window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:D:\HermesTemp\deepseek-harness\packages\client\ui-workflow-run\src\client\WorkflowRunPanel.module.css.mjs
		const css = ".mb5Z2q_root{width:100%;min-width:0}.mb5Z2q_runHeader{box-sizing:border-box;background:var(--dsw-alias-bg-module-platform);border-radius:8px;align-items:center;gap:6px;width:100%;min-width:0;height:32px;padding:0 8px;display:flex}.mb5Z2q_runHeader:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:-2px}.mb5Z2q_runLeading{width:16px;height:16px;color:var(--dsw-alias-label-tertiary);flex:none;justify-content:center;align-items:center;margin-right:0;display:inline-flex}.mb5Z2q_runTitle{max-width:42%;color:var(--dsw-alias-label-secondary);text-overflow:ellipsis;white-space:nowrap;flex:none;font-size:14px;font-weight:510;line-height:24px;overflow:hidden}.mb5Z2q_runSummary{min-width:0;color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;flex:1;font-size:12px;line-height:18px;overflow:hidden}.mb5Z2q_statusTail{height:20px;color:var(--dsw-alias-label-secondary);white-space:nowrap;flex:none;align-items:center;gap:4px;font-size:11px;font-weight:510;line-height:16px;display:inline-flex;overflow:hidden}.mb5Z2q_phaseHeader{box-sizing:border-box;align-items:center;gap:6px;width:100%;min-width:0;height:32px;display:flex}.mb5Z2q_phaseHeader:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:-2px;border-radius:4px}.mb5Z2q_phaseLeading{width:16px;height:16px;color:var(--dsw-alias-label-tertiary);flex:none;justify-content:center;align-items:center;margin-right:0;display:inline-flex}.mb5Z2q_phaseTitle{min-width:0;max-width:42%;color:var(--dsw-alias-label-secondary);text-overflow:ellipsis;white-space:nowrap;flex:0 auto;font-size:14px;line-height:24px;overflow:hidden}.mb5Z2q_phaseCount{min-width:0;color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;flex:1;font-size:13px;line-height:20px;overflow:hidden}.mb5Z2q_phaseStatus{width:132px;color:var(--dsw-alias-label-secondary);text-align:right;text-overflow:ellipsis;white-space:nowrap;flex:none;font-size:13px;line-height:20px;overflow:hidden}.mb5Z2q_separator{background:var(--dsw-alias-label-tertiary);border-radius:50%;flex:none;width:2px;height:2px}.mb5Z2q_phaseList{flex-direction:column;gap:4px;min-width:0;padding:4px 0 0 16px;display:flex}.mb5Z2q_phase{min-width:0}.mb5Z2q_members{flex-direction:column;gap:2px;min-width:0;padding:0 0 0 16px;display:flex}.mb5Z2q_memberRow,.mb5Z2q_memberButton{width:100%;min-width:0;min-height:24px;color:var(--dsw-alias-label-secondary);font:inherit;text-align:left;background:0 0;border:0;border-radius:4px;align-items:center;gap:12px;padding:0;display:flex}.mb5Z2q_memberButton{cursor:pointer}.mb5Z2q_memberButton .mb5Z2q_memberLabel{color:var(--dsw-alias-state-business-primary);text-underline-position:from-font;text-decoration:underline}.mb5Z2q_dotSlot{flex:none;justify-content:center;align-items:center;width:16px;height:24px;display:inline-flex;overflow:hidden}.mb5Z2q_memberButton:focus-visible{outline:none}.mb5Z2q_memberButton:focus-visible .mb5Z2q_memberLabelWrap{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}.mb5Z2q_memberLabelWrap{border-radius:4px;flex:1;align-items:center;min-width:0;height:24px;padding:0 2px;display:flex;overflow:hidden}.mb5Z2q_memberLabel{min-width:0;color:var(--dsw-alias-label-secondary);text-overflow:ellipsis;white-space:nowrap;flex:1;font-size:14px;line-height:24px;overflow:hidden}.mb5Z2q_memberStatus{width:64px;color:var(--dsw-alias-label-secondary);text-align:right;text-overflow:ellipsis;white-space:nowrap;flex:none;font-size:13px;line-height:20px;overflow:hidden}.mb5Z2q_empty{color:var(--dsw-alias-label-tertiary);padding:0;font-size:13px;line-height:20px}@media (width<=560px){.mb5Z2q_phaseList,.mb5Z2q_members{padding-left:12px}}";
		...
		var WorkflowRunPanel_module_css_default = {
			"phaseStatus": "mb5Z2q_phaseStatus",
			"phase": "mb5Z2q_phase",
			"runLeading": "mb5Z2q_runLeading",
			"runTitle": "mb5Z2q_runTitle",
			"dotSlot": "mb5Z2q_dotSlot",
			"phaseLeading": "mb5Z2q_phaseLeading",
			"memberLabelWrap": "mb5Z2q_memberLabelWrap",
			"members": "mb5Z2q_members",
			"memberLabel": "mb5Z2q_memberLabel",
			"memberRow": "mb5Z2q_memberRow",
			"phaseHeader": "mb5Z2q_phaseHeader",
			"runSummary": "mb5Z2q_runSummary",
			"statusTail": "mb5Z2q_statusTail",
			"phaseList": "mb5Z2q_phaseList",
			"runHeader": "mb5Z2q_runHeader",
			"memberButton": "mb5Z2q_memberButton",
			"phaseTitle": "mb5Z2q_phaseTitle",
			"memberStatus": "mb5Z2q_memberStatus",
			"empty": "mb5Z2q_empty",
			"root": "mb5Z2q_root",
			"phaseCount": "mb5Z2q_phaseCount",
			"separator": "mb5Z2q_separator"
		};
		//#endregion
