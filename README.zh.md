...
当前发布线：`0.1.3-alpha.19`。

开发版本：`0.1.3-alpha.19`，见 [变更说明](release/notes/v0.1.3-alpha.19.md)。

完整更新见 [alpha.19 发布说明](release/notes/v0.1.3-alpha.19.md)。
...
完整变更见 [alpha.19 发布说明](release/notes/v0.1.3-alpha.19.md)，协议适配范围见 [rc.1 能力评估](docs/upstream-v0.1.5-rc.1-evaluation.zh.md)。
...
从 [GitHub Releases](https://github.com/qiu7824/deepseek-harness-rs/releases/tag/v0.1.3-alpha.19) 下载对应平台的完整包：
