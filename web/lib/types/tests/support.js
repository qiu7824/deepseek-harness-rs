 ...
 */
export async function newEnglishPage(browser, height = 1000) {
 ...
 */
export async function connectFreshWorkspace(page, root, name = 'workspace') {
 ...
 */
export async function connectFreshWorkspaceZh(page, root, name = 'workspace') {
    mkdirSync(join(root, name), { recursive: true });
...
export async function saveFailureShot(page, name) {
