window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		const zh = {
			"copy.Show local time": "显示本地时间",
			"copy.Show Unix timestamp": "显示 Unix 时间戳",
			"copy.Not recorded": "未记录",
			"copy.Step start unavailable": "未提供步骤开始时间",
			"copy.First token unavailable": "未提供首 Token 时间",
			"copy.Usage unavailable": "未提供用量",
			"copy.Output tokens unavailable": "未提供输出 Token",
			"copy.Duration too short": "耗时过短",
			"copy.turnIndex": "第 {index} 轮",
			...
			"copy.Cached": "缓存命中",
			"copy.Cache created": "缓存写入",
			"copy.Other": "其他",
			"copy.This request": "本次请求",
			"copy.Session cumulative": "会话累计",
			"copy.Options not recorded": "未记录选项",
			"copy.Request options JSON": "请求选项 JSON",
			"copy.Event details": "事件详情",
			"copy.Resize event details": "调整事件详情宽度",
			"copy.Close details": "关闭详情",
			"copy.Trajectory timeline": "轨迹时间线",
			"copy.Timeline overview; drag horizontally to focus events": "时间线概览；横向拖动聚焦事件",
			"copy.(tool call only)": "（仅工具调用）",
			"copy.Between turns": "轮次之间",
			"copy.Pending": "待完成",
			"copy.USER": "用户",
			"copy.CONTEXT": "上下文",
			"copy.COMPACTED": "已压缩",
			...
			"copy.TOOL": "工具",
			"copy.SUBTOOL": "子工具",
			"copy.Loading earlier history\u2026": "正在加载更早记录…",
			"copy.Load earlier history": "加载更早记录",
			"copy.Request #": "请求 #",
			"copy.Compacted": "已压缩",
			"copy.Hierarchy": "层级",
			"copy.Diff": "差异",
			"copy.Source not recorded": "未记录来源",
			"copy.Message source JSON": "消息来源 JSON",
			"copy.No request payload": "无请求数据",
			"copy.No response payload": "无响应数据",
			"copy.No result": "无结果",
			"copy.Summary": "摘要",
			"copy.Raw Output": "原始输出",
			"copy.Preview": "预览",
			"copy.Raw": "原始内容",
			"copy.Source": "来源",
			"copy.Payload": "输入数据",
			...
			"copy.Schema": "定义",
			"copy.Timing": "耗时",
			"copy.Open tool call summary": "打开工具调用摘要",
			"copy.Open image": "打开图片",
			"copy.No tools in this request": "此请求未使用工具",
			...
			"copy.Started": "开始时间",
			"copy.Duration": "持续时间",
			"copy.Timing source": "时间来源",
			"copy.Not available": "未提供",
			"copy.Session timestamps": "会话时间戳",
			"copy.Session timestamps (running)": "会话时间戳（运行中）",
			"copy.Result JSON": "结果 JSON",
			"copy.Schema unavailable": "定义暂不可用",
			"copy.Parameters": "参数",
			"copy.Drag to resize. Double-click to reset.": "拖动调整宽度，双击恢复默认。",
			"copy.SYSTEM": "系统",
			"copy.Status": "状态",
			"copy.Purpose": "用途",
			"copy.Compaction": "上下文压缩",
			"copy.Provider": "提供方",
			"copy.Model": "模型",
			"copy.Tool calls": "工具调用",
			"copy.Subtool calls": "子工具调用",
			"copy.Error": "错误",
			"copy.Retry": "重试",
			"copy.Retry delay": "重试等待",
			"copy.Options": "选项",
			"copy.Usage": "用量",
			"copy.No system prompt in this request": "此请求没有系统提示词",
			"copy.Tokens": "Token",
			"copy.Assistant Message": "助手消息",
			"copy.Tool Call": "工具调用",
			"copy.Request Timing": "请求耗时",
			"copy.Input": "输入",
			"copy.No timing data": "暂无时间数据",
			"copy.Message": "消息",
			"copy.Output": "输出",
			"copy.Completed": "已完成",
			"copy.Running": "运行中",
		...
		/** English dictionary. */
		const en = {
			"copy.Show local time": "Show local time",
			"copy.Show Unix timestamp": "Show Unix timestamp",
			"copy.Not recorded": "Not recorded",
			"copy.Step start unavailable": "Step start unavailable",
			"copy.First token unavailable": "First token unavailable",
			"copy.Usage unavailable": "Usage unavailable",
			"copy.Output tokens unavailable": "Output tokens unavailable",
			"copy.Duration too short": "Duration too short",
			"copy.turnIndex": "Turn {index}",
			...
			"copy.Cached": "Cached",
			"copy.Cache created": "Cache created",
			"copy.Other": "Other",
			"copy.This request": "This request",
			"copy.Session cumulative": "Session cumulative",
			"copy.Options not recorded": "Options not recorded",
			"copy.Request options JSON": "Request options JSON",
			"copy.Event details": "Event details",
			"copy.Resize event details": "Resize event details",
			"copy.Close details": "Close details",
			"copy.Trajectory timeline": "Trajectory timeline",
			"copy.Timeline overview; drag horizontally to focus events": "Timeline overview; drag horizontally to focus events",
			"copy.(tool call only)": "(tool call only)",
			"copy.Between turns": "Between turns",
			"copy.Pending": "Pending",
			"copy.USER": "USER",
			"copy.CONTEXT": "CONTEXT",
			"copy.COMPACTED": "COMPACTED",
			"copy.ASSISTANT": "ASSISTANT",
			"copy.TOOL": "TOOL",
			"copy.SUBTOOL": "SUBTOOL",
			"copy.Loading earlier history\u2026": "Loading earlier history…",
			"copy.Load earlier history": "Load earlier history",
			"copy.Request #": "Request #",
			"copy.Compacted": "Compacted",
			"copy.Hierarchy": "Hierarchy",
			"copy.Diff": "Diff",
			"copy.Source not recorded": "Source not recorded",
			"copy.Message source JSON": "Message source JSON",
			"copy.No request payload": "No request payload",
			"copy.No response payload": "No response payload",
			"copy.No result": "No result",
			"copy.Summary": "Summary",
			"copy.Raw Output": "Raw Output",
			...
			"copy.Schema": "Schema",
			"copy.Timing": "Timing",
			"copy.Open tool call summary": "Open tool call summary",
			"copy.Open image": "Open image",
			"copy.No tools in this request": "No tools in this request",
			"copy.System Prompt": "System Prompt",
			"copy.Tools": "Tools",
			"copy.Thinking": "Thinking",
			"copy.Tool call only": "Tool call only",
			"copy.No content": "No content",
			"copy.Started": "Started",
			"copy.Duration": "Duration",
			"copy.Timing source": "Timing source",
			"copy.Not available": "Not available",
			"copy.Session timestamps": "Session timestamps",
			"copy.Session timestamps (running)": "Session timestamps (running)",
			"copy.Result JSON": "Result JSON",
			"copy.Schema unavailable": "Schema unavailable",
			"copy.Parameters": "Parameters",
			"copy.Drag to resize. Double-click to reset.": "Drag to resize. Double-click to reset.",
			"copy.SYSTEM": "SYSTEM",
			"copy.Status": "Status",
			...
			"copy.Model": "Model",
			"copy.Tool calls": "Tool calls",
			"copy.Subtool calls": "Subtool calls",
			"copy.Error": "Error",
			"copy.Retry": "Retry",
			"copy.Retry delay": "Retry delay",
			"copy.Options": "Options",
			"copy.Usage": "Usage",
			"copy.No system prompt in this request": "No system prompt in this request",
			"copy.Tokens": "Tokens",
			"copy.Assistant Message": "Assistant Message",
			"copy.Tool Call": "Tool Call",
			"copy.Request Timing": "Request Timing",
			"copy.Input": "Input",
			"copy.No timing data": "No timing data",
		...
		const TrajectoryLocale = react.createContext(null);
		function useTrajectoryText() {
			const value = react.useContext(TrajectoryLocale);
			return text => {
                if (!value || typeof text !== "string") return text;
                const section = /^(Turn|Step) (\d+)$/.exec(text);
                if (section) return value.t(section[1] === "Turn" ? "copy.turnIndex" : "copy.stepIndex", { index: section[2] });
                return Object.prototype.hasOwnProperty.call(en, "copy." + text) ? value.t("copy." + text) : text;
            };
		}
		function LocalizedTrajectoryView(props) {
			return (0, react_jsx_runtime.jsx)(TrajectoryLocale.Provider, { value: { t: props.t }, children: (0, react_jsx_runtime.jsx)(TrajectoryView, props) });
		}
		//#endregion
		...
		*/
		...
		function retryAssistantState(state, data) {
				return {
					...initialState(state.turn, state.step, state.startSeq, state.startTime, true),
		...
		function fallbackState$1(context) {
			...
			for (const match of context.matches) {
				...
				} else if (event.type === "llm/retry" && state !== void 0) state = retryAssistantState(state, event.data);
		...
		const trajectoryAssistantDefinition = {
			...
			update: (context, match) => {
				...
				return retryAssistantState(context.state, match.event.data);
			},
			publication: (match) => {
			...
			buildViewNode: (context) => {
				...
				const boundary = closedBoundary(context);
				const partial = node === void 0 && boundary === void 0 && (state.sawChunk || state.settledBlocks.length > 0) ? {
					turn: state.turn,
					step: state.step,
					blocks: visibleAssistantBlocks(state)
				} : null;
		...
		*/
		...
		function sameRunningAssistantRequest(previous, next) {
			if (previous === void 0 || next === void 0) return false;
			return previous.purpose === "assistant" && next.purpose === "assistant" && previous.status === "running" && next.status === "running" && previous.startSeq === next.startSeq && previous.turn === next.turn && previous.step === next.step && previous.startedAt === next.startedAt && previous.completedAt === next.completedAt && previous.error === next.error && previous.retry === next.retry && previous.maxRetries === next.maxRetries && previous.retryDelayMs === next.retryDelayMs && previous.resultSeq === next.resultSeq && previous.provenance === next.provenance && previous.usage === next.usage;
		}
		...
		var TrajectorySnapshotBuilder = class {
			...
			snapshotCache = EMPTY_TRAJECTORY_SNAPSHOT;
			replace(input) {
				this.nodes.clear();
			...
			apply(input) {
				...
				for (const node of input.upserts) {
					...
					if (input.upserts.length === 1) {
						previousSingle = previous;
						nextSingle = node;
					}
				...
				else if (this.patchStreamingAssistant(previousSingle, nextSingle)) return this.snapshotCache;
				return this.snapshot();
			}
			patchStreamingAssistant(previous, next) {
				if (previous?.data.kind !== "assistant" || next?.data.kind !== "assistant") return false;
				if (previous.data.node !== void 0 || next.data.node !== void 0) return false;
				if (!sameRunningAssistantRequest(previous.data.request, next.data.request)) return false;
				const before = previous.data.partial;
				const after = next.data.partial;
				if (after === null) return false;
				if (before === null) {
					if (this.snapshotCache.partial !== null) return false;
				} else if (this.snapshotCache.partial?.turn !== before.turn || this.snapshotCache.partial?.step !== before.step) return false;
				this.snapshotCache = {
					...this.snapshotCache,
					partial: after
				};
 ...
 /* istanbul ignore else */
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\HermesTemp\deepseek-harness\packages\client\ui-trajectory\src\client\TrajectoryTable.module.css.mjs
		const css$3 = ".D_qALW_split{--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);background:var(--dsw-alias-bg-layer-1);flex:1;width:100%;min-height:0;display:flex;position:relative;overflow:hidden;container-type:inline-size}.D_qALW_tablePane{min-width:0;padding-bottom:var(--dsh-trajectory-bottom-clearance,0px);flex:1;position:relative;overflow:hidden auto;container:D_qALW_trajectory-table/inline-size}.D_qALW_historyLoading{z-index:5;pointer-events:none;height:0;position:sticky;top:0;overflow:visible}.D_qALW_historyLoadingBar{box-sizing:border-box;border-bottom:.5px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);width:100%;height:30px;color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xxs-12);justify-content:center;align-items:center;gap:6px;display:flex}.D_qALW_historyLoadingSpinner{box-sizing:border-box;border:1.5px solid var(--dsw-alias-border-l2);border-top-color:var(--dsw-alias-state-business-primary);border-radius:50%;width:10px;height:10px;animation:.7s linear infinite D_qALW_history-loading-spin}.D_qALW_table tbody .D_qALW_historyLoadRow td{height:30px;padding:0}.D_qALW_table tbody .D_qALW_historyLoadRow+tr[data-turn-start=true] td:before{content:none}.D_qALW_historyLoadButton{background:var(--dsw-alias-bg-layer-1);width:100%;height:29px;color:var(--dsw-alias-label-secondary);cursor:pointer;font:var(--dsw-font-xxs-12);border:0;justify-content:center;align-items:center;gap:6px;display:flex}.D_qALW_historyLoadButton:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.D_qALW_historyLoadButton:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:-2px}.D_qALW_historyLoadButton:disabled{cursor:default}.D_qALW_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}.D_qALW_table:not([data-scroll-ready=true]){visibility:hidden}@keyframes D_qALW_history-loading-spin{to{transform:rotate(360deg)}}@media (prefers-reduced-motion:reduce){.D_qALW_historyLoadingSpinner{animation:none}}.D_qALW_table{--trajectory-turn-accent:color-mix(in srgb, var(--dsw-static-blue-500) 22%, var(--dsw-alias-bg-layer-1));border-spacing:0;table-layout:fixed;width:100%;min-width:0;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-1);font:var(--dsw-font-xxs-12)}.D_qALW_eventColumn{width:122px}.D_qALW_contentColumn{width:auto}.D_qALW_table th{z-index:3;box-sizing:border-box;border-bottom:1px solid var(--dsw-alias-border-l2);height:30px;color:var(--dsw-alias-label-tertiary);background:var(--dsw-specific-sidebar-fill);font:var(--dsw-font-xxs-12);text-align:left;text-overflow:ellipsis;user-select:none;white-space:nowrap;padding:0 8px;font-weight:500;position:sticky;top:0;overflow:hidden}.D_qALW_eventHeader{text-align:right!important;padding-right:4px!important}.D_qALW_table td{box-sizing:border-box;border-bottom:1px solid var(--dsw-alias-border-l1);text-overflow:ellipsis;white-space:nowrap;height:30px;padding:0 8px;overflow:hidden}.D_qALW_table tbody .D_qALW_virtualSpacer{pointer-events:none}.D_qALW_table tbody .D_qALW_virtualSpacer td{height:var(--trajectory-virtual-spacer-height);border:0;padding:0}.D_qALW_table tbody tr:not([data-collapsed-summary]):not([data-virtual-spacer]):not([data-history-load]){cursor:default;transition:background-color .12s var(--ds-ease-in-out), opacity .12s var(--ds-ease-in-out);outline:none}.D_qALW_table tbody tr[data-timeline-focus=outside]{opacity:.24}.D_qALW_table tbody tr:not([data-collapsed-summary]):not([data-virtual-spacer]):not([data-history-load]):not([data-selected=true]):hover{background:var(--dsw-alias-interactive-bg-hover)}.D_qALW_table tbody tr[data-request-only=true]:hover{background:0 0}.D_qALW_table tbody tr[data-request-only=true] td{border-bottom:0;height:0;padding-top:0;padding-bottom:0}.D_qALW_table tbody tr[data-terminal-request-boundary=true] td{height:9px}.D_qALW_table tbody tr[data-request-only=true] .D_qALW_turnRail{top:-15px;bottom:0}.D_qALW_table tbody tr:not([data-collapsed-summary]):focus-visible{box-shadow:inset 0 0 0 1px var(--dsw-alias-state-business-primary)}.D_qALW_table tbody tr[data-selected=true]{background:var(--dsw-alias-interactive-bg-active)}.D_qALW_requestBoundaryControl{--request-boundary-base-left:12px;z-index:6;top:-8px;left:calc(var(--request-boundary-base-left) + var(--request-boundary-offset,0px));cursor:pointer;background:0 0;border:0;width:16px;height:16px;padding:0;position:absolute}.D_qALW_requestBoundaryControl:before{background:var(--dsw-alias-label-caption);width:5px;height:5px;box-shadow:0 0 0 2px var(--dsw-alias-bg-layer-1), 0 0 0 3px transparent;content:\"\";transition:background .12s var(--ds-ease-in-out), box-shadow .12s var(--ds-ease-in-out);border-radius:50%;position:absolute;top:5.5px;left:5.5px}.D_qALW_requestBoundaryControl:after{border:1px solid var(--dsw-alias-border-l1);width:max-content;color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-layer-1);content:attr(data-label);font:9px/12px var(--ds-font-family-code);opacity:0;pointer-events:none;transition:opacity .12s var(--ds-ease-in-out), transform .12s var(--ds-ease-in-out);user-select:none;white-space:nowrap;border-radius:2px;padding:0 4px;position:absolute;top:2px;left:17px;transform:translate(-2px);box-shadow:0 2px 6px #0000001f}.D_qALW_requestBoundaryControl:hover:before,.D_qALW_requestBoundaryControl:focus-visible:before{background:var(--dsw-alias-brand-primary-new-colorprimary-new-color)}.D_qALW_requestBoundaryControlActive:before,.D_qALW_requestBoundaryControlActive:hover:before,.D_qALW_requestBoundaryControlActive:focus-visible:before{background:color-mix(in srgb, var(--dsw-alias-brand-primary-new-colorprimary-new-color) 18%, var(--dsw-alias-bg-layer-1));box-shadow:0 0 0 1.5px var(--dsw-alias-brand-primary-new-colorprimary-new-color)}.D_qALW_requestBoundaryControl[data-request-status=error]:before,.D_qALW_requestBoundaryControl[data-request-status=error]:hover:before,.D_qALW_requestBoundaryControl[data-request-status=error]:focus-visible:before{background:var(--dsw-alias-state-error-primary)}.D_qALW_requestBoundaryControl:hover:after,.D_qALW_requestBoundaryControl:focus-visible:after{opacity:1;transform:translate(0)}.D_qALW_requestBoundaryControl:focus-visible{outline:none}.D_qALW_table tbody tr:has(.D_qALW_requestBoundaryControl:hover):not([data-selected=true]){background:0 0}.D_qALW_event{position:relative}.D_qALW_turnRail,.D_qALW_selectionRail{background:var(--dsw-alias-brand-primary-new-colorprimary-new-color);pointer-events:none;position:absolute;left:0}.D_qALW_turnRail{z-index:4;background:var(--trajectory-turn-accent);width:2px;top:-1px;bottom:-1px}.D_qALW_table tbody tr[data-turn-end=true] .D_qALW_turnRail{bottom:0}.D_qALW_selectionRail{z-index:5;width:3px;top:0;bottom:0}.D_qALW_table tbody tr[data-error=true] .D_qALW_turnRail{background:color-mix(in srgb, var(--dsw-alias-state-error-primary) 22%, var(--dsw-alias-bg-layer-1))}.D_qALW_table tbody tr[data-error=true] .D_qALW_selectionRail{background:var(--dsw-alias-state-error-primary)}.D_qALW_table tbody tr[data-turn-start=true] td{position:relative;overflow:visible}.D_qALW_table tbody tr[data-turn-start=true]:not(:first-child) td:before{z-index:1;background:var(--dsw-alias-border-l1);content:\"\";pointer-events:none;height:2px;position:absolute;top:0;left:0;right:0;transform:translateY(-50%)}.D_qALW_event{padding-left:36px!important;padding-right:4px!important;overflow:visible!important}.D_qALW_turnLabel{z-index:3;box-sizing:border-box;width:max-content;color:var(--dsw-alias-label-tertiary);background:var(--dsw-alias-bg-module-platform);font:8px/10px var(--ds-font-family-code);font-variant-numeric:tabular-nums;user-select:none;white-space:nowrap;border-radius:0 0 2px;flex:none;align-items:center;padding:1px 5px;display:inline-grid;position:absolute;top:0;left:0}.D_qALW_turnLabelFull,.D_qALW_turnLabelCompact{opacity:1;white-space:nowrap;grid-area:1/1;max-width:64px;overflow:hidden}.D_qALW_turnLabelCompact{opacity:0;max-width:0}.D_qALW_turnLabelActive{color:color-mix(in srgb, var(--dsw-static-blue-500) 55%, var(--dsw-alias-label-tertiary));background:var(--trajectory-turn-accent)}.D_qALW_eventInner{justify-content:flex-start;align-items:center;min-width:0;height:100%;display:flex}.D_qALW_kindSlot{flex:none;justify-content:flex-end;align-items:flex-end;width:76px;display:flex}.D_qALW_kindSlot [role=tooltip]{background:var(--dsw-alias-bg-layer-2);box-shadow:var(--dsw-elevation-panel);color:var(--dsw-alias-label-primary);border:0}.D_qALW_content{color:var(--dsw-alias-label-primary);padding-left:4px!important}.D_qALW_kindTag{box-sizing:border-box;letter-spacing:.035em;user-select:none;border:1px solid #0000;border-radius:4px;flex:none;align-items:center;height:19px;padding:0 5px;font-size:10px;font-weight:650;line-height:16px;display:inline-flex}.D_qALW_kindTagIcon{opacity:0;flex:none;justify-content:center;align-items:center;width:0;height:13px;display:inline-flex;overflow:hidden;transform:scale(.8)}.D_qALW_kindTagLabel{opacity:1;white-space:nowrap;max-width:72px;display:inline-block;overflow:hidden}.D_qALW_table .D_qALW_kindSlot .D_qALW_message{justify-content:center;width:100%}@container D_qALW_trajectory-table (width<=620px){.D_qALW_eventColumn{width:50px}.D_qALW_event{padding-left:28px!important;padding-right:3px!important}.D_qALW_requestBoundaryControl{--request-boundary-base-left:6px}.D_qALW_kindSlot{width:19px}.D_qALW_kindTag,.D_qALW_table .D_qALW_kindSlot .D_qALW_message{justify-content:center;width:19px;padding-left:0;padding-right:0}.D_qALW_kindTagIcon{opacity:1;width:13px;transform:scale(1)}.D_qALW_kindTagLabel,.D_qALW_turnLabelFull{opacity:0;max-width:0}.D_qALW_turnLabelCompact{opacity:1;max-width:64px}}@media (prefers-reduced-motion:no-preference){.D_qALW_eventColumn,.D_qALW_event,.D_qALW_requestBoundaryControl,.D_qALW_kindSlot,.D_qALW_kindTag,.D_qALW_kindTagIcon,.D_qALW_kindTagLabel,.D_qALW_turnLabelFull,.D_qALW_turnLabelCompact{transition-duration:.18s;transition-timing-function:var(--ds-ease-in-out)}.D_qALW_eventColumn,.D_qALW_kindSlot{transition-property:width}.D_qALW_event{transition-property:padding-right,padding-left}.D_qALW_requestBoundaryControl{transition-property:left}.D_qALW_kindTag{transition-property:padding-right,padding-left}.D_qALW_kindTagIcon{transition-property:width,opacity,transform}.D_qALW_kindTagLabel,.D_qALW_turnLabelFull,.D_qALW_turnLabelCompact{transition-property:max-width,opacity}}.D_qALW_user{color:var(--dsw-alias-state-business-primary);background:var(--dsw-alias-state-business-tertiary)}.D_qALW_systemNeutral{color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-module-platform)}.D_qALW_contextGreen{color:color-mix(in srgb, var(--dsw-alias-state-success-primary) 68%, var(--dsw-alias-label-secondary));background:var(--dsw-alias-state-success-tertiary)}.D_qALW_compacted{color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-module-platform)}.D_qALW_compactedSummary{font:var(--dsw-font-xs-13);margin-top:12px;padding:0 0 14px}.D_qALW_promptDiffSections{flex-direction:column;gap:14px;max-height:100%;padding:10px 14px 14px;display:flex;overflow:auto}.D_qALW_promptDiffSection{min-width:0}.D_qALW_promptDiffTitle{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-strong-13);user-select:none;margin:0 0 6px}.D_qALW_promptDiff{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-1);font:11px/17px var(--ds-font-family-code);white-space:pre;margin:0;overflow:auto}.D_qALW_promptDiff span{min-width:max-content;padding:0 6px;display:block}.D_qALW_promptDiffLinemeta{color:var(--dsw-alias-label-caption);background:var(--dsw-alias-bg-module-platform);user-select:none}.D_qALW_promptDiffLinecontext{color:var(--dsw-alias-label-secondary)}.D_qALW_promptDiffLineadded{color:color-mix(in srgb, var(--dsw-alias-state-success-primary) 72%, var(--dsw-alias-label-primary));background:var(--dsw-alias-state-success-tertiary)}.D_qALW_promptDiffLineremoved{color:var(--dsw-alias-state-error-primary);background:color-mix(in srgb, var(--dsw-alias-state-error-primary) 12%, var(--dsw-alias-bg-layer-1))}.D_qALW_assistantVioletBright{color:color-mix(in srgb, var(--dsw-alias-brand-primary-new-colorprimary-new-color) 60%, var(--dsw-alias-state-error-secondary));background:color-mix(in srgb, color-mix(in srgb, var(--dsw-alias-brand-primary-new-colorprimary-new-color) 55%, var(--dsw-alias-state-error-secondary)) 15%, var(--dsw-alias-bg-layer-1))}.D_qALW_toolAmber{color:var(--dsw-alias-state-warn-label);background:var(--dsw-alias-state-warn-tertiary)}.D_qALW_subtoolAmber{color:color-mix(in srgb, var(--dsw-alias-state-warn-label) 62%, var(--dsw-alias-label-tertiary));background:color-mix(in srgb, var(--dsw-alias-state-warn-tertiary) 58%, var(--dsw-alias-bg-layer-1))}.D_qALW_contentText{text-overflow:ellipsis;white-space:nowrap;min-width:0;display:block;overflow:hidden}.D_qALW_toolCallOnly{color:var(--dsw-alias-label-tertiary)}.D_qALW_table tbody tr[data-collapsed-summary=turn] td,.D_qALW_table tbody tr[data-collapsed-summary=assistant] td{height:20px}.D_qALW_table tbody tr[data-collapsed-summary]{cursor:pointer;transition:background-color .12s var(--ds-ease-in-out);outline:none}.D_qALW_table tbody tr[data-collapsed-summary]:hover{background:var(--dsw-alias-interactive-bg-hover)}.D_qALW_table tbody tr[data-collapsed-summary]:focus-visible{box-shadow:inset 0 0 0 1px var(--dsw-alias-state-business-primary)}.D_qALW_collapsedTurnContent{min-width:0;color:var(--dsw-alias-label-secondary);align-items:center;font-size:12px;line-height:16px;display:flex}.D_qALW_collapsedTurnEllipsis{color:var(--dsw-alias-label-tertiary);user-select:none;flex:none;margin-right:6px;font-weight:600}.D_qALW_collapsedTurnText{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}.D_qALW_resultPreview{grid-template-columns:clamp(180px, var(--trajectory-tool-request-width,calc(36cqw - 56px)), 480px) minmax(0, 1fr);align-items:center;gap:8px;min-width:0;display:grid}.D_qALW_resultRequest,.D_qALW_inlineResultText{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}.D_qALW_toolCallNameTypeface{color:var(--dsw-alias-label-primary);font:400 12px/18px Menlo,Consolas,Liberation Mono,PingFang SC,Microsoft YaHei}.D_qALW_toolCallPayload{color:var(--dsw-alias-label-secondary);font:400 12px/18px var(--ds-font-family-code);margin-left:7px}.D_qALW_table tbody tr[data-kind=tool] .D_qALW_contentText,.D_qALW_table tbody tr[data-kind=subtool] .D_qALW_contentText,.D_qALW_table tbody tr[data-kind=tool] .D_qALW_resultPreview,.D_qALW_table tbody tr[data-kind=subtool] .D_qALW_resultPreview{font-family:var(--ds-font-family-code);font-size:12px}.D_qALW_table tbody tr[data-kind=subtool] .D_qALW_content{padding-left:26px}.D_qALW_inlineResult{min-width:0;color:var(--dsw-alias-label-secondary);align-items:center;display:flex}.D_qALW_noOutputText{color:var(--dsw-alias-label-caption)}.D_qALW_arrow{color:var(--dsw-alias-label-caption);flex:none;margin-right:8px}.D_qALW_error,.D_qALW_overview dd.D_qALW_error,.D_qALW_details .D_qALW_errorPayload{color:var(--dsw-alias-state-error-primary)}.D_qALW_details .D_qALW_errorPayload .D_qALW_resultBlockText{color:inherit}.D_qALW_details .D_qALW_jsonPayload.D_qALW_errorPayload,.D_qALW_details .D_qALW_jsonPreview.D_qALW_errorPayload{--json-tree-property:var(--dsw-alias-state-error-primary);--json-tree-string:var(--dsw-alias-state-error-primary);--json-tree-number:var(--dsw-alias-state-error-primary);--json-tree-keyword:var(--dsw-alias-state-error-primary);--json-tree-punctuation:var(--dsw-alias-state-error-primary);--json-tree-icon:var(--dsw-alias-state-error-primary)}.D_qALW_details{border-left:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);flex-direction:column;flex:none;width:clamp(320px,38%,440px);min-width:0;max-width:calc(100% - 280px);min-height:0;display:flex;position:relative}.D_qALW_detailsResizeHandle{z-index:6;cursor:col-resize;touch-action:none;user-select:none;background:0 0;border:0;width:8px;padding:0;position:absolute;top:0;bottom:0;left:-4px}.D_qALW_detailsResizeHandle:focus-visible{outline:none}.D_qALW_detailsHeader{box-sizing:border-box;border-bottom:1px solid var(--dsw-alias-border-l2);flex:none;justify-content:space-between;align-items:center;height:42px;padding:0 8px 0 12px;display:flex}.D_qALW_detailsTitle{min-width:0;color:var(--dsw-alias-label-primary);align-items:center;gap:8px;display:flex}.D_qALW_requestDetailsDot{background:var(--dsw-alias-label-secondary);border-radius:50%;flex:none;width:5px;height:5px}.D_qALW_requestDetailsName{font:500 12px/16px var(--ds-font-family-code);flex:none}.D_qALW_detailsLocation{min-width:0;color:var(--dsw-alias-label-tertiary);font:11px/16px var(--ds-font-family-code);text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.D_qALW_close{width:28px;height:28px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:0;border-radius:6px;flex:none;justify-content:center;align-items:center;padding:0;font-size:18px;line-height:18px;display:inline-flex}.D_qALW_close:hover{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover)}.D_qALW_detailTabs{box-sizing:border-box;border-bottom:1px solid var(--dsw-alias-border-l2);overscroll-behavior-x:contain;scrollbar-width:none;white-space:nowrap;flex:none;gap:1px;width:100%;min-width:0;max-width:100%;height:34px;padding:0 8px;display:flex;overflow:auto hidden}.D_qALW_detailTabs::-webkit-scrollbar{display:none}.D_qALW_detailTab{color:var(--dsw-alias-label-tertiary);cursor:pointer;font:var(--dsw-font-xs-13);background:0 0;border:0;flex:none;padding:0 9px;position:relative}.D_qALW_detailTab:hover{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover)}.D_qALW_detailTabActive{color:var(--dsw-alias-state-business-primary)}.D_qALW_detailTabActive:after{background:var(--dsw-alias-state-business-primary);content:\"\";border-radius:1px 1px 0 0;height:2px;position:absolute;bottom:0;left:9px;right:9px}.D_qALW_close:focus-visible,.D_qALW_detailTab:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}.D_qALW_detailBody{min-height:0;padding-bottom:var(--dsh-trajectory-bottom-clearance,0px);scrollbar-gutter:stable;flex:1;overflow:hidden auto}.D_qALW_detailBodySummary{box-sizing:border-box;padding-bottom:calc(12px + var(--dsh-trajectory-bottom-clearance,0px));flex-direction:column;display:flex;overflow:hidden}.D_qALW_detailBodySummary>.D_qALW_overview{overscroll-behavior:contain;flex:0 auto;min-height:0;overflow:auto}.D_qALW_detailBodySummary>.D_qALW_compactedSummary{flex:1;min-height:0;overflow:auto}.D_qALW_summaryScrollRegion{--dsh-scrollbar-thumb:transparent;--dsh-scrollbar-thumb-hover:transparent}.D_qALW_summaryScrollRegion:hover,.D_qALW_summaryScrollRegion:focus-within{--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2)}.D_qALW_compactedSummary .D_qALW_markdownPayload{padding-right:18px}.D_qALW_overview{font:var(--dsw-font-xs-13);margin:0;padding:8px 0}.D_qALW_overviewParentLinks{gap:14px;display:flex}.D_qALW_overviewHierarchyNavLink{all:unset;color:var(--dsw-alias-label-secondary);cursor:pointer;font:inherit;opacity:1;align-items:center;gap:1px;display:inline-flex}.D_qALW_overviewHierarchyNavLink:hover{color:var(--dsw-alias-label-primary)}.D_qALW_overviewHierarchyJumpIconTight{color:var(--dsw-alias-label-caption);flex:none}.D_qALW_overviewHierarchyNavLink:hover .D_qALW_overviewHierarchyJumpIconTight,.D_qALW_overviewHierarchyNavLink:focus-visible .D_qALW_overviewHierarchyJumpIconTight{color:var(--dsw-alias-label-primary)}.D_qALW_overviewHierarchyNavLink:focus-visible{color:var(--dsw-alias-label-primary);outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.D_qALW_overview>div{grid-template-columns:94px minmax(0,1fr);align-items:center;min-height:22px;padding:0 14px;display:grid}.D_qALW_overview>.D_qALW_requestTokenDetail dt{padding-left:12px}.D_qALW_usagePanel{padding:4px 0 10px}.D_qALW_usageGroup+.D_qALW_usageGroup{margin-top:8px}.D_qALW_usageHeading{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-strong-13);user-select:none;margin:0;padding:4px 14px 1px}.D_qALW_usageGroup .D_qALW_overview{padding:0}.D_qALW_overview dt{color:var(--dsw-alias-label-tertiary)}.D_qALW_overview dd{min-width:0;color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;margin:0;overflow:hidden}.D_qALW_timestampToggle{all:unset;color:inherit;cursor:pointer;font:inherit;user-select:text}.D_qALW_timestampToggle:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.D_qALW_overviewSections{border-top:0;flex-direction:column;flex:1;min-height:min-content;display:flex;overflow:hidden}.D_qALW_overviewSection{flex-direction:column;flex:1 1 0;min-height:28px;max-height:max-content;display:flex;overflow:hidden}.D_qALW_overviewSection+.D_qALW_overviewSection{padding-top:8px}.D_qALW_overviewHeading{box-sizing:border-box;width:100%;height:28px;color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-layer-1);font:var(--dsw-font-xs-strong-13);user-select:none;flex:none;align-items:flex-end;margin:0;padding:0 0 3px 14px;display:flex}.D_qALW_overviewTitle{width:max-content;height:auto;color:inherit;cursor:pointer;font:inherit;user-select:none;background:0 0;border:0;flex:none;align-items:center;gap:3px;padding:0;line-height:1;display:inline-flex}.D_qALW_overviewTitleIcon{color:var(--dsw-alias-label-caption);flex:none}.D_qALW_overviewTitle:hover .D_qALW_overviewTitleIcon{color:var(--dsw-alias-label-primary)}.D_qALW_overviewTitle:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.D_qALW_overviewTitle:focus-visible .D_qALW_overviewTitleIcon{color:var(--dsw-alias-state-business-primary)}.D_qALW_overviewPreview{overscroll-behavior:contain;background:var(--dsw-alias-bg-layer-1);flex:1;min-height:0;overflow:auto}.D_qALW_overviewPreview>:last-child{margin-bottom:0;padding-bottom:0}.D_qALW_overviewPreview .D_qALW_jsonPreview>:first-child,.D_qALW_overviewPreview .D_qALW_schemaTree>:first-child{padding-bottom:0}.D_qALW_overviewPreview .D_qALW_schemaTree{margin-bottom:0}.D_qALW_overviewPreview .D_qALW_overview{padding:2px 0 0}.D_qALW_overviewPreview .D_qALW_overview>div{min-height:22px}.D_qALW_markdownPreview,.D_qALW_markdownPayload{color:var(--dsw-alias-label-primary)}.D_qALW_markdownPreview>div,.D_qALW_markdownPayload>div{font:var(--dsw-font-xs-13);gap:8px}.D_qALW_markdownPreview>div h1,.D_qALW_markdownPayload>div h1{font:600 16px/22px var(--dsw-font-family)}.D_qALW_markdownPreview>div h2,.D_qALW_markdownPayload>div h2{font:600 15px/22px var(--dsw-font-family)}.D_qALW_markdownPreview>div :where(h3,h4,h5,h6),.D_qALW_markdownPayload>div :where(h3,h4,h5,h6){font:600 14px/20px var(--dsw-font-family)}.D_qALW_markdownPreview>div :not(pre)>code,.D_qALW_markdownPayload>div :not(pre)>code{font:12px/18px var(--ds-font-family-code)}.D_qALW_markdownPreview>div table,.D_qALW_markdownPayload>div table{font:var(--dsw-font-xs-13)}.D_qALW_markdownPreview>div>:first-child{margin-top:0}.D_qALW_markdownPreview>div>:last-child{margin-bottom:0}.D_qALW_markdownPreview>div :where(h1,h2,h3){margin:12px 0 6px}.D_qALW_markdownPreview>div :where(h4,h5,h6){margin:10px 0 5px}.D_qALW_markdownPreview>div :where(p,ul,ol){margin:8px 0}.D_qALW_markdownPreview>div li:not(:first-child){margin-top:3px}.D_qALW_markdownPreview>div blockquote{margin-top:8px}.D_qALW_markdownPreview>div hr{margin:14px 0}.D_qALW_markdownPreview>div>.md-code-block{margin:10px 0}.D_qALW_assistantContent .D_qALW_markdownPayload,.D_qALW_assistantContent .D_qALW_payload{min-height:0}.D_qALW_thinkingQuote{border-left:2px solid var(--dsw-alias-markdown-citation);color:var(--dsw-alias-label-secondary);background:0 0;margin:6px 14px 0 12px;padding-left:6px}.D_qALW_thinkingQuoteOnlyPreview{margin-bottom:8px}.D_qALW_detailBody>.D_qALW_assistantContentRendered .D_qALW_thinkingQuote{margin-top:14px}.D_qALW_thinkingToggle{width:max-content;height:18px;color:var(--dsw-alias-label-tertiary);cursor:pointer;font:600 12px/18px var(--dsw-font-family);user-select:none;background:0 0;border:0;align-items:center;gap:2px;padding:0;display:flex}.D_qALW_thinkingChevron{transition:transform .12s var(--ds-ease-in-out);flex:none}.D_qALW_thinkingToggle[aria-expanded=true] .D_qALW_thinkingChevron{transform:rotate(90deg)}.D_qALW_thinkingToggle:hover{color:var(--dsw-alias-label-secondary)}.D_qALW_thinkingToggle:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.D_qALW_thinkingQuote .D_qALW_markdownPreview,.D_qALW_thinkingQuote .D_qALW_markdownPayload,.D_qALW_thinkingQuote .D_qALW_payload{min-height:0;color:var(--dsw-alias-label-secondary);background:0 0;padding:2px 0}.D_qALW_assistantOutput{background:var(--dsw-alias-bg-layer-1)}.D_qALW_markdownPreview{padding:6px 14px 8px}.D_qALW_markdownPayload{min-height:100%;padding:14px}.D_qALW_jsonPayload{min-height:100%}.D_qALW_jsonPreview{min-height:0}.D_qALW_schema{background:var(--dsw-alias-bg-layer-1);min-height:100%}.D_qALW_schemaPreview{min-height:0}.D_qALW_schemaIntro{padding:12px 14px 6px}.D_qALW_schemaPreview .D_qALW_schemaIntro{padding-top:6px}.D_qALW_schemaName{color:var(--dsw-alias-label-primary);font:600 12px/18px var(--ds-font-family-code);margin:0}.D_qALW_schemaDescription{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-13);white-space:pre-wrap;margin:2px 0 0}.D_qALW_schemaParameters{min-width:0}.D_qALW_schemaParametersTitle{color:var(--dsw-alias-label-tertiary);font:600 11px/16px var(--dsw-font-family);user-select:none;margin:0;padding:4px 14px 2px}.D_qALW_schemaTree{margin:0 6px 8px 0}.D_qALW_payload{box-sizing:border-box;overflow-wrap:anywhere;min-height:100%;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-markdown-code-block);font:12px/19px var(--ds-font-family-code);tab-size:2;white-space:pre-wrap;margin:0;padding:14px}.D_qALW_payloadPreview{min-height:0;padding:6px 14px 8px}.D_qALW_sourceBlocks{box-sizing:border-box;min-height:100%;padding:12px 14px}.D_qALW_sourceBlock+.D_qALW_sourceBlock{margin-top:14px}.D_qALW_sourceBlockHeader,.D_qALW_sourceBlockJumpTarget{user-select:none;align-items:center;gap:3px;width:max-content;margin-bottom:3px;display:flex}.D_qALW_sourceBlockJumpTarget{all:unset;cursor:pointer;user-select:none;align-items:center;gap:3px;width:max-content;margin-bottom:3px;display:flex}.D_qALW_sourceBlockLabel{color:var(--dsw-alias-label-tertiary);font:11px/16px var(--ds-font-family-code)}.D_qALW_sourceBlockJumpIcon{color:var(--dsw-alias-label-caption);flex:none}.D_qALW_sourceBlockJumpTarget:hover .D_qALW_sourceBlockJumpIcon{color:var(--dsw-alias-label-primary)}.D_qALW_sourceBlockJumpTarget:focus-visible{outline:none}.D_qALW_sourceBlockJumpTarget:focus-visible .D_qALW_sourceBlockJumpIcon{color:var(--dsw-alias-state-business-primary)}.D_qALW_sourceBlockContent{overflow-wrap:anywhere;color:var(--dsw-alias-label-primary);font:12px/19px var(--ds-font-family-code);tab-size:2;white-space:pre-wrap;background:0 0;margin:0}.D_qALW_panelImageLink{cursor:zoom-in;border-radius:4px;width:auto;max-width:100%;display:block;overflow:hidden}.D_qALW_panelImageLinkPreview{max-height:140px}.D_qALW_panelImage{border-radius:inherit;background:var(--dsw-alias-bg-base);object-fit:contain;width:auto;max-width:100%;height:auto;max-height:320px;margin:0;display:block}.D_qALW_panelImageLinkPreview .D_qALW_panelImage{max-height:140px}.D_qALW_messageImages{flex-direction:column;gap:8px;margin:8px 14px 14px;display:flex}.D_qALW_messageImagesPreview{gap:6px;margin:6px 14px 8px}.D_qALW_assistantToolCalls{box-sizing:border-box;max-width:100%;color:var(--dsw-alias-label-secondary);font:11px/17px var(--ds-font-family-code);margin:2px 14px 12px;padding:0;list-style:none}.D_qALW_assistantToolCallsPreview{margin-top:2px;margin-bottom:8px}.D_qALW_assistantToolCalls li{min-width:0}.D_qALW_assistantToolCallButton{all:unset;box-sizing:border-box;cursor:pointer;border-radius:3px;align-items:center;width:calc(100% + 4px);min-width:0;height:19px;margin-left:-4px;padding:0 4px;display:flex}.D_qALW_assistantToolCallButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.D_qALW_assistantToolCallButton:focus-visible{background:var(--dsw-alias-interactive-bg-hover);outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}.D_qALW_assistantToolCallIcon{color:var(--dsw-alias-label-caption);flex:none;margin-right:5px}.D_qALW_assistantToolCallButton:hover .D_qALW_assistantToolCallIcon,.D_qALW_assistantToolCallButton:focus-visible .D_qALW_assistantToolCallIcon{color:var(--dsw-alias-label-secondary)}.D_qALW_assistantToolCallText{white-space:nowrap;flex:1;min-width:0;display:flex;overflow:hidden}.D_qALW_assistantToolCallName{color:var(--dsw-alias-label-secondary);flex:none;margin-right:5px;font-weight:500}.D_qALW_assistantToolCallArgs{min-width:0;color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.D_qALW_systemPrompt{box-sizing:border-box}.D_qALW_toolCatalog{min-height:100%;padding:8px 0 16px}.D_qALW_toolCatalogItem{border-bottom:1px solid var(--dsw-alias-border-l1)}.D_qALW_toolCatalogSummary{box-sizing:border-box;cursor:pointer;user-select:none;grid-template-columns:12px 12px max-content minmax(0,1fr);align-items:center;gap:5px;min-height:30px;padding:4px 12px;list-style:none;display:grid}.D_qALW_toolCatalogSummary::-webkit-details-marker{display:none}.D_qALW_toolCatalogSummary:hover{background:var(--dsw-alias-interactive-bg-hover)}.D_qALW_toolCatalogSummary:focus-visible{background:var(--dsw-alias-interactive-bg-hover);outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}.D_qALW_toolCatalogChevron,.D_qALW_toolCatalogIcon{color:var(--dsw-alias-label-caption)}.D_qALW_toolCatalogChevron{transition:transform .1s var(--ds-ease-in-out)}.D_qALW_toolCatalogItem[open] .D_qALW_toolCatalogChevron{transform:rotate(90deg)}.D_qALW_toolCatalogName{color:var(--dsw-alias-label-primary);font:500 12px/18px var(--ds-font-family-code)}.D_qALW_toolCatalogDescription{min-width:0;color:var(--dsw-alias-label-tertiary);font:var(--dsw-font-xs-13);text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.D_qALW_toolCatalogDefinition{background:var(--dsw-alias-bg-base);padding:0 0 8px 29px}.D_qALW_toolCatalogFullDescription{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-13);white-space:pre-wrap;margin:0;padding:7px 14px 4px 0}.D_qALW_toolCatalogTree{margin-left:-14px;margin-right:6px}.D_qALW_resultBlocks{box-sizing:border-box;flex-direction:column;gap:10px;min-height:100%;padding:14px;display:flex}.D_qALW_resultBlocksPreview{gap:6px;min-height:0;padding:6px 14px 8px}.D_qALW_resultBlockText{overflow-wrap:anywhere;color:var(--dsw-alias-label-primary);font:12px/19px var(--ds-font-family-code);tab-size:2;white-space:pre-wrap;background:0 0;margin:0}.D_qALW_overviewPreview .D_qALW_noPayload{padding:6px 14px 8px}.D_qALW_noPayload{color:var(--dsw-alias-label-tertiary);font:var(--dsw-font-xs-13);margin:0;padding:18px 14px}@media (width<=760px){.D_qALW_details{z-index:5;border-left-color:var(--dsw-alias-border-l3);width:min(92%,420px);max-width:92%;position:absolute;top:0;bottom:0;right:0;box-shadow:-12px 0 32px #00000024}}";
		...
		var TrajectoryTable_module_css_default = {
			"assistantToolCallsPreview": "D_qALW_assistantToolCallsPreview",
			"noPayload": "D_qALW_noPayload",
			"detailTabs": "D_qALW_detailTabs",
			"sourceBlockLabel": "D_qALW_sourceBlockLabel",
			"eventColumn": "D_qALW_eventColumn",
			"promptDiffSections": "D_qALW_promptDiffSections",
			"noOutputText": "D_qALW_noOutputText",
			"selectionRail": "D_qALW_selectionRail",
			"sourceBlockJumpIcon": "D_qALW_sourceBlockJumpIcon",
			"schemaParametersTitle": "D_qALW_schemaParametersTitle",
			"assistantToolCalls": "D_qALW_assistantToolCalls",
			"inlineResultText": "D_qALW_inlineResultText",
			"toolCatalogSummary": "D_qALW_toolCatalogSummary",
			"panelImageLink": "D_qALW_panelImageLink",
			"schemaPreview": "D_qALW_schemaPreview",
			"assistantToolCallArgs": "D_qALW_assistantToolCallArgs",
			"schema": "D_qALW_schema",
			"turnLabelActive": "D_qALW_turnLabelActive",
			"promptDiffLineadded": "D_qALW_promptDiffLineadded",
			"resultRequest": "D_qALW_resultRequest",
			"historyLoadButton": "D_qALW_historyLoadButton",
			"kindTag": "D_qALW_kindTag",
			"overviewTitleIcon": "D_qALW_overviewTitleIcon",
			"thinkingQuoteOnlyPreview": "D_qALW_thinkingQuoteOnlyPreview",
			"thinkingToggle": "D_qALW_thinkingToggle",
			"usagePanel": "D_qALW_usagePanel",
			"promptDiff": "D_qALW_promptDiff",
			"kindTagIcon": "D_qALW_kindTagIcon",
			"detailsHeader": "D_qALW_detailsHeader",
			"tablePane": "D_qALW_tablePane",
			"requestDetailsDot": "D_qALW_requestDetailsDot",
			"assistantContent": "D_qALW_assistantContent",
			"schemaParameters": "D_qALW_schemaParameters",
			"toolCatalogChevron": "D_qALW_toolCatalogChevron",
			"toolCatalogName": "D_qALW_toolCatalogName",
			"history-loading-spin": "D_qALW_history-loading-spin",
			"contentText": "D_qALW_contentText",
			"payload": "D_qALW_payload",
			"assistantToolCallIcon": "D_qALW_assistantToolCallIcon",
			"visuallyHidden": "D_qALW_visuallyHidden",
			"sourceBlockJumpTarget": "D_qALW_sourceBlockJumpTarget",
			"event": "D_qALW_event",
			"turnRail": "D_qALW_turnRail",
			"panelImageLinkPreview": "D_qALW_panelImageLinkPreview",
			"schemaIntro": "D_qALW_schemaIntro",
			"sourceBlockHeader": "D_qALW_sourceBlockHeader",
			"overviewHierarchyJumpIconTight": "D_qALW_overviewHierarchyJumpIconTight",
			"error": "D_qALW_error",
			"overviewSection": "D_qALW_overviewSection",
			"toolCallOnly": "D_qALW_toolCallOnly",
			"toolCatalogItem": "D_qALW_toolCatalogItem",
			"assistantOutput": "D_qALW_assistantOutput",
			"usageHeading": "D_qALW_usageHeading",
			"contextGreen": "D_qALW_contextGreen",
			"overviewHierarchyNavLink": "D_qALW_overviewHierarchyNavLink",
			"toolCallNameTypeface": "D_qALW_toolCallNameTypeface",
			"table": "D_qALW_table",
			"virtualSpacer": "D_qALW_virtualSpacer",
			"detailTabActive": "D_qALW_detailTabActive",
			"turnLabelCompact": "D_qALW_turnLabelCompact",
			"detailBody": "D_qALW_detailBody",
			"resultBlocksPreview": "D_qALW_resultBlocksPreview",
			"historyLoadRow": "D_qALW_historyLoadRow",
			"promptDiffTitle": "D_qALW_promptDiffTitle",
			"markdownPayload": "D_qALW_markdownPayload",
			"resultBlocks": "D_qALW_resultBlocks",
			"message": "D_qALW_message",
			"toolCatalog": "D_qALW_toolCatalog",
			"toolCatalogTree": "D_qALW_toolCatalogTree",
			"toolAmber": "D_qALW_toolAmber",
			"toolCatalogDescription": "D_qALW_toolCatalogDescription",
			"promptDiffLineremoved": "D_qALW_promptDiffLineremoved",
			"schemaName": "D_qALW_schemaName",
			"requestDetailsName": "D_qALW_requestDetailsName",
			"detailBodySummary": "D_qALW_detailBodySummary",
			"trajectory-table": "D_qALW_trajectory-table",
			"sourceBlock": "D_qALW_sourceBlock",
			"markdownPreview": "D_qALW_markdownPreview",
			"detailsTitle": "D_qALW_detailsTitle",
			"messageImagesPreview": "D_qALW_messageImagesPreview",
			"jsonPayload": "D_qALW_jsonPayload",
			"close": "D_qALW_close",
			"kindSlot": "D_qALW_kindSlot",
			"kindTagLabel": "D_qALW_kindTagLabel",
			"compacted": "D_qALW_compacted",
			"overviewSections": "D_qALW_overviewSections",
			"split": "D_qALW_split",
			"schemaTree": "D_qALW_schemaTree",
			"promptDiffLinecontext": "D_qALW_promptDiffLinecontext",
			"collapsedTurnText": "D_qALW_collapsedTurnText",
			"resultPreview": "D_qALW_resultPreview",
			"overviewPreview": "D_qALW_overviewPreview",
			"assistantToolCallText": "D_qALW_assistantToolCallText",
			"assistantToolCallName": "D_qALW_assistantToolCallName",
			"systemNeutral": "D_qALW_systemNeutral",
			"assistantContentRendered": "D_qALW_assistantContentRendered",
			"thinkingChevron": "D_qALW_thinkingChevron",
			"resultBlockText": "D_qALW_resultBlockText",
			"compactedSummary": "D_qALW_compactedSummary",
			"requestTokenDetail": "D_qALW_requestTokenDetail",
			"user": "D_qALW_user",
			"detailsResizeHandle": "D_qALW_detailsResizeHandle",
			"overviewHeading": "D_qALW_overviewHeading",
			"toolCallPayload": "D_qALW_toolCallPayload",
			"promptDiffSection": "D_qALW_promptDiffSection",
			"toolCatalogIcon": "D_qALW_toolCatalogIcon",
			"messageImages": "D_qALW_messageImages",
			"eventInner": "D_qALW_eventInner",
			"content": "D_qALW_content",
			"thinkingQuote": "D_qALW_thinkingQuote",
			"toolCatalogDefinition": "D_qALW_toolCatalogDefinition",
			"errorPayload": "D_qALW_errorPayload",
			"contentColumn": "D_qALW_contentColumn",
			"turnLabelFull": "D_qALW_turnLabelFull",
			"assistantToolCallButton": "D_qALW_assistantToolCallButton",
			"detailTab": "D_qALW_detailTab",
			"timestampToggle": "D_qALW_timestampToggle",
			"requestBoundaryControlActive": "D_qALW_requestBoundaryControlActive",
			"summaryScrollRegion": "D_qALW_summaryScrollRegion",
			"details": "D_qALW_details",
			"schemaDescription": "D_qALW_schemaDescription",
			"sourceBlocks": "D_qALW_sourceBlocks",
			"sourceBlockContent": "D_qALW_sourceBlockContent",
			"panelImage": "D_qALW_panelImage",
			"requestBoundaryControl": "D_qALW_requestBoundaryControl",
			"jsonPreview": "D_qALW_jsonPreview",
			"eventHeader": "D_qALW_eventHeader",
			"usageGroup": "D_qALW_usageGroup",
			"overviewParentLinks": "D_qALW_overviewParentLinks",
			"systemPrompt": "D_qALW_systemPrompt",
			"toolCatalogFullDescription": "D_qALW_toolCatalogFullDescription",
			"turnLabel": "D_qALW_turnLabel",
			"subtoolAmber": "D_qALW_subtoolAmber",
			"collapsedTurnEllipsis": "D_qALW_collapsedTurnEllipsis",
			"arrow": "D_qALW_arrow",
			"overview": "D_qALW_overview",
			"detailsLocation": "D_qALW_detailsLocation",
			"inlineResult": "D_qALW_inlineResult",
			"overviewTitle": "D_qALW_overviewTitle",
			"assistantVioletBright": "D_qALW_assistantVioletBright",
			"collapsedTurnContent": "D_qALW_collapsedTurnContent",
			"historyLoadingSpinner": "D_qALW_historyLoadingSpinner",
			"payloadPreview": "D_qALW_payloadPreview",
			"historyLoadingBar": "D_qALW_historyLoadingBar",
			"historyLoading": "D_qALW_historyLoading",
			"promptDiffLinemeta": "D_qALW_promptDiffLinemeta"
		};
		//#endregion
		...
		function StartedAtValue({ timestamp }) {
			...
			if (timestamp === null || !Number.isFinite(timestamp)) return (0, react_jsx_runtime.jsx)("dd", { children: localize("Not available") });
			return (0, react_jsx_runtime.jsx)("dd", { children: (0, react_jsx_runtime.jsx)("button", {
				...
				title: localize(showUnix ? "Show local time" : "Show Unix timestamp"),
				onClick: (event) => {
		...
		function AssistantTimingPanel({ metrics }) {
			...
			return (0, react_jsx_runtime.jsxs)("dl", {
				...
				children: [
					...
					(0, react_jsx_runtime.jsxs)("div", { children: [(0, react_jsx_runtime.jsx)("dt", { children: localize("Throughput") }), (0, react_jsx_runtime.jsx)("dd", { children: localize(throughput(metrics)) })] })
				]
			});
		}
		...
		function TokenRows({ cell }) {
			...
			return (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
				(0, react_jsx_runtime.jsxs)("div", { children: [(0, react_jsx_runtime.jsx)("dt", { children: localize("Tokens") }), (0, react_jsx_runtime.jsx)("dd", { children: cell.output === void 0 ? "—" : `${cell.output} tok` })] }),
				cell.think !== void 0 && (0, react_jsx_runtime.jsxs)("div", {
					className: TrajectoryTable_module_css_default.requestTokenDetail,
					children: [(0, react_jsx_runtime.jsx)("dt", { children: localize("Reasoning") }), (0, react_jsx_runtime.jsxs)("dd", { children: [cell.think, " tok"] })]
				}),
				content !== void 0 && (0, react_jsx_runtime.jsxs)("div", {
					className: TrajectoryTable_module_css_default.requestTokenDetail,
					children: [(0, react_jsx_runtime.jsx)("dt", { children: localize("Content") }), (0, react_jsx_runtime.jsxs)("dd", { children: [content, " tok"] })]
				})
			] });
		}
		...
		function UsageRows({ usage }) {
			...
			if (usage === void 0) return (0, react_jsx_runtime.jsx)("p", {
				...
				children: localize("Usage not reported")
			});
			...
			return (0, react_jsx_runtime.jsxs)("dl", {
				className: TrajectoryTable_module_css_default.overview,
				children: [
					totalInput !== void 0 && (0, react_jsx_runtime.jsxs)("div", { children: [(0, react_jsx_runtime.jsx)("dt", { children: localize("Input") }), (0, react_jsx_runtime.jsxs)("dd", { children: [totalInput, " tok"] })] }),
					usage.cacheRead !== void 0 && (0, react_jsx_runtime.jsxs)("div", {
						className: TrajectoryTable_module_css_default.requestTokenDetail,
						children: [(0, react_jsx_runtime.jsx)("dt", { children: localize("Cached") }), (0, react_jsx_runtime.jsxs)("dd", { children: [usage.cacheRead, " tok"] })]
					}),
					usage.cacheWrite !== void 0 && (0, react_jsx_runtime.jsxs)("div", {
						className: TrajectoryTable_module_css_default.requestTokenDetail,
						children: [(0, react_jsx_runtime.jsx)("dt", { children: localize("Cache created") }), (0, react_jsx_runtime.jsxs)("dd", { children: [usage.cacheWrite, " tok"] })]
					}),
					usage.input !== void 0 && (0, react_jsx_runtime.jsxs)("div", {
						className: TrajectoryTable_module_css_default.requestTokenDetail,
						children: [(0, react_jsx_runtime.jsx)("dt", { children: localize("Other") }), (0, react_jsx_runtime.jsxs)("dd", { children: [usage.input, " tok"] })]
					}),
					usage.output !== void 0 && (0, react_jsx_runtime.jsxs)("div", { children: [(0, react_jsx_runtime.jsx)("dt", { children: localize("Output") }), (0, react_jsx_runtime.jsxs)("dd", { children: [usage.output, " tok"] })] }),
					usage.reasoning !== void 0 && (0, react_jsx_runtime.jsxs)("div", {
						className: TrajectoryTable_module_css_default.requestTokenDetail,
						children: [(0, react_jsx_runtime.jsx)("dt", { children: localize("Reasoning") }), (0, react_jsx_runtime.jsxs)("dd", { children: [usage.reasoning, " tok"] })]
					}),
					otherOutput !== void 0 && (0, react_jsx_runtime.jsxs)("div", {
						className: TrajectoryTable_module_css_default.requestTokenDetail,
						children: [(0, react_jsx_runtime.jsx)("dt", { children: localize("Content") }), (0, react_jsx_runtime.jsxs)("dd", { children: [otherOutput, " tok"] })]
					})
				]
			});
		}
			...
			return (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [(0, react_jsx_runtime.jsxs)("section", {
					...
					children: [(0, react_jsx_runtime.jsx)("h4", {
						...
						children: localize("This request")
					}), (0, react_jsx_runtime.jsx)(UsageRows, { usage })]
				}), (0, react_jsx_runtime.jsxs)("section", {
					className: TrajectoryTable_module_css_default.usageGroup,
					children: [(0, react_jsx_runtime.jsx)("h4", {
						className: TrajectoryTable_module_css_default.usageHeading,
						children: localize("Session cumulative")
		...
		function MessageSource({ record }) {
			...
			if (source === void 0) return (0, react_jsx_runtime.jsx)("p", {
				className: TrajectoryTable_module_css_default.noPayload,
				children: localize("Source not recorded")
			});
			return (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.JsonTree, {
				data: typeof source === "object" && source !== null ? source : { value: source },
				label: localize("Message source JSON"),
		...
		function RecordPresentation({ cell, children }) {
			...
			return children({
				displayText,
				listDisplayText: toolCallOnly ? localize("(tool call only)") : toolCallText === void 0 ? displayText : [toolCallText.name, toolCallText.args].filter(Boolean).join(" "),
				resultText,
				toolCallOnly,
				toolCallText
			});
		...
		function RecordListText({ displayText, toolCallOnly, toolCallText }) {
			...
			if (toolCallOnly) return (0, react_jsx_runtime.jsx)("span", {
				...
				children: localize("(tool call only)")
			});
			...
			return (0, react_jsx_runtime.jsx)("div", {
				...
				children: blocks.map((block, index) => (0, react_jsx_runtime.jsxs)("section", {
					...
					children: [block.callId !== void 0 ? (0, react_jsx_runtime.jsxs)("button", {
						...
						title: localize("Open tool call summary"),
						onClick: () => {
		...
		function ToolCatalog({ tools }) {
			...
			if (tools.length === 0) return (0, react_jsx_runtime.jsx)("p", {
				className: TrajectoryTable_module_css_default.noPayload,
				children: localize("No tools in this request")
			});
			return (0, react_jsx_runtime.jsx)("div", {
		...
		function MarkdownRecordContent({ record, rendered, preview = false, thinkingExpanded, onThinkingExpandedChange, onOpenCall }) {
					...
					children: [
						(0, react_jsx_runtime.jsxs)("div", {
							...
							children: [(0, react_jsx_runtime.jsxs)("button", {
								...
								children: [localize("Thinking"), (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconChevronRightOutline14, {
			...
			if (!source && !hasImages && !hasToolCalls) {
				const emptyLabel = isToolCallOnly(record.cell) ? localize("Tool call only") : record.cell.text || localize("No content");
		...
		function RecordTiming({ record }) {
			...
			return record.cell.kind === "message" && record.cell.assistantMetrics !== void 0 ? (0, react_jsx_runtime.jsx)(AssistantTimingPanel, { metrics: record.cell.assistantMetrics }) : (0, react_jsx_runtime.jsxs)("dl", {
				className: TrajectoryTable_module_css_default.overview,
				children: [
					(0, react_jsx_runtime.jsxs)("div", { children: [(0, react_jsx_runtime.jsx)("dt", { children: localize("Started") }), (0, react_jsx_runtime.jsx)(StartedAtValue, { timestamp: record.cell.startedAt ?? null })] }),
					(0, react_jsx_runtime.jsxs)("div", { children: [(0, react_jsx_runtime.jsx)("dt", { children: localize("Duration") }), (0, react_jsx_runtime.jsx)("dd", { children: formatElapsedSeconds(record.cell.timeSeconds) })] }),
					(0, react_jsx_runtime.jsxs)("div", { children: [(0, react_jsx_runtime.jsx)("dt", { children: localize("Timing source") }), (0, react_jsx_runtime.jsx)("dd", { children: record.cell.timeSeconds === null ? localize("Not available") : localize("Session timestamps") })] })
				]
			});
		}
		function RequestTiming({ assistant, anchor, request }) {
			...
			if (request?.startedAt !== void 0) {
				...
				return (0, react_jsx_runtime.jsxs)("dl", {
					className: TrajectoryTable_module_css_default.overview,
					children: [
						(0, react_jsx_runtime.jsxs)("div", { children: [(0, react_jsx_runtime.jsx)("dt", { children: localize("Started") }), (0, react_jsx_runtime.jsx)(StartedAtValue, { timestamp: request.startedAt })] }),
						(0, react_jsx_runtime.jsxs)("div", { children: [(0, react_jsx_runtime.jsx)("dt", { children: localize("Duration") }), (0, react_jsx_runtime.jsx)("dd", { children: formatElapsedSeconds(duration) })] }),
						(0, react_jsx_runtime.jsxs)("div", { children: [(0, react_jsx_runtime.jsx)("dt", { children: localize("Timing source") }), (0, react_jsx_runtime.jsx)("dd", { children: duration === null ? localize("Session timestamps (running)") : localize("Session timestamps") })] })
					]
				});
			}
			return (0, react_jsx_runtime.jsxs)("dl", {
				className: TrajectoryTable_module_css_default.overview,
				children: [(0, react_jsx_runtime.jsxs)("div", { children: [(0, react_jsx_runtime.jsx)("dt", { children: localize("Started") }), (0, react_jsx_runtime.jsx)(StartedAtValue, { timestamp: anchor?.cell.startedAt ?? null })] }), (0, react_jsx_runtime.jsxs)("div", { children: [(0, react_jsx_runtime.jsx)("dt", { children: localize("Duration") }), (0, react_jsx_runtime.jsx)("dd", { children: formatElapsedSeconds(null) })] })]
			});
		}
		function RecordPayload({ record, direction, preview = false }) {
			...
			if (json !== void 0) return (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.JsonTree, {
				data: json,
				label: `${direction === "input" ? localize("Payload") : localize("Result")} JSON`,
				className: payloadClassName
			});
			return (0, react_jsx_runtime.jsx)("pre", {
				className: [
		...
		function RecordSchema({ record, preview = false }) {
			...
			if (!record.cell.schemaDetail) return (0, react_jsx_runtime.jsx)("p", {
				className: TrajectoryTable_module_css_default.noPayload,
				children: localize("Schema unavailable")
			});
			...
			return (0, react_jsx_runtime.jsxs)("section", {
				...
				children: [(0, react_jsx_runtime.jsx)("h3", {
					...
					children: (0, react_jsx_runtime.jsxs)("button", {
						...
						onClick: onOpen,
						children: [(0, react_jsx_runtime.jsx)("span", { children: localize(label) }), (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconChevronRightOutline14, {
		...
		*/
							...
							hasOlderRecords && (0, react_jsx_runtime.jsx)("tr", {
								...
								children: (0, react_jsx_runtime.jsx)("td", {
									...
									children: (0, react_jsx_runtime.jsxs)("button", {
										...
										"aria-label": olderBusy ? "Loading earlier history…" : localize("Load earlier history"),
										onClick: () => {
											const pane = tablePaneRef.current;
										...
										children: [
											...
											(0, react_jsx_runtime.jsx)("span", {
												"aria-hidden": "true",
												children: olderBusy ? "Loading earlier history…" : localize("Load earlier history")
											}),
											(0, react_jsx_runtime.jsx)("span", {
										...
										children: [(0, react_jsx_runtime.jsxs)("td", {
											...
											children: [
												...
												!isCollapsedSummary && !isRequestOnly && record.turnStart && (0, react_jsx_runtime.jsx)("span", {
													...
													"aria-label": localize(sectionLabel(record.turn)),
													children: record.turn === null ? localize(sectionLabel(record.turn)) : (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [(0, react_jsx_runtime.jsx)("span", {
														className: TrajectoryTable_module_css_default.turnLabelFull,
														"aria-hidden": "true",
														children: localize(sectionLabel(record.turn))
													}), (0, react_jsx_runtime.jsxs)("span", {
													...
													children: !isCollapsedSummary && !isRequestOnly && (0, react_jsx_runtime.jsx)("span", {
														...
														children: (0, react_jsx_runtime.jsxs)("span", {
															...
															children: [(0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Tooltip, {
																...
																children: localize(KIND_LABEL[record.cell.kind])
															})]
														})
													})
												})
							...
							children: [(0, react_jsx_runtime.jsx)("div", {
								...
								children: selectedRequest !== null ? (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
									...
									(0, react_jsx_runtime.jsxs)("span", {
										...
										children: [localize("Request #"), selectedRequestNumber ?? "—"]
									}),
									(0, react_jsx_runtime.jsx)("span", {
										className: TrajectoryTable_module_css_default.detailsLocation,
										children: selectedRequestInfo?.purpose === "compaction" ? `Compaction · ${localize(sectionLabel(selectedRequest.turn))}` : localize(sectionLabel(selectedRequest.turn))
									})
									...
									children: localize(KIND_LABEL[selected.cell.kind])
								}), (0, react_jsx_runtime.jsx)("span", {
									className: TrajectoryTable_module_css_default.detailsLocation,
									children: selected.cell.kind === "compacted" ? localize(sectionLabel(selected.turn)) : `${localize(sectionLabel(selected.turn))} · ${selected.group}`
								})] })
							}), (0, react_jsx_runtime.jsx)("button", {
								type: "button",
								className: TrajectoryTable_module_css_default.close,
								"aria-label": localize("Close details"),
						...
						(0, react_jsx_runtime.jsxs)("div", {
							...
							children: [
								selectedRequest !== null && selectedRequestState !== void 0 && activeTab === "overview" && (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [(0, react_jsx_runtime.jsxs)("dl", {
									...
									"data-summary-scroll-region": "",
									children: [
										(0, react_jsx_runtime.jsxs)("div", { children: [(0, react_jsx_runtime.jsx)("dt", { children: localize("Status") }), (0, react_jsx_runtime.jsx)("dd", {
											className: selectedRequestState === "error" ? TrajectoryTable_module_css_default.error : void 0,
											children: localize(statusLabel(selectedRequestState))
										})] }),
										selectedRequestInfo?.purpose === "compaction" && (0, react_jsx_runtime.jsxs)("div", { children: [(0, react_jsx_runtime.jsx)("dt", { children: localize("Purpose") }), (0, react_jsx_runtime.jsx)("dd", { children: localize("Compaction") })] }),
										(selectedRequestInfo?.provider ?? selectedRequestInfo?.requestConfig?.provider) !== void 0 && (0, react_jsx_runtime.jsxs)("div", { children: [(0, react_jsx_runtime.jsx)("dt", { children: localize("Provider") }), (0, react_jsx_runtime.jsx)("dd", { children: selectedRequestInfo?.provider ?? selectedRequestInfo?.requestConfig?.provider })] }),
										(selectedRequestInfo?.model ?? selectedRequestInfo?.requestConfig?.model) !== void 0 && (0, react_jsx_runtime.jsxs)("div", { children: [(0, react_jsx_runtime.jsx)("dt", { children: localize("Model") }), (0, react_jsx_runtime.jsx)("dd", { children: selectedRequestInfo?.model ?? selectedRequestInfo?.requestConfig?.model })] }),
										(0, react_jsx_runtime.jsxs)("div", { children: [(0, react_jsx_runtime.jsx)("dt", { children: localize("Tool calls") }), (0, react_jsx_runtime.jsx)("dd", { children: selectedRequestToolCalls })] }),
										selectedRequestSubtoolCalls > 0 && (0, react_jsx_runtime.jsxs)("div", { children: [(0, react_jsx_runtime.jsx)("dt", { children: localize("Subtool calls") }), (0, react_jsx_runtime.jsx)("dd", { children: selectedRequestSubtoolCalls })] }),
										selectedRequestInfo?.error !== void 0 && (0, react_jsx_runtime.jsxs)("div", { children: [(0, react_jsx_runtime.jsx)("dt", { children: localize("Error") }), (0, react_jsx_runtime.jsx)("dd", {
											className: TrajectoryTable_module_css_default.error,
											children: selectedRequestInfo.error
										})] }),
										selectedRequestInfo?.retry !== void 0 && (0, react_jsx_runtime.jsxs)("div", { children: [(0, react_jsx_runtime.jsx)("dt", { children: localize("Retry") }), (0, react_jsx_runtime.jsxs)("dd", { children: [
											"Scheduled ",
											selectedRequestInfo.retry,
											selectedRequestInfo.maxRetries === void 0 ? "" : ` of ${selectedRequestInfo.maxRetries}`
										] })] }),
										selectedRequestInfo?.retryDelayMs !== void 0 && (0, react_jsx_runtime.jsxs)("div", { children: [(0, react_jsx_runtime.jsx)("dt", { children: localize("Retry delay") }), (0, react_jsx_runtime.jsx)("dd", { children: formatDurationMs(selectedRequestInfo.retryDelayMs) })] }),
										selectedRequestResult !== void 0 && (0, react_jsx_runtime.jsxs)("div", { children: [(0, react_jsx_runtime.jsx)("dt", { children: localize("Result") }), (0, react_jsx_runtime.jsx)("dd", {
											...
											children: (0, react_jsx_runtime.jsxs)("button", {
												...
												children: [(0, react_jsx_runtime.jsx)("span", { children: selectedRequestInfo?.purpose === "compaction" ? localize("Compacted") : localize("Assistant Message") }), (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconChevronRightOutline14, {
								...
								promptSelected && activeTab === "system-prompt" && (selectedPrompt.system === "" ? (0, react_jsx_runtime.jsx)("p", {
									className: TrajectoryTable_module_css_default.noPayload,
									children: localize("No system prompt in this request")
								}) : (0, react_jsx_runtime.jsx)("div", {
								...
								!promptSelected && selected?.cell.kind === "compacted" && selectedState !== void 0 && activeTab === "overview" && (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [(0, react_jsx_runtime.jsxs)("dl", {
									...
									children: [
										(0, react_jsx_runtime.jsxs)("div", { children: [(0, react_jsx_runtime.jsx)("dt", { children: localize("Status") }), (0, react_jsx_runtime.jsx)("dd", {
											...
											children: localize(statusLabel(selectedState))
										})] }),
										(0, react_jsx_runtime.jsxs)("div", { children: [(0, react_jsx_runtime.jsx)("dt", { children: localize("Duration") }), (0, react_jsx_runtime.jsx)("dd", { children: formatElapsedSeconds(selected.cell.timeSeconds) })] }),
										(0, react_jsx_runtime.jsxs)("div", { children: [(0, react_jsx_runtime.jsx)("dt", { children: localize("Tokens") }), (0, react_jsx_runtime.jsx)("dd", { children: "—" })] })
									]
								...
								!promptSelected && selected !== void 0 && selected.cell.kind !== "compacted" && selectedState !== void 0 && activeTab === "overview" && (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [(0, react_jsx_runtime.jsxs)("dl", {
									...
									"data-summary-scroll-region": "",
									children: [
										selected.cell.messageSource !== void 0 && (0, react_jsx_runtime.jsxs)("div", { children: [(0, react_jsx_runtime.jsx)("dt", { children: localize("Source") }), (0, react_jsx_runtime.jsx)("dd", {
											className: TrajectoryTable_module_css_default.overviewParentLinks,
											children: (0, react_jsx_runtime.jsxs)("button", {
												type: "button",
												className: TrajectoryTable_module_css_default.overviewHierarchyNavLink,
										...
										hasSelectedHierarchy && (0, react_jsx_runtime.jsxs)("div", { children: [(0, react_jsx_runtime.jsx)("dt", { children: selectedAssistantRequestTarget !== void 0 ? localize("Source") : localize("Hierarchy") }), (0, react_jsx_runtime.jsxs)("dd", {
											className: TrajectoryTable_module_css_default.overviewParentLinks,
											children: [
												selectedAssistantRequestTarget !== void 0 && (0, react_jsx_runtime.jsxs)("button", {
													...
													children: [(0, react_jsx_runtime.jsxs)("span", { children: [localize("Request #"), selectedAssistantRequest ?? "—"] }), (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconChevronRightOutline14, {
														className: TrajectoryTable_module_css_default.overviewHierarchyJumpIconTight,
														size: 11
													})]
												}),
												selectedParentMessage !== void 0 && (0, react_jsx_runtime.jsxs)("button", {
													...
													children: [(0, react_jsx_runtime.jsx)("span", { children: localize("Assistant Message") }), (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconChevronRightOutline14, {
														className: TrajectoryTable_module_css_default.overviewHierarchyJumpIconTight,
														size: 11
													})]
												}),
												selectedParentTool !== void 0 && (0, react_jsx_runtime.jsxs)("button", {
													...
													children: [(0, react_jsx_runtime.jsx)("span", { children: localize("Tool Call") }), (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconChevronRightOutline14, {
														className: TrajectoryTable_module_css_default.overviewHierarchyJumpIconTight,
														size: 11
													})]
												})
										...
										(selected.cell.kind === "user" || selected.cell.kind === "context") && (0, react_jsx_runtime.jsxs)("div", { children: [(0, react_jsx_runtime.jsx)("dt", { children: localize("Duration") }), (0, react_jsx_runtime.jsx)("dd", { children: formatElapsedSeconds(selected.cell.timeSeconds) })] })
									]
								}), (0, react_jsx_runtime.jsxs)("div", {
									className: TrajectoryTable_module_css_default.overviewSections,
									children: [
		...
		//#endregion
		//#region \0dsh-css:D:\HermesTemp\deepseek-harness\packages\client\ui-trajectory\src\client\TrajectoryToolbar.module.css.mjs
		const css$2 = ".OwcNsq_root{z-index:4;box-sizing:border-box;width:100%;height:var(--dsh-trajectory-toolbar-height);border-bottom:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);position:sticky;top:0}.OwcNsq_inner{box-sizing:border-box;align-items:center;gap:8px;width:100%;height:100%;padding:0 6px;display:flex}.OwcNsq_actions{flex:none;align-items:center;gap:2px;display:flex}.OwcNsq_toggle{height:20px;color:var(--dsw-alias-label-tertiary);cursor:pointer;font:var(--dsw-font-xxs-12);background:0 0;border:0;border-radius:3px;flex:none;align-items:center;gap:4px;padding:0 7px;display:inline-flex}.OwcNsq_toggle:hover,.OwcNsq_toggle[aria-pressed=true]{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover)}.OwcNsq_toggle:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:1px}.OwcNsq_toggleIcon{stroke:currentColor;stroke-width:1.25px;stroke-linecap:round;stroke-linejoin:round;flex:none;width:12px;height:12px}.OwcNsq_control{box-sizing:border-box;width:88px;height:20px;color:var(--dsw-alias-label-tertiary);cursor:pointer;font:var(--dsw-font-xxs-12);background:0 0;border:0;border-radius:0;flex:none;justify-content:center;align-items:center;gap:4px;padding:0 5px;display:inline-flex}.OwcNsq_control[hidden]{display:none}.OwcNsq_control:hover:not(:disabled),.OwcNsq_control[aria-checked=true],.OwcNsq_control[aria-pressed=true]{color:var(--dsw-alias-label-primary)}.OwcNsq_control:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:1px}.OwcNsq_control:disabled{color:var(--dsw-alias-label-dimmed);cursor:not-allowed}.OwcNsq_controlTrack{background:var(--dsw-alias-border-l2);width:20px;height:10px;transition:background-color .12s var(--ds-ease-in-out);border-radius:5px;flex:none;display:inline-block;position:relative}.OwcNsq_controlThumb{background:var(--dsw-alias-bg-layer-1);width:6px;height:6px;transition:transform .12s var(--ds-ease-in-out);border-radius:50%;position:absolute;top:2px;left:2px}.OwcNsq_controlTrack[data-on=true]{background:var(--dsw-alias-state-business-primary)}.OwcNsq_controlTrack[data-on=true] .OwcNsq_controlThumb{transform:translate(10px)}.OwcNsq_action{height:20px;color:var(--dsw-alias-label-tertiary);cursor:pointer;font:var(--dsw-font-xxs-12);background:0 0;border:0;border-radius:3px;flex:none;align-items:center;gap:4px;padding:0 5px;display:inline-flex}.OwcNsq_action:hover{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover)}.OwcNsq_action:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:1px}.OwcNsq_actionIcon{color:var(--dsw-alias-label-tertiary);font:14px/14px var(--ds-font-family-code)}.OwcNsq_search{border:1px solid var(--dsw-alias-border-l2);min-width:84px;height:22px;color:var(--dsw-alias-label-caption);background:var(--dsw-alias-bg-layer-2);border-radius:4px;flex:0 164px;align-items:center;gap:4px;margin-left:auto;padding:0 6px;display:flex}.OwcNsq_search:hover{border-color:var(--dsw-alias-label-caption)}.OwcNsq_search:focus-within{border-color:var(--dsw-alias-state-business-primary);background:var(--dsw-alias-bg-layer-1)}.OwcNsq_searchIcon{flex:none}.OwcNsq_searchInput{width:100%;min-width:0;color:var(--dsw-alias-label-primary);font:var(--dsw-font-xxs-12);background:0 0;border:0;outline:0;padding:0}.OwcNsq_searchInput::placeholder{color:var(--dsw-alias-label-caption)}.OwcNsq_searchInput::-webkit-search-cancel-button{cursor:pointer;width:12px;height:12px}";
		...
		var TrajectoryToolbar_module_css_default = {
			"actions": "OwcNsq_actions",
			"toggle": "OwcNsq_toggle",
			"toggleIcon": "OwcNsq_toggleIcon",
			"control": "OwcNsq_control",
			"inner": "OwcNsq_inner",
			"controlTrack": "OwcNsq_controlTrack",
			"controlThumb": "OwcNsq_controlThumb",
			"action": "OwcNsq_action",
			"actionIcon": "OwcNsq_actionIcon",
			"search": "OwcNsq_search",
			"searchIcon": "OwcNsq_searchIcon",
			"searchInput": "OwcNsq_searchInput",
			"root": "OwcNsq_root"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\HermesTemp\deepseek-harness\packages\client\ui-trajectory\src\client\TrajectoryTimeline.module.css.mjs
		const css$1 = ".vc0aAG_root{z-index:1;isolation:isolate;border-bottom:1px solid var(--dsw-alias-border-l2);user-select:none;flex:none;position:relative}.vc0aAG_root [role=tooltip]{font:var(--dsw-font-xxxs-11)}.vc0aAG_plot{background:var(--dsw-alias-bg-layer-2);grid-template-columns:44px minmax(0,1fr);height:50px;display:grid;overflow:hidden}.vc0aAG_labels{border-right:1px solid var(--dsw-alias-border-l1);color:var(--dsw-alias-label-caption);font:var(--dsw-font-xs-13);font-size:10px;line-height:1;position:relative}.vc0aAG_labels span{text-align:right;justify-content:flex-end;align-items:center;height:8px;display:flex;position:absolute;right:3px}.vc0aAG_labels span:first-child{top:7px}.vc0aAG_labels span:nth-child(2){top:21px}.vc0aAG_labels span:nth-child(3){top:35px}.vc0aAG_track{cursor:crosshair;touch-action:none;position:relative;overflow:hidden}.vc0aAG_track[data-panning=true]{cursor:grabbing}.vc0aAG_earlierHistory{z-index:5;appearance:none;box-sizing:border-box;background:linear-gradient(to right, var(--dsw-alias-bg-layer-2) 0, var(--dsw-alias-bg-layer-2) 38%, transparent 100%);width:28px;color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-13);opacity:.72;cursor:pointer;border:0;outline:none;justify-content:flex-start;align-items:center;padding-left:3px;line-height:1;display:flex;position:absolute;top:0;bottom:0;left:0}.vc0aAG_earlierHistory:hover{opacity:1}.vc0aAG_earlierHistory[aria-disabled=true]{cursor:default}.vc0aAG_earlierHistory:focus-visible{box-shadow:inset 0 0 0 1px var(--dsw-alias-border-l2)}.vc0aAG_empty{color:var(--dsw-alias-label-caption);font:var(--dsw-font-xs-13);position:absolute;top:50%;left:50%;transform:translate(-50%,-50%)}.vc0aAG_track:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}.vc0aAG_lanes{z-index:2;top:7px;bottom:7px;left:var(--trajectory-domain-left);width:var(--trajectory-domain-width);position:absolute}.vc0aAG_turnBoundaries{z-index:3;top:0;bottom:0;left:var(--trajectory-domain-left);width:var(--trajectory-domain-width);pointer-events:none;position:absolute}@media (prefers-reduced-motion:no-preference){.vc0aAG_lanes[data-animate-viewport=true],.vc0aAG_turnBoundaries[data-animate-viewport=true]{transition:left .18s ease-out}}.vc0aAG_turnBoundary{top:0;bottom:0;left:var(--trajectory-turn-left);background:var(--dsw-alias-border-l2);width:1px;position:absolute}.vc0aAG_span{top:calc(var(--trajectory-span-lane) * 14px);left:calc(var(--trajectory-span-left) + var(--trajectory-span-gap));width:max(2px, calc(var(--trajectory-span-width) - var(--trajectory-span-gap) - var(--trajectory-span-gap)));background:var(--dsw-alias-label-secondary);opacity:.78;border-radius:1px;min-width:2px;height:8px;position:absolute}.vc0aAG_span[data-timeline-span=user]{background:var(--dsw-alias-state-business-primary)}.vc0aAG_span[data-timeline-span=context]{background:color-mix(in srgb, var(--dsw-alias-state-success-primary) 68%, var(--dsw-alias-label-secondary))}.vc0aAG_span[data-timeline-span=message]{--trajectory-assistant-decoding-color:color-mix(in srgb, var(--dsw-alias-brand-primary-new-colorprimary-new-color) 60%, var(--dsw-alias-state-error-secondary));--trajectory-assistant-ttft-color:color-mix(in srgb, var(--trajectory-assistant-decoding-color) 54%, var(--dsw-alias-bg-layer-2));background:var(--trajectory-assistant-decoding-color);opacity:1}.vc0aAG_span[data-timeline-span=message][data-assistant-timing=true]{background:linear-gradient(to right, var(--trajectory-assistant-ttft-color) 0, var(--trajectory-assistant-ttft-color) var(--trajectory-assistant-ttft), var(--trajectory-assistant-decoding-color) var(--trajectory-assistant-ttft), var(--trajectory-assistant-decoding-color) 100%)}.vc0aAG_span[data-timeline-span=tool],.vc0aAG_span[data-timeline-span=subtool]{background:var(--dsw-alias-state-warn-label);opacity:1}.vc0aAG_span[data-error=true]{background:var(--dsw-alias-state-error-primary)}.vc0aAG_span[data-equal-duration=true]{width:8px;min-width:8px}.vc0aAG_span[data-selected=false]{opacity:.2}.vc0aAG_span[data-hovered=true]:not([data-current=true]){z-index:1;opacity:1;box-shadow:0 0 0 1px var(--dsw-alias-bg-layer-2), 0 0 0 2px color-mix(in srgb, var(--dsw-alias-state-business-primary) 80%, transparent)}.vc0aAG_span[data-current=true]{z-index:1;opacity:1;box-shadow:0 0 0 1px var(--dsw-alias-bg-layer-2), 0 0 0 2px var(--dsw-alias-state-business-primary)}.vc0aAG_span[data-search-match=false]{opacity:.14}.vc0aAG_selection{z-index:1;top:0;bottom:0;left:var(--trajectory-selection-left);width:var(--trajectory-selection-width);background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 12%, transparent);min-width:1px;box-shadow:-100vw 0 0 100vw color-mix(in srgb, var(--dsw-alias-bg-layer-1) 58%, transparent), 100vw 0 0 100vw color-mix(in srgb, var(--dsw-alias-bg-layer-1) 58%, transparent);pointer-events:none;position:absolute}.vc0aAG_selectionEdges{z-index:4;top:0;bottom:0;left:var(--trajectory-selection-left);width:var(--trajectory-selection-width);pointer-events:none;min-width:1px;position:absolute}.vc0aAG_hoverLine{z-index:4;top:0;bottom:0;left:clamp(0px, calc(var(--trajectory-hover-left) - 1px), calc(100% - 2px));background:var(--dsw-alias-state-business-primary);pointer-events:none;width:2px;position:absolute}.vc0aAG_selectionEdges:before,.vc0aAG_selectionEdges:after{background:var(--dsw-alias-state-business-primary);content:\"\";width:3px;position:absolute;top:0;bottom:0}.vc0aAG_selectionEdges:before{left:0}.vc0aAG_selectionEdges:after{right:0}.vc0aAG_selectionEdges[data-dragging=true]:before,.vc0aAG_selectionEdges[data-dragging=true]:after{width:2px}.vc0aAG_selection[data-dragging=true]{background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 18%, transparent)}";
		...
		var TrajectoryTimeline_module_css_default = {
			"labels": "vc0aAG_labels",
			"lanes": "vc0aAG_lanes",
			"turnBoundaries": "vc0aAG_turnBoundaries",
			"span": "vc0aAG_span",
			"empty": "vc0aAG_empty",
			"track": "vc0aAG_track",
			"selection": "vc0aAG_selection",
			"root": "vc0aAG_root",
			"plot": "vc0aAG_plot",
			"selectionEdges": "vc0aAG_selectionEdges",
			"hoverLine": "vc0aAG_hoverLine",
			"earlierHistory": "vc0aAG_earlierHistory",
			"turnBoundary": "vc0aAG_turnBoundary"
		};
		//#endregion
		...
		function LaneLabels() {
			...
			return (0, react_jsx_runtime.jsxs)("div", {
				...
				"aria-hidden": "true",
				children: [
					(0, react_jsx_runtime.jsx)("span", { children: localize("Input") }),
					(0, react_jsx_runtime.jsx)("span", { children: localize("Model") }),
					(0, react_jsx_runtime.jsx)("span", { children: localize("Tools") })
				]
			});
		}
		function EarlierHistoryBoundary({ loading, onHover, onLoad }) {
			...
			return (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Tooltip, {
				...
				children: (0, react_jsx_runtime.jsx)("button", {
					...
					"aria-label": loading ? "Loading earlier history" : localize("Load earlier history"),
		...
		const TrajectoryTimeline = (0, react.memo)(function TrajectoryTimeline({ turns, mode, range, hasEarlierRecords = false, onLoadEarlier, selectedIndex = null, searchMatchIndexes = null, onRangeChange, onRecordSelect, onRecordFocus }) {
			...
			if (model === null) return (0, react_jsx_runtime.jsx)("section", {
				...
				"aria-label": localize("Trajectory timeline"),
				children: (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [(0, react_jsx_runtime.jsx)(LaneLabels, {}), (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [(0, react_jsx_runtime.jsx)("span", {
							...
							children: localize("No timing data")
			...
			return (0, react_jsx_runtime.jsx)("section", {
				...
				children: (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [(0, react_jsx_runtime.jsx)(LaneLabels, {}), (0, react_jsx_runtime.jsxs)("div", {
						...
						"aria-label": localize("Timeline overview; drag horizontally to focus events"),
						tabIndex: 0,
						onKeyDown,
						onPointerDown,
						onPointerMove,
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\HermesTemp\deepseek-harness\packages\client\ui-trajectory\src\client\views.module.css.mjs
		const css = ".V4Cfwq_root{--dsh-trajectory-toolbar-height:32px;box-sizing:border-box;width:100%;height:100%;min-height:0;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-1);flex-direction:column;display:flex;overflow:hidden}.V4Cfwq_ledger{z-index:0;isolation:isolate;--dsh-trajectory-bottom-clearance:calc(var(--dsh-composer-height,152px) + 16px);flex:1;min-width:0;min-height:0;display:flex;position:relative;overflow:hidden}";
		...
		function TrajectoryView({ useSession, useDuration, loadOlder, setActualDuration, inspect, onInspectDone, t }) {
			...
			const completeInspection = useSession((snapshot) => snapshot.views.get("trajectory") ?? EMPTY_TRAJECTORY_SNAPSHOT);
