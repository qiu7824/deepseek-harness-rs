window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		var fields_module_css_default = {
			"badgeMuted": "KMY8pG_badgeMuted",
			"head": "KMY8pG_head",
			"input": "KMY8pG_input",
			"badges": "KMY8pG_badges",
			"invalid": "KMY8pG_invalid",
			"hint": "KMY8pG_hint",
			"badge": "KMY8pG_badge",
			"label": "KMY8pG_label",
			"inputInvalid": "KMY8pG_inputInvalid",
			"field": "KMY8pG_field",
			"reset": "KMY8pG_reset"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\HermesTemp\deepseek-harness\packages\client\ui-settings-plugins\src\client\PluginCard.module.css.mjs
		const css$1 = ".RyFx_G_card{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);border-radius:12px;list-style:none;transition:border-color .16s,background .16s}.RyFx_G_card:hover{border-color:var(--dsw-alias-label-dimmed)}.RyFx_G_cardOpen{background:var(--dsw-alias-bg-layer-2);border-color:var(--dsw-alias-label-dimmed)}.RyFx_G_header{appearance:none;width:100%;font:inherit;color:inherit;text-align:left;cursor:pointer;background:0 0;border:0;border-radius:12px;align-items:center;gap:12px;padding:14px 16px;display:flex}.RyFx_G_header:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:-2px}.RyFx_G_headText{flex-direction:column;flex:1;gap:4px;min-width:0;display:flex}.RyFx_G_name{color:var(--dsw-alias-label-primary);font-size:15px;font-weight:600;line-height:1.4}.RyFx_G_description{color:var(--dsw-alias-label-tertiary);font-size:13px;line-height:1.5}.RyFx_G_chevron{color:var(--dsw-alias-label-tertiary);flex:none;transition:transform .16s}.RyFx_G_chevronOpen{transform:rotate(180deg)}.RyFx_G_body{border-top:1px solid var(--dsw-alias-border-l2);margin:0 16px;padding-bottom:8px}.RyFx_G_readOnly{color:var(--dsw-alias-label-tertiary);margin:12px 0 0;font-size:12px;line-height:1.5}.RyFx_G_pending{white-space:nowrap;background:var(--dsw-alias-bg-module-platform);color:var(--dsw-alias-label-secondary);border-radius:999px;flex:none;padding:1px 8px;font-size:11px;font-weight:500;line-height:17px}.RyFx_G_footer{border-top:1px solid var(--dsw-alias-border-l2);justify-content:flex-end;align-items:center;gap:8px;padding:12px 0 4px;display:flex}.RyFx_G_failed{min-width:0;color:var(--dsw-alias-label-error);flex:1;margin:0;font-size:12px;line-height:1.5}.RyFx_G_discard,.RyFx_G_save{appearance:none;font:inherit;cursor:pointer;border:1px solid #0000;border-radius:8px;padding:5px 14px;font-size:13px;line-height:1.5}.RyFx_G_discard{border-color:var(--dsw-alias-border-l2);color:var(--dsw-alias-label-secondary);background:0 0}.RyFx_G_discard:hover:not(:disabled){color:var(--dsw-alias-label-primary);border-color:var(--dsw-alias-label-dimmed)}.RyFx_G_save{background:var(--dsw-alias-label-primary);color:var(--dsw-alias-bg-layer-3)}.RyFx_G_discard:disabled,.RyFx_G_save:disabled{opacity:.4;cursor:default}.RyFx_G_discard:focus-visible,.RyFx_G_save:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:1px}";
		...
		var PluginCard_module_css_default = {
			"description": "RyFx_G_description",
			"cardOpen": "RyFx_G_cardOpen",
			"name": "RyFx_G_name",
			"header": "RyFx_G_header",
			"save": "RyFx_G_save",
			"card": "RyFx_G_card",
			"discard": "RyFx_G_discard",
			"body": "RyFx_G_body",
			"readOnly": "RyFx_G_readOnly",
			"failed": "RyFx_G_failed",
			"chevron": "RyFx_G_chevron",
			"footer": "RyFx_G_footer",
			"pending": "RyFx_G_pending",
			"chevronOpen": "RyFx_G_chevronOpen",
			"headText": "RyFx_G_headText"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\HermesTemp\deepseek-harness\packages\client\ui-settings-plugins\src\client\PluginsSettingsSection.module.css.mjs
		const css = ".-FWsIq_section{max-width:760px;color:var(--dsw-alias-label-primary);flex-direction:column;gap:12px;display:flex}.-FWsIq_heading{margin:0;font-size:18px;font-weight:600}.-FWsIq_intro{color:var(--dsw-alias-label-tertiary);margin:0;font-size:13px}.-FWsIq_tabs{border-bottom:1px solid var(--dsw-alias-border-l2);align-items:flex-end;gap:22px;margin-top:2px;display:flex}.-FWsIq_tab{color:var(--dsw-alias-label-tertiary);font:inherit;cursor:pointer;background:0 0;border:0;padding:7px 1px 9px;font-size:13px;line-height:20px;position:relative}.-FWsIq_tab:hover,.-FWsIq_tab[data-active=true]{color:var(--dsw-alias-label-primary)}.-FWsIq_tab[data-active=true]:after,.-FWsIq_tab:focus-visible:after{background:var(--dsw-alias-label-primary);content:\"\";border-radius:2px 2px 0 0;height:2px;position:absolute;bottom:-1px;left:0;right:0}.-FWsIq_tab:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:2px;color:var(--dsw-alias-label-primary);border-radius:2px}.-FWsIq_panel{min-width:0;padding-top:2px}.-FWsIq_cards{flex-direction:column;gap:10px;margin:0;padding:0;list-style:none;display:flex}.-FWsIq_empty{color:var(--dsw-alias-label-tertiary);margin:0;font-size:13px}";
		...
		var PluginsSettingsSection_module_css_default = {
			...
			"panel": "-FWsIq_panel",
			"empty": "-FWsIq_empty",
			"heading": "-FWsIq_heading",
			"intro": "-FWsIq_intro",
			"section": "-FWsIq_section",
			"tabs": "-FWsIq_tabs"
		};
		//#endregion
		...
		const pluginCenterControlsCss="\n.dshPluginInstall{font:inherit;line-height:1.6;color:var(--dsw-alias-label-primary)}\n.dshPluginInstall{display:flex;flex-direction:column;gap:14px;padding:20px!important;box-sizing:border-box}\n.dshPluginInstall h3,.dshPluginInstall p{margin:0}.dshPluginInstall p{color:var(--dsw-alias-label-secondary)}\n.dshPluginInstall label{display:flex;flex-wrap:wrap;align-items:center;gap:8px}\n.dshPluginInstall label{display:flex;flex-direction:column;align-items:stretch;gap:6px}\n.dshPluginInstall :is(input:not([type=checkbox]),select,textarea){box-sizing:border-box;max-width:100%;min-height:38px;padding:8px 10px;font:inherit;color:inherit;background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l2,#dedede);border-radius:8px}\n.dshPluginInstall button,.dshPluginCenter>button{min-height:36px;padding:7px 13px;font:inherit;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l2,#dedede);border-radius:8px;cursor:pointer;align-self:flex-start}\n.dshPluginCenter>button{margin:0 0 12px}.dshPluginCenter h1{font-size:24px;margin:0 0 20px}\n.dshPluginInstall button:disabled{opacity:.5;cursor:default}\n:is(.dshPluginInstall,.dshPluginCenter) :focus-visible{outline:2px solid var(--dsw-alias-state-business-primary,#5067ed);outline-offset:2px}\n\n@media(max-width:600px){.dshPluginCenter{padding:16px!important}.dshPluginInstall{padding:14px!important}}\n";
        async function pluginOperationRequest(input,signal){
            const response=await fetch("/__dsh-plugin-manager",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(input),signal});
            const value=await response.json();if(!response.ok)throw new Error(value.error||"插件操作失败");return value;
        }
        function pluginOperationActive(operation){return operation&&["running","cancelling","awaiting-client","rolling-back","committing"].includes(operation.phase);}
        function PluginInstallControls(){
            react.useEffect(()=>{const style=document.createElement("style");style.dataset.pluginCenterControls="1";style.textContent=pluginCenterControlsCss;document.head.appendChild(style);return()=>style.remove();},[]);
            const [spec,setSpec]=react.useState(""),[action,setAction]=react.useState("add"),[sending,setSending]=react.useState(false),[confirm,setConfirm]=react.useState(false),[error,setError]=react.useState(""),[operation,setOperation]=react.useState(null),[configurationError,setConfigurationError]=react.useState(""),[clientFailures,setClientFailures]=react.useState([]);
            const alive=react.useRef(false),generation=react.useRef(0),inFlight=react.useRef(false);
            react.useEffect(()=>{
                alive.current=true;const abort=new AbortController();let timer,disposed=false;
                const refresh=async()=>{const captured=generation.current;let delay=5000;try{const value=await pluginOperationRequest({action:"status"},abort.signal);delay=pluginOperationActive(value.operation)?750:5000;if(!disposed&&alive.current&&captured===generation.current){setOperation(value.operation);setConfigurationError(value.configurationError||"");setClientFailures(Array.isArray(globalThis.__DSH_PLUGIN_FAILURES__)?globalThis.__DSH_PLUGIN_FAILURES__.slice():[]);}}catch(e){if(!disposed&&alive.current&&e.name!=="AbortError"&&captured===generation.current)setError(e.message);}finally{if(!disposed&&alive.current)timer=setTimeout(refresh,delay);}};
                refresh();return()=>{disposed=true;alive.current=false;clearTimeout(timer);abort.abort();};
            },[]);
            const mutate=async(input)=>{if(inFlight.current)return;inFlight.current=true;setSending(true);setError("");generation.current++;try{const value=await pluginOperationRequest(input);if(alive.current){setOperation(value.operation);setConfirm(false);}}catch(e){if(alive.current)setError(e.message);}finally{generation.current++;inFlight.current=false;if(alive.current)setSending(false);}};
            const busy=sending||pluginOperationActive(operation),h=react.createElement;
            const phase={running:"正在处理","awaiting-client":"等待界面切换","rolling-back":"正在恢复原状态",committing:"正在保存",cancelling:"正在取消并清理",succeeded:"已完成",failed:"操作失败",cancelled:"已取消",interrupted:"操作被中断","recovery-required":"需要恢复检查"}[operation?.phase]||"";
            return h("section",{className:"dshSettingsDisclosure dshPluginInstall",style:{marginBottom:20,maxWidth:760}},
                h("h3",null,"安装与移除"),h("p",null,"支持纯 Web 插件，来源需要完整提交 SHA。"),
                clientFailures.map(failure=>h("p",{key:failure.id,role:"alert"},`插件 ${failure.id} 无法启动：${failure.message}。其他功能可继续使用，可在插件清单中停用或移除。`)),
                configurationError&&h("div",{role:"alert"},h("p",null,configurationError),h("button",{disabled:busy,onClick:()=>mutate({action:"recover"})},"恢复上次有效配置")),
                h("label",null,"操作",h("select",{value:action,disabled:busy,onChange:e=>{setAction(e.target.value);setConfirm(false)}},h("option",{value:"add"},"安装 / 更新"),h("option",{value:"remove"},"移除"))),
                h("label",null,action==="add"?"GitHub 来源":"已安装包名",h("input",{value:spec,disabled:busy,maxLength:400,placeholder:action==="add"?"github:owner/repo#完整提交 SHA":"@scope/package",onChange:e=>{setSpec(e.target.value);setConfirm(false)},style:{width:"100%",boxSizing:"border-box"}})),
                h("button",{type:"button",disabled:busy||!spec.trim(),onClick:()=>setConfirm(true)},busy?"正在处理…":"检查操作"),
                confirm&&h("div",null,h("p",null,action==="add"?"插件将在浏览器中运行；确认信任此来源并安装？":"移除后重启应用生效；确认移除此插件？"),h("button",{disabled:busy,onClick:()=>mutate({action,spec:spec.trim()})},"确认"),h("button",{disabled:busy,onClick:()=>setConfirm(false)},"取消")),
                operation&&h("div",{"aria-live":"polite"},h("p",{role:"status"},phase),pluginOperationActive(operation)&&h("button",{type:"button",disabled:sending||operation.phase==="cancelling",onClick:()=>mutate({action:"cancel",operationId:operation.operationId})},"取消操作"),operation.restartRequired&&h("p",null,"更新已提交，重启应用后生效。"),operation.error&&h("p",{role:"alert"},operation.error),operation.log&&h("pre",{style:{whiteSpace:"pre-wrap",overflowWrap:"anywhere",maxHeight:240,overflow:"auto"}},operation.log)),
		...
		* @returns the card.
		*/
        function SearchChoiceField({ id, label, value, disabled, options, onChange }) {
            return react.createElement("div", { className: fields_module_css_default.field },
                react.createElement("div", { className: fields_module_css_default.head }, react.createElement("label", { className: fields_module_css_default.label, htmlFor: id }, label)),
                react.createElement("select", { id, className: fields_module_css_default.input, value, disabled, onChange: event => onChange(event.target.value) }, options.map(([id, label]) => react.createElement("option", { key: id, value: id }, label))));
        }
		function WebSearchCard(props) {
			...
			return (0, react_jsx_runtime.jsxs)(PluginCard, {
				...
				onDiscard: props.discard,
				children: [
                    react.createElement(SearchChoiceField, { id: "web-search-mode", label: t("webSearchMode"), value: state.mode?.text || "deepseek", disabled, options: [["deepseek", "DeepSeek"], ["hosted", t("webSearchHosted")]], onChange: value => props.edit("mode", value) }),
                    ...(state.mode?.text === "hosted" ? [react.createElement(SearchChoiceField, { key: "access", id: "web-search-access", label: t("webSearchAccess"), value: state.access?.text || "live", disabled, options: [["live", t("webSearchLive")], ["cached", t("webSearchCached")]], onChange: value => props.edit("access", value) }), react.createElement("p", { key: "hint", className: fields_module_css_default.hint }, t("webSearchHostedHint"))] : [
		...
		var WebSearchCardController = class {
			...
			*/
			constructor(scope, api) {
				this.scope = scope;
				this.api = api;
				this.form = new CardForm(scope, [textField("baseURL"), numberField("maxUses"), textField("mode"), textField("access")], [{
					field: API_KEY_FIELD,
			...
			projection() {
				return {
                    ...
                    mode: this.form.field("mode"), access: this.form.field("access"),
		...
		*/
		...
		const en = {
			...
			webSearchDescription: "Search provider and request settings.", webSearchMode: "Search service", webSearchHosted: "Hosted search · existing model connection", webSearchAccess: "Internet access", webSearchLive: "Live", webSearchCached: "Cached", webSearchHostedHint: "Uses the current conversation connection and model. Optional search task assignments override them. The provider must support native Responses web search.",
		...
		const zh = {
			...
			webSearchTitle: "网页搜索",
			webSearchDescription: "搜索服务及请求设置。", webSearchMode: "搜索服务", webSearchHosted: "托管搜索 · 已有模型连接", webSearchAccess: "联网方式", webSearchLive: "实时联网", webSearchCached: "缓存搜索", webSearchHostedHint: "沿用当前对话的连接和模型；可选的搜索任务分工会覆盖默认选择，服务端需支持 Responses 原生搜索。",
			webSearchApiKey: "API Key",
		...
		*/
		function apply(ctx) {
			...
			ctx.slots.inject("main",()=>ctx.slots.register({name:"main",key:"plugin-center",locale:NS,children:{"plugin-center.inventory":{kind:"single",scope:"root"}}},props=>react.createElement("section",{className:"dshPluginCenter",style:{height:"100%",overflow:"auto",padding:24,boxSizing:"border-box"}},react.createElement("h1",null,"插件中心"),react.createElement(PluginInstallControls),react.createElement("button",{type:"button",onClick:()=>window.dispatchEvent(new CustomEvent("dsh-open-settings",{detail:{section:"plugins"}}))},"插件配置"),props.renderSlot("plugin-center.inventory",{}))));
            ctx.slots.inject("sidebar.panellist",()=>ctx.slots.register({name:"sidebar.panellist",id:"plugin-center",order:30,label:()=>"插件"},()=>react.createElement("span",{"aria-hidden":true},"▦")));
