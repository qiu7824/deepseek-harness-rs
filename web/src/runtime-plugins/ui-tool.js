window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		function terminalBlockLabels(t, card) {
			return {
				signal: (signal) => t("terminal.signal", { signal }),
				exitCode: (code) => t("terminal.exitCode", { code }),
				running: t("terminal.running"),
				failed: t("terminal.failed"),
				done: card && card.exitCode === undefined && card.signal === undefined && !card.running ? t("terminal.unknown") : t("terminal.done"),
				copy: t("copy"),
				copied: t("copied"),
		...
		*/
		...
		var ToolRow_module_css_default = {
			"row": "CYEYBq_row",
			"searchBody": "CYEYBq_searchBody",
			"title": "CYEYBq_title",
			"ioLabel": "CYEYBq_ioLabel",
			"leading": "CYEYBq_leading",
			"errorSummary": "CYEYBq_errorSummary",
			"dsh-tool-row-sweep": "CYEYBq_dsh-tool-row-sweep",
			"inspectButton": "CYEYBq_inspectButton",
			"summarySuffix": "CYEYBq_summarySuffix",
			"ioSection": "CYEYBq_ioSection",
			"ioDivider": "CYEYBq_ioDivider",
			"webBody": "CYEYBq_webBody",
			"visuallyHidden": "CYEYBq_visuallyHidden",
			"chevron": "CYEYBq_chevron",
			"ioCard": "CYEYBq_ioCard",
			"diffBody": "CYEYBq_diffBody",
			"ioText": "CYEYBq_ioText",
			"readBody": "CYEYBq_readBody",
			"searchRecovery": "CYEYBq_searchRecovery",
			"bodyWrap": "CYEYBq_bodyWrap",
			"sep": "CYEYBq_sep",
			"bodyScroll": "CYEYBq_bodyScroll",
			"codeBody": "CYEYBq_codeBody",
			"terminalBody": "CYEYBq_terminalBody",
			"fileLink": "CYEYBq_fileLink",
			"summary": "CYEYBq_summary",
			"root": "CYEYBq_root"
		};
		//#endregion
		...
		*  summary already describe a settled row). */
				...
				children: [status !== null && (0, react_jsx_runtime.jsx)("span", {
					...
					children: (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [imageBody !== null ? (open ? imageBody : null) : terminalBody !== null ? (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.TerminalBlock, {
							...terminalBody.card,
							maxLines: 80,
							labels: terminalBlockLabels(t, terminalBody.card),
		...
		//#endregion
		//#region \0dsh-css:D:\HermesTemp\deepseek-harness\packages\client\ui-tool\src\client\tool\ToolCallTree.module.css.mjs
		const css$2 = ".MDAFra_callRow{border-radius:6px}.MDAFra_subCalls{border-left:1px solid var(--dsw-alias-border-l2);flex-direction:column;gap:4px;margin:4px 0 2px 22px;padding-left:8px;display:flex}";
		...
		var ToolCallTree_module_css_default = {
			"subCalls": "MDAFra_subCalls",
			"callRow": "MDAFra_callRow"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\HermesTemp\deepseek-harness\packages\client\ui-tool\src\client\tool\ToolDetails.module.css.mjs
		const css$1 = ".HbO4gq_description{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-13);margin:0 0 6px}.HbO4gq_cardBody{margin:0}.HbO4gq_recovery{white-space:pre-wrap;overflow-wrap:anywhere;color:var(--dsw-alias-label-tertiary);font:var(--dsw-font-xs-13);margin:6px 0 0}.HbO4gq_code{background:var(--dsw-alias-markdown-code-block);font-family:var(--ds-font-family-code);color:var(--dsw-alias-label-primary);white-space:pre-wrap;word-break:break-word;border-radius:12px;margin:0;padding:16px;font-size:13px;line-height:22px}.HbO4gq_code[data-error]{color:var(--dsw-alias-state-error-primary)}.HbO4gq_read,.HbO4gq_web{margin:0}.HbO4gq_empty{color:var(--dsw-alias-label-tertiary);padding:8px 0;font-size:13px;line-height:20px}";
		...
		var ToolDetails_module_css_default = {
			"code": "HbO4gq_code",
			"description": "HbO4gq_description",
			"recovery": "HbO4gq_recovery",
			"empty": "HbO4gq_empty",
			"web": "HbO4gq_web",
			"cardBody": "HbO4gq_cardBody",
			"read": "HbO4gq_read"
		};
		//#endregion
		...
		*/
		function ToolDetails({ block, cwd, t }) {
			...
			if (terminal !== null) return (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [terminal.description !== void 0 ? (0, react_jsx_runtime.jsx)("div", {
				...
				...terminal.card,
				labels: terminalBlockLabels(t, terminal.card),
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\HermesTemp\deepseek-harness\packages\client\ui-tool\src\client\tool\toolviews\bash-sample.module.css.mjs
		const css = ".DOBunG_card{flex-direction:column;display:flex}.DOBunG_terminal{--dsl-terminal-font:var(--dsw-font-markdown-code-block-small);--dsl-terminal-line-height:18px;--dsl-terminal-output-max-height:224px;border:1px solid var(--dsw-alias-border-l1);margin:4px 0 4px 4px}.DOBunG_ioCard{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-markdown-code-block);font:var(--dsw-font-markdown-code-block-small);border-radius:12px;flex-direction:column;margin:4px 0 4px 4px;display:flex}.DOBunG_ioSection{grid-template-columns:max-content 1fr;align-items:baseline;column-gap:14px;max-height:150px;padding:12px 16px;display:grid;overflow-y:auto}.DOBunG_ioSection::-webkit-scrollbar-thumb{background-clip:padding-box;border:2px solid #0000;border-radius:6px}.DOBunG_ioSection::-webkit-scrollbar-track{margin:6px 0}.DOBunG_ioLabel{color:var(--dsw-alias-label-caption);align-self:start;position:sticky;top:0}.DOBunG_ioDivider{background:var(--dsw-alias-border-l2);flex:none;height:1px}.DOBunG_ioText{white-space:pre-wrap;word-break:break-word;min-width:0;color:var(--dsw-alias-label-secondary)}.DOBunG_ioText[data-error]{color:var(--dsw-alias-state-error-primary)}.DOBunG_root[data-expandable]{cursor:pointer}.DOBunG_root{align-items:center;min-width:0;height:24px;display:flex;position:relative;overflow:hidden}.DOBunG_root[data-state=running]:after{content:\"\";background:linear-gradient(90deg, transparent 0%, color-mix(in srgb, var(--dsw-alias-bg-base) 60%, transparent) 55%, transparent 100%);pointer-events:none;width:300px;animation:2.6s ease-out infinite DOBunG_dsh-bash-row-sweep;position:absolute;top:0;bottom:0;left:0}@keyframes DOBunG_dsh-bash-row-sweep{0%{left:-300px}90%,to{left:100%}}.DOBunG_leading{width:16px;height:16px;color:var(--dsw-alias-label-tertiary);flex:none;justify-content:center;align-items:center;margin-right:6px;display:inline-flex;position:relative}.DOBunG_chevron{color:var(--dsw-alias-label-secondary)}.DOBunG_iconIdle{opacity:1;transition:opacity .1s;display:inline-flex}.DOBunG_chevronHover{opacity:0;margin:auto;transition:opacity .1s;position:absolute;inset:0}.DOBunG_root:hover .DOBunG_iconIdle{opacity:0}.DOBunG_root:hover .DOBunG_chevronHover{opacity:1}.DOBunG_title{color:var(--dsw-alias-label-secondary);flex:none;font-size:14px;line-height:24px}.DOBunG_sep{background:var(--dsw-alias-label-caption);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}.DOBunG_summary{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-tertiary);flex:auto;font-size:14px;line-height:24px;overflow:hidden}.DOBunG_errorSummary{color:var(--dsw-alias-state-error-primary)}.DOBunG_bodyWrap{flex-direction:column;display:flex}.DOBunG_inspectButton{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-secondary);cursor:pointer;opacity:0;border-radius:999px;align-self:flex-start;align-items:center;gap:4px;margin:4px 0 2px 4px;padding:2px 8px;font-size:11px;line-height:16px;transition:opacity .1s;display:inline-flex}.DOBunG_card:hover .DOBunG_inspectButton,.DOBunG_inspectButton:focus-visible{opacity:1}.DOBunG_inspectButton:hover{background:var(--dsw-alias-interactive-bg-hover-solid);color:var(--dsw-alias-label-primary)}.DOBunG_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}";
		...
		var bash_sample_module_css_default = {
			"terminal": "DOBunG_terminal",
			"sep": "DOBunG_sep",
			"ioSection": "DOBunG_ioSection",
			"ioLabel": "DOBunG_ioLabel",
			"dsh-bash-row-sweep": "DOBunG_dsh-bash-row-sweep",
			"leading": "DOBunG_leading",
			"iconIdle": "DOBunG_iconIdle",
			"bodyWrap": "DOBunG_bodyWrap",
			"chevronHover": "DOBunG_chevronHover",
			"summary": "DOBunG_summary",
			"ioText": "DOBunG_ioText",
			"card": "DOBunG_card",
			"title": "DOBunG_title",
			"visuallyHidden": "DOBunG_visuallyHidden",
			"inspectButton": "DOBunG_inspectButton",
			"ioCard": "DOBunG_ioCard",
			"ioDivider": "DOBunG_ioDivider",
			"errorSummary": "DOBunG_errorSummary",
			"chevron": "DOBunG_chevron",
			"root": "DOBunG_root"
		};
		//#endregion
