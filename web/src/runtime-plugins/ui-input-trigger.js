window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\HermesTemp\deepseek-harness\packages\client\ui-input-trigger\src\client\MenuView.module.css.mjs
		const css = ".ielcbq_menu{z-index:100;--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border:1px solid var(--dsw-alias-border-inverted);background:var(--dsw-specific-menu);min-width:min(260px,100%);max-width:min(537px,100%);max-height:320px;box-shadow:var(--dsw-shadow-lv3);border-radius:12px;flex-direction:column;padding:4px;display:flex;position:absolute;bottom:calc(100% + 4px);left:0;overflow:hidden}.ielcbq_viewport{flex-direction:column;min-height:0;display:flex;overflow-y:auto}.ielcbq_item{cursor:pointer;width:100%;min-height:40px;color:var(--dsw-alias-label-primary);text-align:left;background:0 0;border:none;border-radius:10px;align-items:center;gap:8px;padding:8px 10px;font-size:14px;line-height:22px;display:flex}.ielcbq_item:hover,.ielcbq_item.ielcbq_active{background:var(--dsw-alias-interactive-bg-hover)}.ielcbq_itemIcon{width:16px;height:16px;color:var(--dsw-alias-label-tertiary);flex:none;justify-content:center;align-items:center;display:inline-flex}.ielcbq_itemName{text-overflow:ellipsis;white-space:nowrap;flex:none;max-width:40%;overflow:hidden}.ielcbq_itemDescription{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-tertiary);flex:1;overflow:hidden}.ielcbq_groupTitle{color:var(--dsw-alias-label-tertiary);padding:8px 10px;font-size:12px;line-height:16px}.ielcbq_loading{min-height:40px;color:var(--dsw-alias-label-dimmed);align-items:center;padding:8px 10px;font-size:14px;line-height:22px;display:flex}";
		...
		var MenuView_module_css_default = {
			"item": "ielcbq_item",
			"menu": "ielcbq_menu",
			"itemIcon": "ielcbq_itemIcon",
			"groupTitle": "ielcbq_groupTitle",
			"active": "ielcbq_active",
			"viewport": "ielcbq_viewport",
			"itemDescription": "ielcbq_itemDescription",
			"loading": "ielcbq_loading",
			"itemName": "ielcbq_itemName"
		};
		//#endregion
		...
		*/
		...
		const en = {
			"session-reference": "Conversations",
			"command": "Commands",
			"skill": "Skills",
			"subagent": "Subagents",
			"loading": "Loading…",
