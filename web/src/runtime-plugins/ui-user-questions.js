window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\HermesTemp\deepseek-harness\packages\client\ui-user-questions\src\client\PlanReviewPanel.module.css.mjs
		const css$1 = ".LpKJ0q_frame{padding:6px calc(var(--dsh-composer-side-clearance) + 16px) 10px;justify-content:center;display:flex}.LpKJ0q_card{width:100%;max-width:var(--dsh-chat-content-width);border:1px solid var(--dsw-alias-state-warn-secondary);background:var(--dsw-specific-input-major);max-height:min(60vh,520px);box-shadow:var(--dsw-shadow-lv2);color:var(--dsw-alias-label-primary);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border-radius:20px;flex-direction:column;display:flex;overflow:hidden}.LpKJ0q_card,.LpKJ0q_card *{box-sizing:border-box}.LpKJ0q_strip{background:var(--dsw-alias-state-warn-tertiary);color:var(--dsw-alias-state-warn-primary);flex-shrink:0;align-items:center;gap:8px;padding:10px 16px;font-size:13px;line-height:18px;display:flex}.LpKJ0q_dot{background:var(--dsw-alias-state-warn-primary);border-radius:50%;width:8px;height:8px}.LpKJ0q_body{overscroll-behavior:contain;flex:auto;min-height:0;padding:12px 16px 4px;font-size:14px;line-height:22px;overflow-y:auto}.LpKJ0q_footer{flex-shrink:0;justify-content:space-between;align-items:center;gap:12px;padding:8px 16px 12px;display:flex}.LpKJ0q_feedback{min-height:16px;color:var(--dsw-alias-state-error-primary);font-size:11px;line-height:16px}.LpKJ0q_actions{flex-shrink:0;align-items:center;gap:8px;display:flex}.LpKJ0q_discuss{color:var(--dsw-alias-label-secondary);gap:6px}.LpKJ0q_discuss:hover:not(:disabled){color:var(--dsw-alias-label-primary)}@media (width<=720px){.LpKJ0q_card{border-radius:16px}.LpKJ0q_body{padding:10px 12px 4px}.LpKJ0q_footer{align-items:flex-end;padding:8px 12px 10px}}";
		...
		var PlanReviewPanel_module_css_default = {
			...
			"body": "LpKJ0q_body",
			"strip": "LpKJ0q_strip",
			"actions": "LpKJ0q_actions",
			"discuss": "LpKJ0q_discuss",
			"frame": "LpKJ0q_frame",
			"feedback": "LpKJ0q_feedback",
			"footer": "LpKJ0q_footer",
			"dot": "LpKJ0q_dot"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\HermesTemp\deepseek-harness\packages\client\ui-user-questions\src\client\QuestionComposer.module.css.mjs
		const css = ".UcYNVG_frame{padding:6px calc(var(--dsh-composer-side-clearance) + 16px) 10px;justify-content:center;display:flex}.UcYNVG_card{width:100%;max-width:var(--dsh-chat-content-width);border:1px solid var(--dsw-alias-border-l2-darkmode-thin);background:var(--dsw-specific-input-major);max-height:min(60vh,520px);box-shadow:var(--dsw-shadow-lv2);color:var(--dsw-alias-label-primary);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border-radius:20px;flex-direction:column;padding:0 0 10px;display:flex;overflow:hidden}.UcYNVG_card,.UcYNVG_card *{box-sizing:border-box}.UcYNVG_header{flex-shrink:0;justify-content:space-between;align-items:flex-start;gap:16px;padding:20px 16px 0 24px;display:flex}.UcYNVG_headingBlock{min-width:0}.UcYNVG_eyebrow{color:var(--dsw-alias-label-tertiary);margin-bottom:5px;font-size:11px;line-height:16px}.UcYNVG_title{margin:0;font-size:16px;font-weight:500;line-height:22px}.UcYNVG_detail{margin:0 2px 8px}.UcYNVG_footerActions{flex-shrink:0;align-items:center;gap:12px;display:flex}.UcYNVG_pager{flex-shrink:0;align-items:center;gap:6px;display:flex}.UcYNVG_progress{color:var(--dsw-alias-label-secondary);white-space:nowrap;word-spacing:-2px;padding:0 4px;font-size:14px;font-weight:500;line-height:24px}.UcYNVG_iconButton{width:24px;height:24px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;border-radius:999px;place-items:center;padding:0;display:grid}.UcYNVG_iconButton:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.UcYNVG_iconButton:disabled{color:var(--dsw-alias-label-dimmed);cursor:default}.UcYNVG_body{overscroll-behavior:contain;flex-direction:column;flex:auto;min-height:0;display:flex;overflow-y:auto}.UcYNVG_options{flex-direction:column;gap:1px;margin:8px 0 0;padding:4px 12px;display:flex}.UcYNVG_option{width:100%;min-height:40px;color:inherit;text-align:left;cursor:pointer;background:0 0;border:1px solid #0000;border-radius:12px;flex-shrink:0;align-items:flex-start;gap:8px;padding:8px 12px 8px 8px;transition:background-color .12s,border-color .12s;display:flex}.UcYNVG_option:hover:not(:disabled),.UcYNVG_optionSelected{background:var(--dsw-alias-interactive-bg-hover)}.UcYNVG_optionSelected{border-color:var(--dsw-alias-border-l2)}.UcYNVG_option:disabled{cursor:default}.UcYNVG_number{background:var(--dsw-alias-bg-overlay);width:20px;height:20px;color:var(--dsw-alias-label-secondary);border-radius:6px;flex:0 0 20px;place-items:center;margin-top:2px;font-size:12px;font-weight:500;line-height:18px;display:grid}.UcYNVG_checkbox{flex:0 0 20px;place-items:center;width:20px;height:20px;margin-top:2px;display:grid}.UcYNVG_checkbox:before{content:\"\";border:1px solid var(--dsw-alias-border-l4);border-radius:4px;grid-area:1/1;width:14px;height:14px;transition:background-color .12s,border-color .12s}.UcYNVG_checkbox>svg{grid-area:1/1}.UcYNVG_checkboxChecked{color:var(--dsw-alias-label-primary-foreground)}.UcYNVG_checkboxChecked:before{border-color:var(--dsw-alias-label-primary);background:var(--dsw-alias-label-primary)}.UcYNVG_optionCopy{flex:1;min-width:0}.UcYNVG_optionLine{flex-wrap:wrap;align-items:baseline;gap:2px 6px;display:flex}.UcYNVG_optionLabel{font-size:14px;font-weight:500;line-height:24px}.UcYNVG_badge{background:var(--dsw-specific-sidebar-nav-item-active-accent);color:var(--dsw-alias-button-info-fill);border-radius:6px;padding:0 4px;font-size:11px;font-weight:600;line-height:18px}.UcYNVG_description{color:var(--dsw-alias-label-tertiary);font-size:14px;font-weight:400;line-height:24px}.UcYNVG_customRow{border:1px solid #0000;border-radius:12px;flex-shrink:0;align-items:flex-start;gap:8px;width:100%;min-height:40px;padding:8px 12px 8px 8px;transition:background-color .12s,border-color .12s;display:flex}.UcYNVG_customRow:hover,.UcYNVG_customRow:focus-within,.UcYNVG_customRowActive{background:var(--dsw-alias-interactive-bg-hover)}.UcYNVG_customRow:focus-within,.UcYNVG_customRowActive{border-color:var(--dsw-alias-border-l2)}.UcYNVG_customInput{min-width:0;color:var(--dsw-alias-label-primary);caret-color:var(--dsw-alias-state-business-primary);font:inherit;background:0 0;border:none;outline:none;flex:1;padding:0;font-size:14px;line-height:24px}.UcYNVG_customInput::placeholder{color:var(--dsw-alias-label-caption)}.UcYNVG_customTextarea{resize:none;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-module-platform);min-height:64px;max-height:140px;color:var(--dsw-alias-label-primary);caret-color:var(--dsw-alias-state-business-primary);font:inherit;border-radius:10px;outline:none;flex-shrink:0;margin:0 12px;padding:8px 12px;font-size:14px;line-height:24px;display:block}.UcYNVG_customTextarea:focus{border-color:var(--dsw-alias-state-business-primary)}.UcYNVG_customTextarea::placeholder{color:var(--dsw-alias-label-caption)}.UcYNVG_footer{flex-shrink:0;justify-content:space-between;align-items:center;gap:12px;margin-top:12px;padding:0 10px 0 18px;display:flex}.UcYNVG_feedback{min-height:16px;color:var(--dsw-alias-state-error-primary);text-align:right;flex:1;font-size:11px;line-height:16px}@media (width<=720px){.UcYNVG_card{border-radius:16px}.UcYNVG_header{padding:10px 12px 0 18px}.UcYNVG_options{padding:4px 8px}.UcYNVG_title{font-size:15px;line-height:21px}.UcYNVG_option,.UcYNVG_customRow{padding:8px 6px}.UcYNVG_footer{align-items:flex-end;padding:0 10px}.UcYNVG_footerActions{flex-shrink:0}}@media (prefers-reduced-motion:reduce){.UcYNVG_option,.UcYNVG_customRow{transition:none}}";
		...
		var QuestionComposer_module_css_default = {
			"customInput": "UcYNVG_customInput",
			"card": "UcYNVG_card",
			"headingBlock": "UcYNVG_headingBlock",
			"pager": "UcYNVG_pager",
			"progress": "UcYNVG_progress",
			"customRowActive": "UcYNVG_customRowActive",
			"header": "UcYNVG_header",
			"footer": "UcYNVG_footer",
			"optionSelected": "UcYNVG_optionSelected",
			"iconButton": "UcYNVG_iconButton",
			"optionCopy": "UcYNVG_optionCopy",
			"body": "UcYNVG_body",
			"footerActions": "UcYNVG_footerActions",
			"customTextarea": "UcYNVG_customTextarea",
			"checkboxChecked": "UcYNVG_checkboxChecked",
			"detail": "UcYNVG_detail",
			"badge": "UcYNVG_badge",
			"optionLine": "UcYNVG_optionLine",
			"feedback": "UcYNVG_feedback",
			"eyebrow": "UcYNVG_eyebrow",
			"description": "UcYNVG_description",
			"checkbox": "UcYNVG_checkbox",
			"number": "UcYNVG_number",
			"customRow": "UcYNVG_customRow",
			"options": "UcYNVG_options",
			"frame": "UcYNVG_frame",
			"title": "UcYNVG_title",
			"optionLabel": "UcYNVG_optionLabel",
			"option": "UcYNVG_option"
		};
		//#endregion
		...
		*/
					...
					children: [
						(0, react_jsx_runtime.jsxs)("header", {
							...
							children: [(0, react_jsx_runtime.jsxs)("div", {
								...
								children: [react.createElement("div", { role: "status", "data-question-status": true, style: { display: "flex", alignItems: "center", gap: 6, fontSize: 12, lineHeight: "18px", color: "var(--dsw-alias-label-secondary)" } }, react.createElement(_deepseek_ai_dsh_client_ui_primitives.IconQuestionOutline14, { size: 14, "aria-hidden": true }), t(busy === "answer" ? "status.submitting" : busy !== null ? "status.cancelling" : "status.waiting")), question.header !== void 0 && (0, react_jsx_runtime.jsx)("div", {
		...
		const zh = {
            "status.waiting": "等待回答", "status.submitting": "正在提交回答", "status.cancelling": "正在取消",
		...
		const en = {
            "status.waiting": "Waiting for your answer", "status.submitting": "Submitting answer", "status.cancelling": "Cancelling",
