window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\HermesTemp\deepseek-harness\packages\extensions\ui-cordis\src\client\CordisRunRow.module.css.mjs
		const css$2 = ".DhlywW_card{flex-direction:column;gap:8px;display:flex}.DhlywW_row{align-items:center;min-height:32px;display:flex}.DhlywW_icon{color:var(--dsw-alias-state-business-primary);flex:none;margin-right:8px;display:inline-flex}.DhlywW_title{color:var(--dsw-alias-state-business-primary);flex:none;font-size:14px;font-weight:500;line-height:24px}.DhlywW_separator{background:var(--dsw-alias-state-business-primary);border-radius:50%;flex:none;width:2px;height:2px;margin:0 8px}.DhlywW_summary,.DhlywW_error{min-width:0;color:var(--dsw-alias-label-secondary);text-overflow:ellipsis;white-space:nowrap;flex:1;font-size:13px;line-height:24px;overflow:hidden}.DhlywW_error{color:var(--dsw-alias-state-error-primary)}.DhlywW_status{color:var(--dsw-alias-label-caption);flex:none;margin-left:8px;font-size:12px;line-height:24px}.DhlywW_card[data-cordis-status=awaiting-approval] .DhlywW_status,.DhlywW_card[data-cordis-status=client-pending] .DhlywW_status{color:var(--dsw-alias-state-warn-label)}.DhlywW_card[data-cordis-status=running] .DhlywW_status{color:var(--dsw-alias-state-success-primary)}.DhlywW_card[data-cordis-status=failed] .DhlywW_status{color:var(--dsw-alias-state-error-primary)}.DhlywW_inspect{width:24px;height:24px;color:var(--dsw-alias-label-tertiary);cursor:pointer;opacity:0;background:0 0;border:none;border-radius:999px;justify-content:center;align-items:center;margin-left:4px;padding:0;display:inline-flex}.DhlywW_card:hover .DhlywW_inspect,.DhlywW_inspect:focus-visible{opacity:1}.DhlywW_inspect:hover{background:var(--dsw-alias-interactive-bg-hover)}.DhlywW_message{background:var(--dsw-alias-button-ghost-active-fill);color:var(--dsw-alias-label-tertiary);border-radius:8px;padding:8px 12px;font-size:12px;line-height:18px}.DhlywW_business{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);border-radius:12px;min-width:0;overflow:hidden}.DhlywW_output{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-markdown-code-block);color:var(--dsw-alias-label-secondary);font:var(--dsw-font-markdown-code-block-small);white-space:pre-wrap;overflow-wrap:anywhere;border-radius:8px;margin:0;padding:10px 12px;overflow:auto}.DhlywW_business .DhlywW_output{border:none;border-radius:0}";
		...
		var CordisRunRow_module_css_default = {
			"title": "DhlywW_title",
			"error": "DhlywW_error",
			"message": "DhlywW_message",
			"business": "DhlywW_business",
			"row": "DhlywW_row",
			"output": "DhlywW_output",
			"status": "DhlywW_status",
			"inspect": "DhlywW_inspect",
			"icon": "DhlywW_icon",
			"card": "DhlywW_card",
			"separator": "DhlywW_separator",
			"summary": "DhlywW_summary"
		};
		//#endregion
		...
		function CordisActionRow({ callId, toolName, block, inspect, t }) {
			...
			return (0, react_jsx_runtime.jsxs)("div", {
				className: CordisRunRow_module_css_default.card, title: t(remove ? "row.removeTitle" : "row.stopTitle"),
				"data-tool": toolName,
				...
				children: [(0, react_jsx_runtime.jsxs)("div", {
					...
					children: [
						(0, react_jsx_runtime.jsx)("span", {
							className: CordisRunRow_module_css_default.icon + " dshReplyHintIcon", "aria-hidden": true,
						...
						(0, react_jsx_runtime.jsx)("span", {
							className: CordisRunRow_module_css_default.title + " dshReplyHintLabel",
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\HermesTemp\deepseek-harness\packages\extensions\ui-cordis\src\client\CordisDefineRow.module.css.mjs
		const css$1 = ".BkJQvW_card{flex-direction:column;display:flex}.BkJQvW_card .BkJQvW_title,.BkJQvW_card .BkJQvW_chevron{color:var(--dsw-alias-state-business-primary)}.BkJQvW_title{flex:none;font-size:14px;font-weight:500;line-height:24px}.BkJQvW_row{gap:0}.BkJQvW_separator{background:var(--dsw-alias-state-business-primary);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}.BkJQvW_name{text-overflow:ellipsis;white-space:nowrap;max-width:40%;color:var(--dsw-alias-label-secondary);flex:none;font-size:14px;line-height:24px;overflow:hidden}.BkJQvW_purpose{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-tertiary);flex:auto;margin-left:8px;font-size:13px;line-height:24px;overflow:hidden}.BkJQvW_errorSummary{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-state-error-primary);flex:auto;font-size:14px;line-height:24px;overflow:hidden}.BkJQvW_requestError{text-overflow:ellipsis;white-space:nowrap;max-width:40%;color:var(--dsw-alias-state-error-primary);flex:none;margin-left:8px;font-size:12px;line-height:24px;overflow:hidden}.BkJQvW_readout{flex:none;align-items:center;margin-left:8px;display:inline-flex}.BkJQvW_panelHint{color:var(--dsw-alias-label-caption);margin:4px 0 2px 4px;font-size:11px;line-height:16px}.BkJQvW_statusLabel{color:var(--dsw-alias-label-caption);font-size:12px;line-height:24px}.BkJQvW_approvalPrompt{text-overflow:ellipsis;white-space:nowrap;max-width:40%;color:var(--dsw-alias-label-secondary);flex:none;margin-left:8px;font-size:12px;line-height:24px;overflow:hidden}.BkJQvW_notice{text-overflow:ellipsis;white-space:nowrap;max-width:40%;color:var(--dsw-alias-label-caption);flex:none;margin-left:8px;font-size:12px;line-height:24px;overflow:hidden}.BkJQvW_switch{height:22px;padding:0 8px;font-size:12px}.BkJQvW_card[data-terminal] .BkJQvW_title,.BkJQvW_card[data-terminal] .BkJQvW_name,.BkJQvW_card[data-terminal] .BkJQvW_purpose,.BkJQvW_card[data-terminal] .BkJQvW_statusLabel{color:var(--dsw-alias-label-caption)}.BkJQvW_card[data-terminal] .BkJQvW_separator{background:var(--dsw-alias-label-caption)}.BkJQvW_bodyWrap{flex-direction:column;display:flex}.BkJQvW_sourceCard{flex-direction:column;margin:4px 0 4px 4px;display:flex}.BkJQvW_sourceTabs{border-bottom:1px solid var(--dsw-alias-border-l2);height:32px;display:flex}.BkJQvW_sourceTab{color:var(--dsw-alias-label-tertiary);cursor:pointer;font:var(--dsw-font-xs-13);background:0 0;border:0;padding:0 10px;position:relative}.BkJQvW_sourceTab:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.BkJQvW_sourceTab:disabled{cursor:default;opacity:.4}.BkJQvW_sourceTabActive{color:var(--dsw-alias-state-business-primary)}.BkJQvW_sourceTabActive:after{background:var(--dsw-alias-state-business-primary);content:\"\";border-radius:1px 1px 0 0;height:2px;position:absolute;bottom:0;left:10px;right:10px}.BkJQvW_sourceTab:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}.BkJQvW_sourcePanel{max-height:260px;overflow:auto}.BkJQvW_sourceCode{margin:0}.BkJQvW_codeSection{flex-direction:column;max-height:260px;margin:4px 0 4px 4px;display:flex;overflow:auto}.BkJQvW_sectionLabel{color:var(--dsw-alias-label-caption);text-transform:uppercase;letter-spacing:.04em;flex:none;padding:2px 0;font-size:11px;font-weight:500;line-height:16px}.BkJQvW_output{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-markdown-code-block);white-space:pre-wrap;overflow-wrap:anywhere;font:var(--dsw-font-markdown-code-block-small);color:var(--dsw-alias-label-secondary);border-radius:8px;margin:0;padding:8px 10px}.BkJQvW_output[data-error]{color:var(--dsw-alias-state-error-primary)}.BkJQvW_inspectButton{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-secondary);cursor:pointer;opacity:0;border-radius:999px;align-self:flex-start;align-items:center;gap:4px;margin:4px 0 2px 4px;padding:2px 8px;font-size:11px;line-height:16px;transition:opacity .1s;display:inline-flex}.BkJQvW_card:hover .BkJQvW_inspectButton,.BkJQvW_inspectButton:focus-visible{opacity:1}.BkJQvW_inspectButton:hover{background:var(--dsw-alias-interactive-bg-hover-solid);color:var(--dsw-alias-label-primary)}.BkJQvW_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}@media (prefers-reduced-motion:reduce){.BkJQvW_inspectButton{transition:none}}";
		...
		var CordisDefineRow_module_css_default = {
			"purpose": "BkJQvW_purpose",
			"readout": "BkJQvW_readout",
			"panelHint": "BkJQvW_panelHint",
			"requestError": "BkJQvW_requestError",
			"approvalPrompt": "BkJQvW_approvalPrompt",
			"notice": "BkJQvW_notice",
			"switch": "BkJQvW_switch",
			"sourceCard": "BkJQvW_sourceCard",
			"bodyWrap": "BkJQvW_bodyWrap",
			"sourceTab": "BkJQvW_sourceTab",
			"row": "BkJQvW_row",
			"sourceTabActive": "BkJQvW_sourceTabActive",
			"sectionLabel": "BkJQvW_sectionLabel",
			"name": "BkJQvW_name",
			"sourcePanel": "BkJQvW_sourcePanel",
			"codeSection": "BkJQvW_codeSection",
			"errorSummary": "BkJQvW_errorSummary",
			"title": "BkJQvW_title",
			"chevron": "BkJQvW_chevron",
			"separator": "BkJQvW_separator",
			"statusLabel": "BkJQvW_statusLabel",
			"sourceTabs": "BkJQvW_sourceTabs",
			"output": "BkJQvW_output",
			"visuallyHidden": "BkJQvW_visuallyHidden",
			"sourceCode": "BkJQvW_sourceCode",
			"inspectButton": "BkJQvW_inspectButton",
			"card": "BkJQvW_card"
		};
		//#endregion
		...
		function CordisDefineRow({ callId, block, inspect, useInventory, useLoaded, t }) {
			...
			return (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [a11yState !== null && (0, react_jsx_runtime.jsx)("span", {
					...
					icon: (0, react_jsx_runtime.jsx)("span", { className: "dshReplyHintIcon", title: t("row.defineTitle"), "aria-hidden": true, children: (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconCodeOutline16, { size: 14 }) }),
					title: (0, react_jsx_runtime.jsx)("span", { className: "dshReplyHintLabel", children: t("row.defineTitle") }),
					open,
					expandable,
					...
					children: (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							inspect !== void 0 && (0, react_jsx_runtime.jsxs)("button", {
								...
								onClick: inspect,
								children: [(0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconInspectOutline12, {}), t("body.inspect")]
							})
						]
					})
				})]
		...
		*/
		...
		function CordisRunRow({ callId, block, inspect, renderSlot, useInventory, useLoaded, useRunCards, useActiveRuns, onObserveRunCard, t }) {
			...
			return (0, react_jsx_runtime.jsxs)("div", {
				className: CordisRunRow_module_css_default.card, title: t(card.mode === "update" ? "row.updateTitle" : "row.runTitle") + " · " + status,
				...
				children: [
					(0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							(0, react_jsx_runtime.jsx)("span", {
								className: CordisRunRow_module_css_default.status + " dshReplyHintLabel",
								children: status
							}),
							inspect !== void 0 && (0, react_jsx_runtime.jsx)("button", {
								type: "button",
		...
		//#endregion
		//#region \0dsh-css:D:\HermesTemp\deepseek-harness\packages\extensions\ui-cordis\src\client\CordisPanel.module.css.mjs
		const css = ".bPMTmW_layer{flex:none;align-items:center;width:100%;height:49px;margin:8px 0 0;display:flex;position:relative}.bPMTmW_footerButtons{align-items:center;width:100%;display:flex}.bPMTmW_badge{width:100%;height:49px;color:var(--dsw-alias-label-primary);cursor:pointer;background:0 0;border:none;border-radius:12px;align-items:center;gap:8px;padding:0 8px 0 6px;font-family:inherit;font-size:14px;display:inline-flex;overflow:hidden}.bPMTmW_badge:hover{background:var(--dsw-alias-interactive-bg-hover-solid)}.bPMTmW_badge[data-active]{background:var(--dsw-alias-interactive-bg-hover)}.bPMTmW_badgeLabel{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}.bPMTmW_badgeCount{color:var(--dsw-alias-label-tertiary);font-variant-numeric:tabular-nums;flex:none;margin-left:auto;font-size:12px;line-height:16px}.bPMTmW_layer.bPMTmW_rail{width:36px;height:36px;margin:0}.bPMTmW_rail .bPMTmW_badge{border-radius:50%;justify-content:center;gap:0;width:36px;height:36px;padding:0}.bPMTmW_rail .bPMTmW_footerButtons{flex-direction:column;gap:2px}.bPMTmW_panel{z-index:30;border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-base);width:420px;max-width:calc(100vw - 24px);max-height:60vh;box-shadow:var(--dsw-shadow-lv2);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border-radius:12px;flex-direction:column;display:flex;position:fixed;bottom:128px;left:12px;overflow:hidden}.bPMTmW_header{box-sizing:border-box;border-bottom:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);flex:none;justify-content:space-between;align-items:center;min-height:44px;padding:10px 12px;display:flex}.bPMTmW_body{flex:1;min-height:0;padding:4px 12px 12px;overflow-y:auto}.bPMTmW_title{color:var(--dsw-alias-label-primary);font-size:13px;font-weight:500;line-height:20px}.bPMTmW_note,.bPMTmW_readError{color:var(--dsw-alias-label-tertiary);margin:4px 0;font-size:12px;line-height:18px}.bPMTmW_readError{color:var(--dsw-alias-state-error-primary)}.bPMTmW_group{color:var(--dsw-alias-label-caption);text-transform:uppercase;letter-spacing:.04em;margin:8px 0 4px;font-size:11px;font-weight:500;line-height:16px}.bPMTmW_rows{flex-direction:column;gap:8px;margin:0;padding:0;list-style:none;display:flex}.bPMTmW_row{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);border-radius:12px;flex-direction:column;gap:8px;padding:10px 12px;display:flex}.bPMTmW_row[data-cordis-awaiting]{border-color:var(--dsw-alias-state-business-primary)}.bPMTmW_rowHead{align-items:center;gap:8px;display:flex}.bPMTmW_rowId{color:var(--dsw-alias-label-tertiary);font-family:var(--dsh-font-mono,monospace);flex:none;font-size:11px;line-height:20px}.bPMTmW_rowName{min-width:0;color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;flex:1;font-size:13px;font-weight:500;line-height:20px;overflow:hidden}.bPMTmW_rowStatus{background:var(--dsw-alias-button-ghost-active-fill);height:20px;color:var(--dsw-alias-label-caption);border-radius:10px;flex:none;align-items:center;padding:0 6px;font-size:11px;line-height:20px;display:inline-flex}.bPMTmW_row[data-cordis-status=idle] .bPMTmW_rowStatus{background:var(--dsw-alias-button-ghost-active-fill);color:var(--dsw-alias-label-caption)}.bPMTmW_row[data-cordis-status=awaiting-approval] .bPMTmW_rowStatus,.bPMTmW_row[data-cordis-status=client-pending] .bPMTmW_rowStatus{background:var(--dsw-alias-state-warn-tertiary);color:var(--dsw-alias-state-warn-label)}.bPMTmW_row[data-cordis-status=failed] .bPMTmW_rowStatus{background:var(--dsw-alias-interactive-bg-hover-danger);color:var(--dsw-alias-state-error-primary)}.bPMTmW_row[data-cordis-status=running] .bPMTmW_rowStatus{background:var(--dsw-alias-state-success-tertiary);color:var(--dsw-alias-state-success-primary)}.bPMTmW_rowDetail{align-items:center;gap:8px;min-height:28px;display:flex}.bPMTmW_versionPicker{color:var(--dsw-alias-label-caption);align-items:center;gap:8px;font-size:11px;line-height:18px;display:flex}.bPMTmW_versionPicker select{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);min-width:0;height:26px;color:var(--dsw-alias-label-secondary);font:inherit;border-radius:7px;flex:1;padding:0 8px}.bPMTmW_rowPurpose{min-width:0;color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;flex:1;font-size:12px;line-height:18px;overflow:hidden}.bPMTmW_rowError{color:var(--dsw-alias-state-error-primary);font-size:12px;line-height:18px}.bPMTmW_rowActions{flex:none;align-items:center;gap:10px;display:flex}.bPMTmW_transition{min-width:0;color:var(--dsw-alias-label-caption);align-items:center;gap:8px;font-size:11px;line-height:18px;display:flex}.bPMTmW_transitionActions{gap:6px;margin-left:auto;display:flex}.bPMTmW_transitionActions button{border:1px solid var(--dsw-alias-border-l2);color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;background:0 0;border-radius:999px;padding:2px 8px}.bPMTmW_transitionActions button:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}.bPMTmW_transitionActions button:disabled{opacity:.4;cursor:default}.bPMTmW_activeVersion{color:var(--dsw-alias-label-caption);font-size:11px;line-height:16px}.bPMTmW_actionButton{width:28px;height:28px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;border-radius:999px;justify-content:center;align-items:center;padding:0;display:inline-flex}.bPMTmW_actionButton:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-secondary)}.bPMTmW_actionButton:disabled{opacity:.4;cursor:default}.bPMTmW_doubleCheck{width:17px;height:14px;display:inline-block;position:relative}.bPMTmW_doubleCheck svg{position:absolute;top:1px}.bPMTmW_doubleCheck svg:first-child{opacity:.7;left:0}.bPMTmW_doubleCheck svg:last-child{left:5px}";
		...
		var CordisPanel_module_css_default = {
			"group": "bPMTmW_group",
			"transitionActions": "bPMTmW_transitionActions",
			"title": "bPMTmW_title",
			"readError": "bPMTmW_readError",
			"badgeLabel": "bPMTmW_badgeLabel",
			"header": "bPMTmW_header",
			"rowStatus": "bPMTmW_rowStatus",
			"layer": "bPMTmW_layer",
			"actionButton": "bPMTmW_actionButton",
			"activeVersion": "bPMTmW_activeVersion",
			"rows": "bPMTmW_rows",
			"rowHead": "bPMTmW_rowHead",
			"body": "bPMTmW_body",
			"panel": "bPMTmW_panel",
			"rowId": "bPMTmW_rowId",
			"rowActions": "bPMTmW_rowActions",
			"badgeCount": "bPMTmW_badgeCount",
			"versionPicker": "bPMTmW_versionPicker",
			"footerButtons": "bPMTmW_footerButtons",
			"rowError": "bPMTmW_rowError",
			"doubleCheck": "bPMTmW_doubleCheck",
			"row": "bPMTmW_row",
			"rail": "bPMTmW_rail",
			"note": "bPMTmW_note",
			"rowName": "bPMTmW_rowName",
			"rowDetail": "bPMTmW_rowDetail",
			"transition": "bPMTmW_transition",
			"rowPurpose": "bPMTmW_rowPurpose",
			"badge": "bPMTmW_badge"
		};
		//#endregion
