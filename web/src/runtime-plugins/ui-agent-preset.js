window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const en = {
			...
			presetCodeDescription: "All Standard mode capabilities, with tools exposed through the Code Mode SDK so the model can combine multi-step operations in one TypeScript program. Requires a compatible Node.js runtime.",
			presetMinimalName: "Minimal mode",
			presetMinimalDescription: "Coding agent with a native shell and text editor.",
			presetCordisName: "Creator mode",
			presetCordisDescription: "Create and maintain Rust Agent presets and skills using Standard mode tools and composition validation.",
			duplicate: "Duplicate",
		...
		const zh = {
			...
			presetCodeDescription: "具备标准模式的全部能力，并通过 Code Mode SDK 呈现工具，让模型用一个 TypeScript 程序组合多步操作；需要兼容的 Node.js 运行环境。",
			presetMinimalName: "极简模式",
			presetMinimalDescription: "使用原生 Shell 与文本编辑器完成编码任务。",
			presetCordisName: "创造模式",
			presetCordisDescription: "创建与维护 Rust Agent 预设和 Skills，复用标准模式工具并验证组合。",
			duplicate: "复制",
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\HermesTemp\deepseek-harness\packages\client\ui-agent-preset\src\client\AgentPresetLabel.module.css.mjs
		const css$3 = ".OTY38q_label{background:var(--dsw-alias-fill-tsp-secondary);max-width:180px;height:22px;color:var(--dsw-alias-label-secondary);white-space:nowrap;text-overflow:ellipsis;border-radius:6px;align-items:center;gap:4px;padding:0 2px 0 0;font-size:12px;line-height:22px;display:inline-flex;overflow:hidden}.OTY38q_icon{opacity:.7;flex:none}";
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\HermesTemp\deepseek-harness\packages\client\ui-agent-preset\src\client\AgentPresetRow.module.css.mjs
		const css$2 = ".eQa5OG_row{border-bottom:1px solid var(--dsw-alias-border-l2);align-items:center;gap:8px;padding:16px 0;display:flex}.eQa5OG_rowText{flex-direction:column;flex:1;gap:4px;min-width:0;padding-right:48px;display:flex}.eQa5OG_title{color:var(--dsw-alias-label-primary);font-size:14px;font-weight:400;line-height:22px}.eQa5OG_desc{color:var(--dsw-alias-label-tertiary);font-size:12px;font-weight:400;line-height:18px}.eQa5OG_selector{background:var(--dsw-alias-bg-module-platform);height:36px;font:inherit;color:var(--dsw-alias-label-primary);cursor:pointer;border:none;border-radius:18px;align-items:center;gap:12px;padding:0 14px;font-size:14px;line-height:22px;display:inline-flex}.eQa5OG_selector:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}.eQa5OG_selector:disabled{cursor:default}.eQa5OG_chevron{flex:none}";
		...
		var AgentPresetRow_module_css_default = {
			"selector": "eQa5OG_selector",
			"rowText": "eQa5OG_rowText",
			"title": "eQa5OG_title",
			"desc": "eQa5OG_desc",
			"chevron": "eQa5OG_chevron",
			"row": "eQa5OG_row"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\HermesTemp\deepseek-harness\packages\client\ui-agent-preset\src\client\AgentPresetSeat.module.css.mjs
		const css$1 = ".mfaoHG_seat{max-width:min(100%,240px);min-height:28px;color:var(--dsw-alias-label-primary);white-space:nowrap;text-overflow:ellipsis;cursor:pointer;background:0 0;border:none;border-radius:16px;align-items:center;gap:4px;padding:0 8px;font-size:13px;font-weight:500;line-height:20px;display:inline-flex;overflow:hidden}.mfaoHG_seat:not(:disabled):hover,.mfaoHG_seat[aria-expanded=true]{background:var(--dsw-alias-interactive-bg-hover)}.mfaoHG_seat:disabled{cursor:default;color:var(--dsw-alias-label-tertiary)}.mfaoHG_seatIcon{color:var(--dsw-alias-label-primary);flex:none}.mfaoHG_introIcon{animation:.15s cubic-bezier(.16,1,.3,1) both mfaoHG_seat-icon-in}@keyframes mfaoHG_seat-icon-in{0%{opacity:0;transform:scale(.5)}to{opacity:1;transform:scale(1)}}.mfaoHG_introText{white-space:pre;display:inline-block}.mfaoHG_introChar{white-space:pre;opacity:0;animation:.4s ease-out forwards mfaoHG_seat-char-in;display:inline-block}@keyframes mfaoHG_seat-char-in{0%{opacity:0;transform:translateY(4px)}to{opacity:1;transform:none}}@media (prefers-reduced-motion:reduce){.mfaoHG_introIcon,.mfaoHG_introChar{opacity:1;animation:none}}.mfaoHG_chevron{color:var(--dsw-alias-label-caption);flex:none}.mfaoHG_item{flex-direction:column;gap:2px;max-width:280px;display:flex}.mfaoHG_itemName{color:var(--dsw-alias-label-primary);font-size:13px;line-height:20px}.mfaoHG_itemDesc{color:var(--dsw-alias-label-caption);white-space:normal;font-size:12px;line-height:16px}";
		...
		var AgentPresetSeat_module_css_default = {
			"introIcon": "mfaoHG_introIcon",
			"chevron": "mfaoHG_chevron",
			"itemDesc": "mfaoHG_itemDesc",
			"seatIcon": "mfaoHG_seatIcon",
			"introChar": "mfaoHG_introChar",
			"seat-char-in": "mfaoHG_seat-char-in",
			"itemName": "mfaoHG_itemName",
			"seat": "mfaoHG_seat",
			"seat-icon-in": "mfaoHG_seat-icon-in",
			"introText": "mfaoHG_introText",
			"item": "mfaoHG_item"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\HermesTemp\deepseek-harness\packages\client\ui-agent-preset\src\client\AgentPresetSection.module.css.mjs
		const css = ".Fv0BZq_section{max-width:720px;color:var(--dsw-alias-label-primary);flex-direction:column;gap:12px;display:flex}.Fv0BZq_title{margin:0;font-size:18px;font-weight:600}.Fv0BZq_intro{color:var(--dsw-alias-label-tertiary);margin:0;font-size:13px}.Fv0BZq_group{flex-direction:column;gap:10px;display:flex}.Fv0BZq_group+.Fv0BZq_group{margin-top:20px}.Fv0BZq_groupHead{letter-spacing:.06em;text-transform:uppercase;color:var(--dsw-alias-label-tertiary);margin:0;font-size:12px;font-weight:600}.Fv0BZq_cards{grid-template-columns:repeat(auto-fill,minmax(268px,1fr));grid-auto-rows:1fr;gap:12px;margin:0;padding:0;list-style:none;display:grid}.Fv0BZq_card{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);border-radius:12px;flex-direction:column;transition:border-color .16s,background .16s;display:flex}.Fv0BZq_card:hover:not(.Fv0BZq_cardActive){border-color:var(--dsw-alias-label-dimmed)}.Fv0BZq_cardActive{background:var(--dsw-alias-bg-layer-2);border-color:var(--dsw-alias-label-primary)}.Fv0BZq_cardBroken,.Fv0BZq_cardBroken:hover{border-color:var(--dsw-alias-state-error-primary)}.Fv0BZq_brokenBadge{white-space:nowrap;background:var(--dsw-alias-state-error-primary);color:var(--dsw-alias-bg-layer-3);border-radius:999px;padding:1px 8px;font-size:11px;font-weight:500;line-height:17px}.Fv0BZq_cardBrokenReason{color:var(--dsw-alias-state-error-primary);overflow-wrap:anywhere;font-size:12px;line-height:1.5}.Fv0BZq_cardMain{appearance:none;font:inherit;color:inherit;text-align:left;cursor:pointer;background:0 0;border:0;border-radius:12px 12px 0 0;flex-direction:column;flex:1;gap:8px;padding:14px 16px 12px;display:flex}.Fv0BZq_cardMain:disabled{cursor:default}.Fv0BZq_cardMain:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:-2px}.Fv0BZq_cardHead{align-items:center;gap:8px;display:flex}.Fv0BZq_cardName{font-size:15px;font-weight:600;line-height:1.4}.Fv0BZq_badge,.Fv0BZq_inUse{white-space:nowrap;border-radius:999px;padding:1px 8px;font-size:11px;font-weight:500;line-height:17px}.Fv0BZq_badge{border:1px solid var(--dsw-alias-border-l2);color:var(--dsw-alias-label-tertiary)}.Fv0BZq_inUse{background:var(--dsw-alias-label-primary);color:var(--dsw-alias-bg-layer-3);margin-left:auto}.Fv0BZq_cardDesc{color:var(--dsw-alias-label-secondary);-webkit-line-clamp:4;overflow-wrap:anywhere;-webkit-box-orient:vertical;min-height:42px;font-size:13px;line-height:1.55;display:-webkit-box;overflow:hidden}.Fv0BZq_cardId{font-family:var(--dsw-font-mono,ui-monospace, SFMono-Regular, Menlo, monospace);color:var(--dsw-alias-label-dimmed);margin-top:auto;font-size:11px}.Fv0BZq_cardFoot{border-top:1px solid var(--dsw-alias-border-l2);justify-content:flex-end;gap:2px;padding:6px 10px;display:flex}.Fv0BZq_iconButton{appearance:none;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:0;border-radius:7px;align-items:center;padding:6px;display:inline-flex;position:relative}.Fv0BZq_iconButton:disabled{opacity:.4;cursor:default}.Fv0BZq_iconButton:hover:not(:disabled){background:var(--dsw-alias-bg-layer-1);color:var(--dsw-alias-label-primary)}.Fv0BZq_iconButton:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:-1px}.Fv0BZq_iconButton:after{content:attr(data-tip);background:var(--dsw-alias-label-primary);color:var(--dsw-alias-bg-layer-3);white-space:nowrap;opacity:0;pointer-events:none;border-radius:6px;padding:3px 8px;font-size:11px;line-height:17px;transition:opacity .12s;position:absolute;bottom:calc(100% + 6px);left:50%;transform:translate(-50%)}.Fv0BZq_iconButton:hover:after,.Fv0BZq_iconButton:focus-visible:after{opacity:1}.Fv0BZq_iconDanger:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover-danger);color:var(--dsw-alias-state-error-primary)}.Fv0BZq_revealedPath{color:var(--dsw-alias-label-tertiary);align-items:baseline;gap:6px;margin:0;padding:6px 16px 10px;font-size:11px;display:flex}.Fv0BZq_revealedPath code{font-family:var(--dsw-font-mono,ui-monospace, SFMono-Regular, Menlo, monospace);color:var(--dsw-alias-label-secondary);user-select:all;overflow-wrap:anywhere}.Fv0BZq_revealedPathLabel{white-space:nowrap}.Fv0BZq_secondaryButton{color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;background:0 0;border:none;border-radius:7px;padding:5px 8px;font-size:12.5px}.Fv0BZq_secondaryButton:hover:not(:disabled){background:var(--dsw-alias-bg-layer-1)}.Fv0BZq_secondaryButton:disabled{opacity:.5;cursor:default}.Fv0BZq_field{flex-direction:column;gap:6px;display:flex}.Fv0BZq_fieldLabel{color:var(--dsw-alias-label-secondary);font-size:12px;font-weight:500}.Fv0BZq_input{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);font:inherit;background:var(--dsw-alias-bg-layer-1);color:var(--dsw-alias-label-primary);border-radius:10px;padding:9px 12px;font-size:13px}.Fv0BZq_input:focus{border-color:var(--dsw-alias-brand-primary);outline:none}.Fv0BZq_input::placeholder{color:var(--dsw-alias-label-dimmed)}.Fv0BZq_dialog{width:min(560px,100%)}.Fv0BZq_dialogFields{flex-direction:column;gap:12px;display:flex}.Fv0BZq_viewerCode{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-2);max-height:min(52vh,480px);color:var(--dsw-alias-label-secondary);font-family:var(--dsw-font-mono,ui-monospace, SFMono-Regular, Menlo, monospace);white-space:pre;tab-size:2;--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border-radius:10px;margin:0;padding:12px;font-size:12.5px;line-height:1.5;overflow:auto}.Fv0BZq_error{color:var(--dsw-alias-state-error-primary);margin:0;font-size:12px}.Fv0BZq_deleteDialog{width:min(480px,100%)}.Fv0BZq_deleteConfirm:not(:disabled){border-color:var(--dsw-alias-state-error-primary);color:var(--dsw-alias-state-error-primary)}.Fv0BZq_deleteConfirm:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover-danger)}.Fv0BZq_creatorButton{box-sizing:border-box;border:1px dashed var(--dsw-alias-border-l3);height:44px;font:inherit;color:var(--dsw-alias-label-primary);cursor:pointer;background:0 0;border-radius:12px;justify-content:center;align-self:stretch;align-items:center;gap:6px;font-size:14px;line-height:22px;display:flex}.Fv0BZq_creatorButton:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}.Fv0BZq_creatorButton:disabled{opacity:.4;cursor:default}";
		...
		var AgentPresetSection_module_css_default = {
			"viewerCode": "Fv0BZq_viewerCode",
			"revealedPath": "Fv0BZq_revealedPath",
			"fieldLabel": "Fv0BZq_fieldLabel",
			"dialog": "Fv0BZq_dialog",
			"deleteDialog": "Fv0BZq_deleteDialog",
			"revealedPathLabel": "Fv0BZq_revealedPathLabel",
			"group": "Fv0BZq_group",
			"cardActive": "Fv0BZq_cardActive",
			"brokenBadge": "Fv0BZq_brokenBadge",
			"cards": "Fv0BZq_cards",
			"card": "Fv0BZq_card",
			"error": "Fv0BZq_error",
			"cardBroken": "Fv0BZq_cardBroken",
			"secondaryButton": "Fv0BZq_secondaryButton",
			"iconDanger": "Fv0BZq_iconDanger",
			"input": "Fv0BZq_input",
			"cardMain": "Fv0BZq_cardMain",
			"cardDesc": "Fv0BZq_cardDesc",
			"groupHead": "Fv0BZq_groupHead",
			"cardName": "Fv0BZq_cardName",
			"title": "Fv0BZq_title",
			"cardHead": "Fv0BZq_cardHead",
			"iconButton": "Fv0BZq_iconButton",
			"field": "Fv0BZq_field",
			"dialogFields": "Fv0BZq_dialogFields",
			"section": "Fv0BZq_section",
			"cardId": "Fv0BZq_cardId",
			"intro": "Fv0BZq_intro",
			"badge": "Fv0BZq_badge",
			"cardFoot": "Fv0BZq_cardFoot",
			"creatorButton": "Fv0BZq_creatorButton",
			"inUse": "Fv0BZq_inUse",
			"deleteConfirm": "Fv0BZq_deleteConfirm",
			"cardBrokenReason": "Fv0BZq_cardBrokenReason"
		};
		//#endregion
									...
									children: group.map(({ row, text }) => (0, react_jsx_runtime.jsxs)("li", {
										...
										children: [
											...
											state.revealedPaths[row.id] === void 0 ? null : (0, react_jsx_runtime.jsxs)("p", {
												...
												}), (0, react_jsx_runtime.jsx)("code", { children: globalThis.__DSH_FILE_ACTIONS__?.displayPath(state.revealedPaths[row.id]) ?? state.revealedPaths[row.id] })]
											})
										]
									}, row.id))
								}),
