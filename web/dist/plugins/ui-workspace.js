window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\HermesTemp\deepseek-harness\packages\client\ui-workspace\src\client\rows\Rows.module.css.mjs
		const css$3 = ".lUA0WG_projectRow,.lUA0WG_sessionRow{cursor:pointer;user-select:none;color:var(--dsw-alias-label-primary);border-radius:8px;align-items:center;gap:6px;padding:0 8px;display:flex}.lUA0WG_projectRow:hover,.lUA0WG_sessionRow:hover,.lUA0WG_sessionRow.lUA0WG_selected{background:var(--dsw-alias-interactive-bg-hover)}.lUA0WG_searchResultRow{box-sizing:border-box;cursor:pointer;text-align:left;width:100%;min-height:48px;color:var(--dsw-alias-label-primary);background:0 0;border:none;border-radius:8px;flex-direction:column;align-items:stretch;padding:4px 8px;display:flex}.lUA0WG_searchResultRow:hover,.lUA0WG_searchResultRow.lUA0WG_selected{background:var(--dsw-alias-interactive-bg-hover)}.lUA0WG_searchResultHeading{align-items:center;min-width:0;display:flex}.lUA0WG_searchResultTitle{text-overflow:ellipsis;white-space:nowrap;min-width:0;margin-left:4px;font-size:14px;line-height:20px;overflow:hidden}.lUA0WG_searchResultMeta{align-items:center;gap:6px;min-width:0;margin-left:20px;display:flex}.lUA0WG_searchResultWorkspace,.lUA0WG_searchResultSnippet{text-overflow:ellipsis;white-space:nowrap;font-size:12px;line-height:17px;overflow:hidden}.lUA0WG_searchResultWorkspace{max-width:40%;color:var(--dsw-alias-label-tertiary);flex:none}.lUA0WG_searchResultSnippet{min-width:0;color:var(--dsw-alias-label-secondary);flex:1}.lUA0WG_projectRow{box-sizing:border-box;align-items:center;height:34px}.lUA0WG_projectRow .lUA0WG_rowActions{height:20px}.lUA0WG_sessionRow{height:32px;animation:lUA0WG_row-in .15s var(--ds-ease-in-out);gap:0}.lUA0WG_sessionRow .lUA0WG_title{margin:0 6px 0 4px}.lUA0WG_flatSessionRowWithoutStatus .lUA0WG_title{margin-left:0}@keyframes lUA0WG_row-in{0%{opacity:0}}.lUA0WG_slot{width:16px;height:20px;color:var(--dsw-alias-label-tertiary);flex:none;justify-content:center;align-items:center;display:inline-flex}.lUA0WG_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}.lUA0WG_folderActive{color:var(--dsw-alias-state-business-primary)}.lUA0WG_projectRow .lUA0WG_chevron{display:none}.lUA0WG_projectRow:hover .lUA0WG_chevron{display:inline-flex}.lUA0WG_projectRow:hover .lUA0WG_folder{display:none}.lUA0WG_arrow{transition:transform .15s var(--ds-ease-in-out)}.lUA0WG_arrowOpen{transform:rotate(90deg)}.lUA0WG_projectText{flex-direction:column;flex:1;gap:2px;min-width:0;display:flex}.lUA0WG_title{text-overflow:ellipsis;white-space:nowrap;min-width:0;font-size:14px;line-height:20px;overflow:hidden}.lUA0WG_renameInput{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-button-elevated-fill);min-width:0;color:inherit;border-radius:4px;outline:none;padding:0 2px;font-size:14px;line-height:20px}.lUA0WG_sessionRow .lUA0WG_title{flex:1}.lUA0WG_meta{text-overflow:ellipsis;white-space:nowrap;color:var(--dsw-alias-label-tertiary);font-size:12px;line-height:20px;overflow:hidden}.lUA0WG_time{color:var(--dsw-alias-label-tertiary);flex:none;font-size:12px;line-height:20px}.lUA0WG_dot{flex:none}.lUA0WG_rowActions{flex:none;align-items:center;gap:12px;display:none}.lUA0WG_projectRow:hover .lUA0WG_rowActions,.lUA0WG_sessionRow:hover .lUA0WG_rowActions,.lUA0WG_projectRow.lUA0WG_menuOpen .lUA0WG_rowActions,.lUA0WG_sessionRow.lUA0WG_menuOpen .lUA0WG_rowActions{display:inline-flex}.lUA0WG_sessionRow:hover .lUA0WG_time,.lUA0WG_sessionRow.lUA0WG_menuOpen .lUA0WG_time{display:none}.lUA0WG_projectRow.lUA0WG_menuOpen,.lUA0WG_sessionRow.lUA0WG_menuOpen{background:var(--dsw-alias-interactive-bg-hover)}.lUA0WG_sessionRow.lUA0WG_dropBefore,.lUA0WG_sessionRow.lUA0WG_dropAfter{position:relative}.lUA0WG_sessionRow.lUA0WG_dropBefore:before,.lUA0WG_sessionRow.lUA0WG_dropAfter:after{content:\"\";z-index:1;background:linear-gradient(55deg, transparent calc(50% - 1px), var(--dsw-alias-state-business-primary) calc(50% - 1px) calc(50% + 1px), transparent calc(50% + 1px)) 0 0 / 5px 7px no-repeat, linear-gradient(125deg, transparent calc(50% - 1px), var(--dsw-alias-state-business-primary) calc(50% - 1px) calc(50% + 1px), transparent calc(50% + 1px)) 0 5px / 5px 7px no-repeat, linear-gradient(var(--dsw-alias-state-business-primary) 0 0) 4px 5px / calc(100% - 4px) 2px no-repeat;pointer-events:none;height:12px;position:absolute;left:0;right:4px}.lUA0WG_sessionRow.lUA0WG_dropBefore:before{top:-7px}.lUA0WG_sessionRow.lUA0WG_dropAfter:after{bottom:-7px}.lUA0WG_hoverContent{flex-direction:column;gap:8px;display:flex}.lUA0WG_hoverTitle{color:#fff;overflow-wrap:break-word;font-size:14px;line-height:20px}.lUA0WG_hoverPath{color:#cfd3d6;word-break:break-all;font-size:12px;line-height:16px}.lUA0WG_hoverTime{color:#cfd3d6;font-size:12px;line-height:16px}.lUA0WG_hoverStatus{color:#adb2b8;align-items:center;gap:8px;font-size:12px;line-height:20px;display:flex}.lUA0WG_iconButton{cursor:pointer;width:16px;height:16px;color:var(--dsw-alias-label-tertiary);background:0 0;border:none;border-radius:4px;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}.lUA0WG_iconButton:hover{color:var(--dsw-alias-label-primary)}.lUA0WG_chevron{color:var(--dsw-alias-label-caption)}@media (prefers-reduced-motion:reduce){.lUA0WG_sessionRow,.lUA0WG_arrow{transition:none;animation:none}}";
		...
		var Rows_module_css_default = {
			"dropAfter": "lUA0WG_dropAfter",
			"sessionRow": "lUA0WG_sessionRow",
			"dropBefore": "lUA0WG_dropBefore",
			"rowActions": "lUA0WG_rowActions",
			"searchResultHeading": "lUA0WG_searchResultHeading",
			"row-in": "lUA0WG_row-in",
			"title": "lUA0WG_title",
			"flatSessionRowWithoutStatus": "lUA0WG_flatSessionRowWithoutStatus",
			"meta": "lUA0WG_meta",
			"hoverContent": "lUA0WG_hoverContent",
			"searchResultSnippet": "lUA0WG_searchResultSnippet",
			"hoverTitle": "lUA0WG_hoverTitle",
			"selected": "lUA0WG_selected",
			"searchResultWorkspace": "lUA0WG_searchResultWorkspace",
			"folder": "lUA0WG_folder",
			"visuallyHidden": "lUA0WG_visuallyHidden",
			"hoverPath": "lUA0WG_hoverPath",
			"arrowOpen": "lUA0WG_arrowOpen",
			"renameInput": "lUA0WG_renameInput",
			"time": "lUA0WG_time",
			"projectText": "lUA0WG_projectText",
			"projectRow": "lUA0WG_projectRow",
			"hoverTime": "lUA0WG_hoverTime",
			"hoverStatus": "lUA0WG_hoverStatus",
			"menuOpen": "lUA0WG_menuOpen",
			"arrow": "lUA0WG_arrow",
			"slot": "lUA0WG_slot",
			"searchResultTitle": "lUA0WG_searchResultTitle",
			"dot": "lUA0WG_dot",
			"chevron": "lUA0WG_chevron",
			"folderActive": "lUA0WG_folderActive",
			"iconButton": "lUA0WG_iconButton",
			"searchResultMeta": "lUA0WG_searchResultMeta",
			"searchResultRow": "lUA0WG_searchResultRow"
		};
		//#endregion
		...
		*/
		...
		var WorkspacePicker_module_css_default = {
			"modalAction": "rfjl1G_modalAction",
			"modalError": "rfjl1G_modalError",
			"menuStatus": "rfjl1G_menuStatus"
		};
		//#endregion
		...
		*/
		function WorkspacePickFlow({ t, open, anchorRef, useWorkspaces, createWorkspace, useDirectoryFlow, renderDirectoryFlow, onPick, onClose, addOnly = false, side = "bottom", selectedId }) {
            ...
            const confirmWorkspace=()=>{if(pickingFolder||!workspacePath)return;setPickingFolder(true);setModalError(null);adoptDirectory(workspacePath).then((workspace) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\HermesTemp\deepseek-harness\packages\client\ui-workspace\src\client\WorkspaceBrowser.module.css.mjs
		const css$1 = "._5VlF5q_root{--dsh-session-list-edge-inset:var(--dsh-sidebar-inline-padding);--dsh-session-list-scrollbar-width:8px;--dsh-session-list-scrollbar-offset:2px;box-sizing:border-box;min-height:0;padding-right:var(--dsh-session-list-edge-inset);flex-direction:column;flex:1;display:flex}._5VlF5q_root._5VlF5q_rail{padding-right:0}._5VlF5q_iconButton{cursor:pointer;width:28px;height:28px;color:var(--dsw-alias-label-secondary);background:0 0;border:none;border-radius:50%;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}._5VlF5q_iconButton:hover{background:var(--dsw-alias-interactive-bg-hover)}._5VlF5q_sectionHeader{box-sizing:border-box;height:36px;color:var(--dsw-alias-label-tertiary);border-radius:12px;flex:none;justify-content:flex-end;align-items:center;gap:4px;margin-bottom:4px;padding-left:4px;display:flex;overflow:hidden}._5VlF5q_root:not(._5VlF5q_rail) ._5VlF5q_sectionHeader{margin-top:2px;margin-right:-4px}._5VlF5q_sectionLabel{white-space:nowrap;opacity:1;visibility:visible;min-width:0;max-width:45%;transition:max-width .18s var(--ds-ease-in-out), margin-right .18s var(--ds-ease-in-out), opacity .12s var(--ds-ease-in-out), transform .18s var(--ds-ease-in-out), visibility 0s linear;flex:none;line-height:20px;overflow:hidden}._5VlF5q_sectionLabelHidden{opacity:0;visibility:hidden;max-width:0;margin-right:-4px;transition-delay:0s,0s,0s,0s,.18s;transform:translate(-4px)}._5VlF5q_searchSlot{box-sizing:border-box;min-width:0;max-width:28px;transition:max-width .18s var(--ds-ease-in-out), padding-left .18s var(--ds-ease-in-out);flex:1;align-items:center;margin-left:auto;padding-left:0;display:flex}._5VlF5q_searchSlotExpanded{max-width:100%;padding-left:0}._5VlF5q_headerActions{opacity:1;visibility:visible;max-width:60px;transition:max-width .18s var(--ds-ease-in-out), opacity .12s var(--ds-ease-in-out), transform .18s var(--ds-ease-in-out), visibility 0s linear;flex:none;align-items:center;gap:4px;display:flex;overflow:hidden}._5VlF5q_headerActionsHidden{opacity:0;visibility:hidden;pointer-events:none;max-width:0;transition-delay:0s,0s,0s,.18s;transform:translate(4px)}._5VlF5q_search{box-sizing:border-box;cursor:text;width:100%;height:28px;color:var(--dsw-alias-label-secondary);transition:width .18s var(--ds-ease-in-out), padding .18s var(--ds-ease-in-out), border-color .18s var(--ds-ease-in-out), background-color .18s var(--ds-ease-in-out);background:0 0;border:none;border-radius:50%;flex:none;align-items:center;gap:0;margin:0;padding:0;display:flex;overflow:hidden}._5VlF5q_searchExpanded{border:1px solid var(--dsw-alias-border-l2);width:calc(100% + 4px);height:30px;color:var(--dsw-alias-label-caption);background:0 0;border-radius:10px;margin-inline:-2px;padding:0 4px 0 0}._5VlF5q_searchButton{cursor:pointer;width:28px;height:28px;color:inherit;background:0 0;border:none;border-radius:50%;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}._5VlF5q_searchExpanded ._5VlF5q_searchButton{width:28px;height:30px}._5VlF5q_searchButton:hover{background:var(--dsw-alias-interactive-bg-hover)}._5VlF5q_searchExpanded ._5VlF5q_searchButton:hover{background:0 0}._5VlF5q_searchInput{opacity:0;pointer-events:none;width:0;min-width:0;color:var(--dsw-alias-label-primary);transition:opacity .12s var(--ds-ease-in-out);background:0 0;border:none;outline:none;flex:1;font-size:13px;line-height:18px}._5VlF5q_searchExpanded ._5VlF5q_searchInput{opacity:1;pointer-events:auto;margin-left:-2px}._5VlF5q_searchInput::placeholder{color:var(--dsw-alias-label-tertiary)}._5VlF5q_clearButton{cursor:pointer;width:24px;height:24px;color:var(--dsw-alias-label-secondary);background:0 0;border:none;border-radius:50%;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}._5VlF5q_clearButton:hover{background:var(--dsw-alias-interactive-bg-hover)}._5VlF5q_rail ._5VlF5q_sectionHeader{justify-content:flex-start;gap:0;margin-bottom:12px;padding-left:0}._5VlF5q_rail ._5VlF5q_headerActions{max-width:none}._5VlF5q_rail ._5VlF5q_iconButton{width:36px;height:36px;color:var(--dsw-alias-label-primary)}._5VlF5q_rail ._5VlF5q_search{background:0 0;border-color:#0000;gap:0;width:36px;height:36px;margin:0 0 12px;padding:0}._5VlF5q_rail ._5VlF5q_searchButton{width:36px;height:36px;color:var(--dsw-alias-label-primary)}._5VlF5q_rail ._5VlF5q_searchButton:hover{background:var(--dsw-alias-interactive-bg-hover)}._5VlF5q_listArea{min-height:0;margin-left:-4px;margin-right:calc(-1 * var(--dsh-session-list-edge-inset));flex-direction:column;flex:1;padding-left:4px;display:flex;overflow:visible}._5VlF5q_rail ._5VlF5q_listArea{margin-left:0;margin-right:0;padding-left:0}._5VlF5q_treeBody{flex-direction:column;flex:1;min-height:0;display:flex;position:relative}._5VlF5q_fade{left:0;right:var(--dsh-session-list-edge-inset);background:linear-gradient(to bottom, transparent, var(--dsw-specific-sidebar-fill));pointer-events:none;height:24px;position:absolute;bottom:0}._5VlF5q_wide{animation:_5VlF5q_wide-in .2s var(--ds-ease-in-out)}@keyframes _5VlF5q_wide-in{0%{opacity:0}}._5VlF5q_list{min-height:0;margin-left:-4px;margin-right:var(--dsh-session-list-scrollbar-offset);padding-left:4px;padding-right:calc(var(--dsh-session-list-edge-inset) - var(--dsh-session-list-scrollbar-width) - var(--dsh-session-list-scrollbar-offset));scrollbar-gutter:stable;flex:1;padding-bottom:16px;overflow-y:auto}._5VlF5q_flatList>*+*,._5VlF5q_searchTree>[role=treeitem]+[role=treeitem],._5VlF5q_groupSection>*+*{margin-top:2px}._5VlF5q_searchStatus,._5VlF5q_searchWarning{color:var(--dsw-alias-label-tertiary);padding:10px 12px;font-size:12px;line-height:18px}._5VlF5q_searchWarning{color:var(--dsw-alias-label-secondary)}._5VlF5q_groupSection{position:relative}._5VlF5q_groupSection+._5VlF5q_groupSection{margin-top:4px}._5VlF5q_listTopDropIndicator,._5VlF5q_workspaceDropBefore:before,._5VlF5q_workspaceDropAfter:after{content:\"\";z-index:1;background:linear-gradient(55deg, transparent calc(50% - 1px), var(--dsw-alias-state-business-primary) calc(50% - 1px) calc(50% + 1px), transparent calc(50% + 1px)) 0 0 / 5px 7px no-repeat, linear-gradient(125deg, transparent calc(50% - 1px), var(--dsw-alias-state-business-primary) calc(50% - 1px) calc(50% + 1px), transparent calc(50% + 1px)) 0 5px / 5px 7px no-repeat, linear-gradient(var(--dsw-alias-state-business-primary) 0 0) 4px 5px / calc(100% - 4px) 2px no-repeat;pointer-events:none;height:12px;position:absolute;left:0;right:0}._5VlF5q_listTopDropIndicator{top:-8px;left:0;right:var(--dsh-session-list-edge-inset)}._5VlF5q_listTopDropActive>._5VlF5q_workspaceDropBefore:first-child:before{display:none}._5VlF5q_workspaceDropBefore:before{top:-8px}._5VlF5q_workspaceDropAfter:after{bottom:-8px}._5VlF5q_sessionOverflowButton{cursor:pointer;text-align:left;width:100%;height:28px;color:var(--dsw-alias-label-tertiary);background:0 0;border:none;border-radius:8px;padding:0 12px 0 28px;font-size:12px}._5VlF5q_groupSection>._5VlF5q_sessionOverflowButton{margin-top:0}._5VlF5q_sessionOverflowButton:hover{color:var(--dsw-alias-label-secondary);background:0 0}._5VlF5q_empty{color:var(--dsw-alias-label-tertiary);padding:16px 12px;font-size:13px}._5VlF5q_renameInput{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);width:100%;height:44px;color:var(--dsw-alias-label-primary);background:0 0;border-radius:22px;outline:none;padding:7px 14px;font-size:14px;font-weight:400;line-height:22px}._5VlF5q_renameInput:disabled{color:var(--dsw-alias-label-dimmed)}._5VlF5q_renameError{color:var(--dsw-alias-state-error-primary);margin-top:8px;font-size:12px;line-height:18px}._5VlF5q_deleteAction:not(:disabled){color:var(--dsw-alias-state-error-primary)}._5VlF5q_deleteStatus{color:var(--dsw-alias-label-secondary);font-size:12px;line-height:18px}@media (prefers-reduced-motion:reduce){._5VlF5q_wide{animation:none}._5VlF5q_search,._5VlF5q_sectionLabel,._5VlF5q_searchSlot,._5VlF5q_searchInput,._5VlF5q_headerActions{transition:none}}";
		...
		var WorkspaceBrowser_module_css_default = {
			"wide": "_5VlF5q_wide",
			"listTopDropIndicator": "_5VlF5q_listTopDropIndicator",
			"empty": "_5VlF5q_empty",
			"flatList": "_5VlF5q_flatList",
			"searchInput": "_5VlF5q_searchInput",
			"workspaceDropBefore": "_5VlF5q_workspaceDropBefore",
			"sectionLabelHidden": "_5VlF5q_sectionLabelHidden",
			"listArea": "_5VlF5q_listArea",
			"searchStatus": "_5VlF5q_searchStatus",
			"headerActionsHidden": "_5VlF5q_headerActionsHidden",
			"searchSlot": "_5VlF5q_searchSlot",
			"searchButton": "_5VlF5q_searchButton",
			"listTopDropActive": "_5VlF5q_listTopDropActive",
			"clearButton": "_5VlF5q_clearButton",
			"sessionOverflowButton": "_5VlF5q_sessionOverflowButton",
			"treeBody": "_5VlF5q_treeBody",
			"workspaceDropAfter": "_5VlF5q_workspaceDropAfter",
			"search": "_5VlF5q_search",
			"deleteAction": "_5VlF5q_deleteAction",
			"deleteStatus": "_5VlF5q_deleteStatus",
			"sectionLabel": "_5VlF5q_sectionLabel",
			"fade": "_5VlF5q_fade",
			"renameError": "_5VlF5q_renameError",
			"searchTree": "_5VlF5q_searchTree",
			"sectionHeader": "_5VlF5q_sectionHeader",
			"searchWarning": "_5VlF5q_searchWarning",
			"renameInput": "_5VlF5q_renameInput",
			"wide-in": "_5VlF5q_wide-in",
			"searchSlotExpanded": "_5VlF5q_searchSlotExpanded",
			"searchExpanded": "_5VlF5q_searchExpanded",
			"root": "_5VlF5q_root",
			"groupSection": "_5VlF5q_groupSection",
			"headerActions": "_5VlF5q_headerActions",
			"list": "_5VlF5q_list",
			"iconButton": "_5VlF5q_iconButton",
			"rail": "_5VlF5q_rail"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\HermesTemp\deepseek-harness\packages\client\ui-workspace\src\client\ArchivedSessionsSection.module.css.mjs
		const css = "._9ExMla_section{width:100%;max-width:720px;color:var(--dsw-alias-label-primary);flex-direction:column;gap:12px;display:flex}._9ExMla_title{margin:0;font-size:16px;font-weight:500;line-height:24px}._9ExMla_description,._9ExMla_error{margin:0;font-size:14px;line-height:22px}._9ExMla_description{color:var(--dsw-alias-label-tertiary)}._9ExMla_error{color:var(--dsw-alias-state-error-primary)}._9ExMla_empty{border:1px dashed var(--dsw-alias-border-l2);text-align:center;color:var(--dsw-alias-label-tertiary);border-radius:12px;margin-top:12px;padding:28px 16px;font-size:14px}._9ExMla_list{flex-direction:column;gap:8px;margin:12px 0 0;padding:0;list-style:none;display:flex}._9ExMla_row{border:1px solid var(--dsw-alias-border-l2);border-radius:12px;flex-wrap:wrap;align-items:center;gap:16px;padding:12px 14px;display:flex}._9ExMla_identity{flex:1;min-width:0}._9ExMla_name{text-overflow:ellipsis;white-space:nowrap;font-size:14px;font-weight:500;line-height:22px;overflow:hidden}._9ExMla_meta{color:var(--dsw-alias-label-tertiary);flex-wrap:wrap;gap:4px 12px;margin-top:2px;font-size:12px;line-height:18px;display:flex}._9ExMla_actions{flex:none;align-items:center;gap:8px;display:inline-flex}._9ExMla_primary,._9ExMla_secondary,._9ExMla_danger,._9ExMla_dangerSolid{box-sizing:border-box;height:32px;font:inherit;cursor:pointer;border-radius:16px;padding:0 12px;font-size:13px}._9ExMla_primary{background:var(--dsw-alias-button-primary-fill);color:var(--dsw-alias-label-primary-foreground);border:none}._9ExMla_secondary{border:1px solid var(--dsw-alias-border-l2);color:var(--dsw-alias-label-primary);background:0 0}._9ExMla_danger{border:1px solid var(--dsw-alias-state-error-primary);color:var(--dsw-alias-state-error-primary);background:0 0}._9ExMla_dangerSolid{background:var(--dsw-alias-state-error-primary);color:var(--dsw-alias-label-primary-foreground);border:none}._9ExMla_primary:hover:not(:disabled){background:var(--dsw-alias-button-primary-hover)}._9ExMla_secondary:hover:not(:disabled),._9ExMla_danger:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}._9ExMla_dangerSolid:hover:not(:disabled){opacity:.85}._9ExMla_primary:disabled,._9ExMla_secondary:disabled,._9ExMla_danger:disabled,._9ExMla_dangerSolid:disabled{cursor:default;opacity:.45}._9ExMla_confirm{border-top:1px solid var(--dsw-alias-border-l2);flex-basis:100%;align-items:center;gap:16px;padding-top:12px;display:flex}._9ExMla_confirmCopy{flex-direction:column;flex:1;gap:2px;min-width:0;font-size:13px;line-height:20px;display:flex}._9ExMla_confirmCopy span{color:var(--dsw-alias-label-tertiary)}._9ExMla_confirmActions{flex:none;gap:8px;display:inline-flex}@media (width<=760px){._9ExMla_row{flex-direction:column;align-items:stretch}._9ExMla_actions,._9ExMla_confirmActions{justify-content:flex-end}._9ExMla_confirm{flex-direction:column;align-items:stretch}}";
		const tagId = "@deepseek-ai/dsh-client-ui-workspace/ArchivedSessionsSection.module.css";
		...
		var ArchivedSessionsSection_module_css_default = {
			"actions": "_9ExMla_actions",
			"error": "_9ExMla_error",
			"secondary": "_9ExMla_secondary",
			"name": "_9ExMla_name",
			"list": "_9ExMla_list",
			"primary": "_9ExMla_primary",
			"dangerSolid": "_9ExMla_dangerSolid",
			"confirmCopy": "_9ExMla_confirmCopy",
			"confirm": "_9ExMla_confirm",
			"confirmActions": "_9ExMla_confirmActions",
			"section": "_9ExMla_section",
			"row": "_9ExMla_row",
			"title": "_9ExMla_title",
			"identity": "_9ExMla_identity",
			"danger": "_9ExMla_danger",
			"empty": "_9ExMla_empty",
			"description": "_9ExMla_description",
			"meta": "_9ExMla_meta"
		};
		//#endregion
		//#region lib/types/client/ArchivedSessionsSection.js
		/** Archived-session management page contributed to Settings by ui-workspace. */
		...
		function ArchivedSessionsSection({ useSessions, useWorkspaces, unarchiveSession, deleteArchivedSession, t }) {
			...
			const permanentlyDelete = async (sessionId) => {
				setBusyId(sessionId);
				setError(void 0);
				try {
			...
			return (0, react_jsx_runtime.jsxs)("section", {
				...
				children: [
					...
					(0, react_jsx_runtime.jsx)("p", {
						className: ArchivedSessionsSection_module_css_default.description,
						children: t("archive.description")
					}),
					error !== void 0 && (0, react_jsx_runtime.jsx)("p", {
						className: ArchivedSessionsSection_module_css_default.error,
						role: "alert",
						children: t("archive.actionError", { message: error })
					}),
					workspaces.archivedSessionIds.length === 0 ? (0, react_jsx_runtime.jsx)("div", {
						className: ArchivedSessionsSection_module_css_default.empty,
						children: t("archive.empty")
					}) : (0, react_jsx_runtime.jsx)("ul", {
						className: ArchivedSessionsSection_module_css_default.list,
						children: workspaces.archivedSessionIds.map((sessionId) => {
							const summary = sessions.byId[sessionId];
							const busy = busyId === sessionId;
							const workspace = workspaceBySession.get(sessionId) ?? (summary?.cwd === void 0 ? t("group.ungrouped") : workspaceLabel(summary.cwd));
							const title = summary?.blank === true ? t("session.new") : summary?.displayTitle ?? String(sessionId);
							return (0, react_jsx_runtime.jsxs)("li", {
								...
								children: [
									(0, react_jsx_runtime.jsxs)("div", {
										...
										children: [(0, react_jsx_runtime.jsx)("div", {
											className: ArchivedSessionsSection_module_css_default.name,
											title,
											children: title
										}), (0, react_jsx_runtime.jsxs)("div", {
											className: ArchivedSessionsSection_module_css_default.meta,
											children: [(0, react_jsx_runtime.jsx)("span", { children: workspace }), summary === void 0 ? (0, react_jsx_runtime.jsx)("span", { children: t("archive.unavailable") }) : (0, react_jsx_runtime.jsx)("span", { children: t("archive.updated", { time: new Date(summary.updatedAt).toLocaleString() }) })]
										})]
									}),
									(0, react_jsx_runtime.jsxs)("div", {
										className: ArchivedSessionsSection_module_css_default.actions,
										children: [
											(0, react_jsx_runtime.jsx)("button", {
												type: "button",
											...
											(0, react_jsx_runtime.jsx)("button", {
												type: "button",
												className: ArchivedSessionsSection_module_css_default.danger,
												disabled: busy,
												onClick: () => {
									...
									confirmDeleteId === sessionId && (0, react_jsx_runtime.jsxs)("div", {
										className: ArchivedSessionsSection_module_css_default.confirm,
										role: "alertdialog",
										"aria-label": t("archive.deleteConfirm", { name: title }),
										children: [(0, react_jsx_runtime.jsxs)("div", {
											className: ArchivedSessionsSection_module_css_default.confirmCopy,
											children: [(0, react_jsx_runtime.jsx)("strong", { children: t("archive.deleteConfirm", { name: title }) }), (0, react_jsx_runtime.jsx)("span", { children: t("archive.deleteWarning") })]
										}), (0, react_jsx_runtime.jsxs)("div", {
											className: ArchivedSessionsSection_module_css_default.confirmActions,
											children: [(0, react_jsx_runtime.jsx)("button", {
												type: "button",
												...
												type: "button",
												className: ArchivedSessionsSection_module_css_default.dangerSolid,
												disabled: busy,
												onClick: () => {
													permanentlyDelete(sessionId);
												},
												children: busy ? t("archive.deleting") : t("archive.confirmDelete")
											})]
										})]
									})
								]
		...
		*/
		...
		const zh = {
			...
			"archive.deleteWarning": "此操作会永久删除此会话及其所有子智能体的历史记录，并移除对应列表引用；独立分支会话和工作区文件保留，无法恢复。",
			"archive.cancel": "取消",
			"archive.confirmDelete": "永久删除",
			"archive.deleting": "正在删除…",
			"archive.unavailable": "会话记录暂不可用",
			"archive.updated": "更新于 {time}",
			"archive.actionError": "操作失败：{message}",
		...
		const en = {
			...
			"archive.deleteWarning": "This permanently deletes this session and all its subagent histories and list references. Independent forks and workspace files are retained. This cannot be undone.",
			"archive.cancel": "Cancel",
			"archive.confirmDelete": "Delete permanently",
			"archive.deleting": "Deleting…",
			"archive.unavailable": "Session record is temporarily unavailable",
			"archive.updated": "Updated {time}",
			"archive.actionError": "Action failed: {message}",
