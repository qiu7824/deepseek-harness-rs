	...
	factory: (require) => {
		...
		*/
		...
		const zh = {
			...
			"archive.deleteWarning": "此操作会删除完整会话记录，并从工作区与归档列表中移除，无法恢复。",
			"archive.cancel": "取消",
		...
		const en = {
			...
			"archive.deleteWarning": "This removes the complete session record and its workspace/archive references. It cannot be undone.",
