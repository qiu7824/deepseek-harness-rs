window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#endregion
		//#region \0dsh-css:D:\HermesTemp\deepseek-harness\packages\client\ui-directory-picker-browse\src\client\DirectoryBrowser.module.css.mjs
		const css = ".abED8G_dialog.abED8G_dialog{--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);gap:0;width:min(680px,100%);height:min(500px,100dvh - 32px);padding:0}.abED8G_editorScope{display:contents}.abED8G_header{border-bottom:1px solid var(--dsw-alias-border-l3);flex-direction:column;flex:none;gap:8px;padding:16px 14px 8px 24px;display:flex}.abED8G_title{min-height:28px;color:var(--dsw-alias-label-primary);align-items:flex-end;margin:0;font-size:16px;font-weight:510;line-height:24px;display:flex}.abED8G_crumbBar{box-sizing:border-box;border:1px solid #0000;border-radius:8px;align-items:center;gap:4px;min-height:24px;margin-left:-9px;padding:0 8px;display:flex}.abED8G_crumbBar:has(.abED8G_crumbEditZone:enabled:hover),.abED8G_crumbBar:has(.abED8G_crumbEditZone:focus-visible),.abED8G_crumbBar:has(.abED8G_pathInput){border-color:var(--dsw-alias-border-l2)}.abED8G_millerRow{scrollbar-width:none;flex:1 1 0;align-items:stretch;gap:12px;min-height:0;display:flex;overflow-x:auto}.abED8G_crumbTrail{scrollbar-width:none;flex:0 auto;align-items:center;gap:4px;min-width:0;display:flex;overflow-x:auto}.abED8G_crumbSeat{flex:none;align-items:center;gap:4px;min-width:0;display:inline-flex}.abED8G_crumb{text-overflow:ellipsis;white-space:nowrap;max-width:160px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;padding:0;font-size:13px;font-weight:500;line-height:20px;overflow:hidden}.abED8G_crumb:hover{color:var(--dsw-alias-label-primary)}.abED8G_crumbChevron{color:var(--dsw-alias-label-tertiary);flex:none}.abED8G_crumbEditZone{cursor:text;background:0 0;border:none;outline:none;flex:1 0 34px;justify-content:flex-end;align-items:center;min-width:34px;height:22px;padding:0;display:flex}.abED8G_crumbEditGlyph{color:var(--dsw-alias-label-tertiary);flex:none}.abED8G_crumbEditZone:enabled:hover .abED8G_crumbEditGlyph,.abED8G_crumbEditZone:focus-visible .abED8G_crumbEditGlyph{color:var(--dsw-alias-label-primary)}.abED8G_crumbEditZone:disabled{cursor:default}.abED8G_crumbEditZone:disabled .abED8G_crumbEditGlyph{color:var(--dsw-alias-label-caption)}.abED8G_pathInput{box-sizing:border-box;min-width:0;height:22px;color:var(--dsw-alias-label-primary);background:0 0;border:none;outline:none;flex:1 1 0;padding:0;font-size:13px;line-height:20px}.abED8G_content{flex-direction:column;flex:1 1 0;min-height:0;padding:16px 16px 16px 24px;display:flex;position:relative}.abED8G_column{flex-direction:column;flex:1 1 0;gap:2px;min-width:256px;padding-right:8px;display:flex;overflow-y:auto}.abED8G_divider{background:var(--dsw-alias-border-l3);flex:none;width:1px}.abED8G_rowSeat{flex:none;display:flex}.abED8G_row{text-align:left;cursor:pointer;background:0 0;border:none;border-radius:6px;flex:none;align-items:center;gap:4px;width:100%;height:28px;padding:4px;display:flex}.abED8G_row:hover{background:var(--dsw-alias-interactive-bg-hover)}.abED8G_rowSelected,.abED8G_rowSelected:hover{background:var(--dsw-alias-interactive-bg-active,var(--dsw-alias-interactive-bg-hover))}.abED8G_rowIcon{color:var(--dsw-alias-label-secondary);flex:none}.abED8G_rowIconSelected{color:var(--dsw-alias-button-info-fill);flex:none}.abED8G_rowName{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-primary);flex:1 1 0;font-size:13px;font-weight:500;line-height:20px;overflow:hidden}.abED8G_rowChevron{color:var(--dsw-alias-label-tertiary);flex:none}.abED8G_status,.abED8G_error{padding:4px 120px 4px 4px;font-size:12px;line-height:18px}.abED8G_status{color:var(--dsw-alias-label-secondary)}.abED8G_error{color:var(--dsw-alias-state-error-primary)}.abED8G_loadingFloat{background:var(--dsw-alias-bg-layer-2);padding:2px 8px;position:absolute;bottom:8px;right:16px}.abED8G_footerBar{border-top:1px solid var(--dsw-alias-border-l3);flex-wrap:wrap;flex:none;align-items:center;gap:8px;padding:16px 24px;display:flex}.abED8G_showHiddenToggle{color:var(--dsw-alias-label-secondary);cursor:pointer;white-space:nowrap;background:0 0;border:none;align-items:center;gap:4px;padding:0;font-size:13px;font-weight:500;line-height:20px;display:inline-flex}.abED8G_showHiddenToggle:hover{color:var(--dsw-alias-label-primary)}.abED8G_showHiddenToggle:disabled{color:var(--dsw-alias-label-caption);cursor:default}.abED8G_showHiddenToggleActive{color:var(--dsw-alias-label-primary)}.abED8G_footerGap{flex:1 1 0}.abED8G_footerAction{min-width:72px}.abED8G_createDialog.abED8G_createDialog{gap:0;width:min(380px,100%);padding:0}.abED8G_createBody{flex-direction:column;gap:12px;padding:22px 24px 20px;display:flex}.abED8G_createTitle{color:var(--dsw-alias-label-primary);margin:0;font-size:16px;font-weight:510;line-height:24px}.abED8G_createIn{color:var(--dsw-alias-label-primary);margin:0;font-size:14px;line-height:22px}.abED8G_createInput{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);width:100%;height:44px;color:var(--dsw-alias-label-primary);background:0 0;border-radius:22px;outline:none;padding:7px 14px;font-size:14px;line-height:22px}.abED8G_createInput::placeholder{color:var(--dsw-alias-label-caption)}.abED8G_createActions{justify-content:flex-end;align-items:center;gap:8px;margin-top:8px;display:flex}";
		...
		var DirectoryBrowser_module_css_default = {
			"footerAction": "abED8G_footerAction",
			"footerBar": "abED8G_footerBar",
			"loadingFloat": "abED8G_loadingFloat",
			"createActions": "abED8G_createActions",
			"showHiddenToggleActive": "abED8G_showHiddenToggleActive",
			"status": "abED8G_status",
			"footerGap": "abED8G_footerGap",
			"crumbEditGlyph": "abED8G_crumbEditGlyph",
			"rowIconSelected": "abED8G_rowIconSelected",
			"createBody": "abED8G_createBody",
			"dialog": "abED8G_dialog",
			"showHiddenToggle": "abED8G_showHiddenToggle",
			"header": "abED8G_header",
			"crumbSeat": "abED8G_crumbSeat",
			"rowChevron": "abED8G_rowChevron",
			"error": "abED8G_error",
			"crumbTrail": "abED8G_crumbTrail",
			"content": "abED8G_content",
			"millerRow": "abED8G_millerRow",
			"createDialog": "abED8G_createDialog",
			"createTitle": "abED8G_createTitle",
			"createIn": "abED8G_createIn",
			"createInput": "abED8G_createInput",
			"rowSelected": "abED8G_rowSelected",
			"crumbEditZone": "abED8G_crumbEditZone",
			"crumb": "abED8G_crumb",
			"rowIcon": "abED8G_rowIcon",
			"column": "abED8G_column",
			"divider": "abED8G_divider",
			"row": "abED8G_row",
			"editorScope": "abED8G_editorScope",
			"crumbChevron": "abED8G_crumbChevron",
			"rowSeat": "abED8G_rowSeat",
			"rowName": "abED8G_rowName",
			"crumbBar": "abED8G_crumbBar",
			"pathInput": "abED8G_pathInput",
			"title": "abED8G_title"
		};
		//#endregion
