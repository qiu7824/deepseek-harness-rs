window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		var ConversationController = class extends _deepseek_ai_cordis.Service {
			...
			*/
			...
			/** Pull older pages until one durable event sequence is loaded. */
		...
		*/
		var SessionInputShell = class {
			...
			*/
			...
			/**
			* Clear only the exact ordinary-send snapshot that the Host accepted. If
			* the user edited the draft or changed images while the RPC was pending,
		...
		var InputHub = class {
			...
			*/
			...
			/**
			* Default sink: keep the draft visible until the Host has durably admitted
			* the prompt, then commit-clear it. A transport or business rejection keeps
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\HermesTemp\deepseek-harness\packages\client\ui-conversation\src\client\skeleton\ContextMeter.module.css.mjs
		const css$19 = ".YysEUW_root{display:inline-flex;position:relative}.YysEUW_trigger{width:28px;height:28px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;border-radius:999px;flex:none;place-items:center;display:grid}.YysEUW_trigger:hover{background:var(--dsw-alias-interactive-bg-hover)}.YysEUW_track{fill:none;stroke:var(--dsw-alias-border-l3);stroke-width:2px}.YysEUW_fill{fill:none;stroke:var(--dsw-alias-label-tertiary);stroke-width:2px;stroke-linecap:round}.YysEUW_panel{z-index:100;box-sizing:border-box;border:1px solid var(--dsw-alias-border-inverted);background:var(--dsw-specific-menu);width:264px;box-shadow:var(--dsw-shadow-lv3);color:var(--dsw-alias-label-secondary);cursor:default;border-radius:12px;padding:12px;font-size:12px;line-height:20px;position:absolute;bottom:calc(100% + 8px);right:0}.YysEUW_header{align-items:center;gap:6px;display:flex}.YysEUW_figures{font-variant-numeric:tabular-nums;color:var(--dsw-alias-label-primary);margin-left:auto;font-weight:500}.YysEUW_percent{color:var(--dsw-alias-label-primary);font-weight:500}.YysEUW_headline{color:var(--dsw-alias-label-tertiary)}.YysEUW_headline:empty{display:none}.YysEUW_bar{background:var(--dsw-alias-interactive-bg-hover);border-radius:999px;gap:1px;height:4px;margin:10px 0 12px;display:flex;overflow:hidden}.YysEUW_segment{background:var(--meter-tint,var(--dsw-alias-label-tertiary));border-radius:1px;flex:none;min-width:2px;height:100%}.YysEUW_swatch{background:var(--meter-tint);vertical-align:baseline;border-radius:2px;width:8px;height:8px;margin-right:6px;display:inline-block}.YysEUW_colorSystem{--meter-tint:var(--dsw-static-neutral-bluish-400)}.YysEUW_colorTools{--meter-tint:#a78bfa}.YysEUW_colorMessages{--meter-tint:var(--dsw-static-blue-450)}.YysEUW_rows{margin:6px 0 0}.YysEUW_row{justify-content:space-between;align-items:center;gap:12px;padding:2px 0;display:flex}.YysEUW_row dt{color:var(--dsw-alias-label-secondary)}.YysEUW_row dd{font-variant-numeric:tabular-nums;color:var(--dsw-alias-label-primary);margin:0}";
		...
		var ContextMeter_module_css_default = {
			"fill": "YysEUW_fill",
			"panel": "YysEUW_panel",
			"figures": "YysEUW_figures",
			"colorTools": "YysEUW_colorTools",
			"segment": "YysEUW_segment",
			"row": "YysEUW_row",
			"headline": "YysEUW_headline",
			"bar": "YysEUW_bar",
			"track": "YysEUW_track",
			"colorMessages": "YysEUW_colorMessages",
			"header": "YysEUW_header",
			"root": "YysEUW_root",
			"trigger": "YysEUW_trigger",
			"percent": "YysEUW_percent",
			"colorSystem": "YysEUW_colorSystem",
			"rows": "YysEUW_rows",
			"swatch": "YysEUW_swatch"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\HermesTemp\deepseek-harness\packages\client\ui-conversation\src\client\skeleton\PermissionSelect.module.css.mjs
		const css$18 = ".tMJkdG_trigger{min-width:0;max-width:220px;height:28px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;border-radius:24px;outline:none;align-items:center;gap:4px;padding:0 4px 0 8px;font-size:13px;font-weight:500;line-height:20px;display:inline-flex}.tMJkdG_trigger:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}.tMJkdG_trigger:focus-visible{box-shadow:0 0 0 2px var(--dsw-alias-border-l3)}.tMJkdG_trigger:disabled{color:var(--dsw-alias-label-dimmed);cursor:default}.tMJkdG_triggerIcon{flex:none;display:inline-flex}.tMJkdG_triggerIcon svg{width:14px;height:14px}.tMJkdG_triggerLabel{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}.tMJkdG_chevron{color:var(--dsw-alias-label-caption);flex:none;transition:transform .12s;display:inline-flex}@container (width<=460px){.tMJkdG_trigger:has(.tMJkdG_triggerIcon) .tMJkdG_triggerLabel{display:none}}.tMJkdG_chevronOpen{transform:rotate(180deg)}";
		...
		var PermissionSelect_module_css_default = {
			"triggerIcon": "tMJkdG_triggerIcon",
			"chevron": "tMJkdG_chevron",
			"triggerLabel": "tMJkdG_triggerLabel",
			"trigger": "tMJkdG_trigger",
			"chevronOpen": "tMJkdG_chevronOpen"
		};
		//#endregion
		...
		*/
		...
		function PermissionSelect({ value, locked, command, t }) {
			...
			return (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [(0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Menu, {
				...
				anchor: (0, react_jsx_runtime.jsxs)("button", {
					...
					children: [
						(0, react_jsx_runtime.jsx)("span", {
							className: PermissionSelect_module_css_default.triggerIcon + (currentValue === FULL_ACCESS ? " dshPermissionFullAccess" : ""),
							style: currentValue === FULL_ACCESS ? { color: "#f97316" } : void 0,
							"aria-hidden": true,
		...
		var InputBar_module_css_default = {
			"attachments": "Uzx--a_attachments",
			"input": "Uzx--a_input",
			"modes": "Uzx--a_modes",
			"trailing": "Uzx--a_trailing",
			"backdrop": "Uzx--a_backdrop",
			"row": "Uzx--a_row",
			"retry": "Uzx--a_retry",
			"accessory": "Uzx--a_accessory",
			"select": "Uzx--a_select",
			"card": "Uzx--a_card",
			"root": "Uzx--a_root",
			"noticeError": "Uzx--a_noticeError",
			"scroll": "Uzx--a_scroll",
			"mirror": "Uzx--a_mirror",
			"chipLabel": "Uzx--a_chipLabel",
			"hero": "Uzx--a_hero",
			"cardWorkspaceTrigger": "Uzx--a_cardWorkspaceTrigger",
			"overlayAnchor": "Uzx--a_overlayAnchor",
			"pending": "Uzx--a_pending",
			"chip": "Uzx--a_chip",
			"chipInvalid": "Uzx--a_chipInvalid",
			"hint": "Uzx--a_hint",
			"primary": "Uzx--a_primary",
			"tools": "Uzx--a_tools",
			"textRef": "Uzx--a_textRef",
			"input-pending": "Uzx--a_input-pending",
			"hlToken": "Uzx--a_hlToken",
			"add": "Uzx--a_add",
			"grow": "Uzx--a_grow",
			"notice": "Uzx--a_notice",
			"hlSegment": "Uzx--a_hlSegment"
		};
		//#endregion
		...
		* (running/removed/promptError) are self-selected via useSession. */
		...
		function continueNumberedDraft(text, start, end = start) {
		...
		function InputBar({ useSession, useInput, inputActions, keyboard, addImages, removeImage, draftImages, resolveSubmitMode, toggleCommandMenu, toggleReferenceMenu, stop, command, t, renderSlot, useNotices, useLexicon, useMenuLauncher, useProjection, sessionId, variant, disabled: inert = false, blocked, workspacePickerOpen = false, onRequestWorkspace, placeholder, accessory, overlay, leftItems, rightItems, footer }) {
			...
			const onKeyDown = (e) => {
				...
				if (accelerated) {
					const el = e.currentTarget, start = el.selectionStart ?? draft.length, end = el.selectionEnd ?? start;
					const continued = continueNumberedDraft(draft, start, end);
					if (continued) {
						keyboard.setDraft(continued.text, { start, end, insertedLength: continued.insertedLength });
						keyboard.track(continued.text, continued.caret);
						restoreCaret(el, continued.caret);
						return;
					}
				}
		...
		//#endregion
		//#region \0dsh-css:D:\HermesTemp\deepseek-harness\packages\client\ui-conversation\src\client\settings\EnterBehaviorRow.module.css.mjs
		const css$16 = ".Q3C_SG_row{border-bottom:1px solid var(--dsw-alias-border-l2);align-items:center;gap:8px;padding:16px 0;display:flex}.Q3C_SG_rowText{flex-direction:column;flex:1;gap:4px;min-width:0;padding-right:48px;display:flex}.Q3C_SG_title{color:var(--dsw-alias-label-primary);font-size:14px;font-weight:400;line-height:22px}.Q3C_SG_desc{color:var(--dsw-alias-label-tertiary);font-size:12px;font-weight:400;line-height:18px}.Q3C_SG_selector{background:var(--dsw-alias-bg-module-platform);height:36px;font:inherit;color:var(--dsw-alias-label-primary);cursor:pointer;border:none;border-radius:18px;align-items:center;gap:12px;padding:0 14px;font-size:14px;line-height:22px;display:inline-flex}.Q3C_SG_selector:hover{background:var(--dsw-alias-interactive-bg-hover)}.Q3C_SG_chevron{flex:none}";
		...
		var EnterBehaviorRow_module_css_default = {
			"title": "Q3C_SG_title",
			"rowText": "Q3C_SG_rowText",
			"row": "Q3C_SG_row",
			"chevron": "Q3C_SG_chevron",
			"desc": "Q3C_SG_desc",
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\HermesTemp\deepseek-harness\packages\client\ui-conversation\src\client\chat\MessageItem.module.css.mjs
		const css$15 = ".iEd2kG_userRow{flex-direction:column;align-items:flex-end;gap:6px;display:flex}.iEd2kG_userStack{flex-direction:column;align-items:flex-end;gap:8px;min-width:0;max-width:min(525px,82%);display:flex}.iEd2kG_bubble{background:var(--dsw-specific-bubble);max-width:100%;color:var(--dsw-alias-label-primary);border-radius:22px;padding:10px 16px;font-size:16px;line-height:24px}.iEd2kG_contextRow,.iEd2kG_compactionRow{padding:2px 0}.iEd2kG_compactionButton{width:100%;min-width:0;height:24px;color:inherit;font:inherit;text-align:left;background:0 0;border:none;border-radius:6px;align-items:center;padding:0;display:flex}.iEd2kG_compactionButton:not(:disabled){cursor:pointer}.iEd2kG_compactionButton:not(:disabled):hover{background:var(--dsw-alias-interactive-bg-hover)}.iEd2kG_compactionLeading{width:16px;height:16px;color:var(--dsw-alias-label-secondary);flex:none;place-items:center;margin-right:6px;display:inline-grid}.iEd2kG_compactionContextIcon,.iEd2kG_compactionDisclosureIcon{grid-area:1/1;justify-content:center;align-items:center;display:inline-flex}.iEd2kG_compactionDisclosureIcon,.iEd2kG_compactionButton:not(:disabled):hover .iEd2kG_compactionContextIcon,.iEd2kG_compactionButton:not(:disabled):focus-visible .iEd2kG_compactionContextIcon{opacity:0}.iEd2kG_compactionButton:not(:disabled):hover .iEd2kG_compactionDisclosureIcon,.iEd2kG_compactionButton:not(:disabled):focus-visible .iEd2kG_compactionDisclosureIcon{opacity:1}.iEd2kG_compactionTitle{color:var(--dsw-alias-label-primary-dimmed);flex:none;font-size:14px;line-height:24px}.iEd2kG_compactionSep{background:var(--dsw-alias-label-caption);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}.iEd2kG_compactionSummary{min-width:0;color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;flex:auto;font-size:14px;line-height:24px;overflow:hidden}.iEd2kG_compactionBody{color:var(--dsw-alias-label-tertiary);padding:4px 0 4px 22px;font-size:14px;line-height:24px}.iEd2kG_retryRow{color:var(--dsw-alias-label-tertiary);font-size:13px;line-height:20px}.iEd2kG_retrySummary{width:fit-content;color:inherit;cursor:pointer;user-select:none;border-radius:3px;align-items:center;gap:7px;padding:2px 0;list-style:none;display:inline-flex}.iEd2kG_retrySummary::-webkit-details-marker{display:none}.iEd2kG_retrySummary:after{content:\"\";opacity:.8;border-bottom:1.5px solid;border-right:1.5px solid;width:6px;height:6px;transition:transform .12s;transform:rotate(-45deg)}.iEd2kG_retrySummary:hover{color:var(--dsw-alias-label-secondary)}.iEd2kG_retrySummary:focus-visible{outline:1.5px solid var(--dsw-alias-button-info-fill);outline-offset:2px}.iEd2kG_retryText{color:inherit}.iEd2kG_retryRow[data-active] .iEd2kG_retryText{background:linear-gradient(90deg, var(--dsw-alias-label-tertiary) 0%, var(--dsw-alias-label-tertiary) 40%, var(--dsw-alias-label-secondary) 50%, var(--dsw-alias-label-tertiary) 60%, var(--dsw-alias-label-tertiary) 100%);color:#0000;background-position:100%;background-size:200% 100%;background-clip:text;animation:1.6s ease-in-out infinite iEd2kG_retry-shimmer}.iEd2kG_retryRow[open] .iEd2kG_retrySummary:after{transform:rotate(45deg)}.iEd2kG_retryDetails{overflow-wrap:anywhere;gap:2px;margin-top:3px;padding-left:14px;font-size:12px;line-height:18px;display:grid}.iEd2kG_retryDetailLabel{color:var(--dsw-alias-label-secondary)}.iEd2kG_turnErrorRow{grid-template-columns:10px minmax(0,1fr) auto;align-items:start;gap:8px;padding:2px 0;font-size:13px;line-height:20px;display:grid}.iEd2kG_turnErrorDot{margin-top:5px}.iEd2kG_turnErrorCopy{overflow-wrap:anywhere;min-width:0}.iEd2kG_turnErrorTitle{color:var(--dsw-alias-state-error-primary);margin-right:6px;font-weight:600}.iEd2kG_turnErrorMessage{color:var(--dsw-alias-label-secondary)}.iEd2kG_turnErrorCode{color:var(--dsw-alias-label-tertiary);font:var(--dsw-font-markdown-code-block-small)}.iEd2kG_maxTokensTitle{color:var(--dsw-alias-state-warn-primary);margin-right:6px;font-weight:600}@keyframes iEd2kG_retry-shimmer{0%{background-position:100%}to{background-position:0}}@media (prefers-reduced-motion:reduce){.iEd2kG_retryRow[data-active] .iEd2kG_retryText{color:inherit;background:0 0;animation:none}}.iEd2kG_refChip{color:var(--dsw-alias-label-primary);white-space:nowrap;vertical-align:baseline;background:#6187d838;border-radius:6px;margin:0 2px;padding:0 8px;font-size:.85em;line-height:1.6;display:inline-block}";
		...
		var MessageItem_module_css_default = {
			"refChip": "iEd2kG_refChip",
			"contextRow": "iEd2kG_contextRow",
			"userStack": "iEd2kG_userStack",
			"compactionButton": "iEd2kG_compactionButton",
			"compactionDisclosureIcon": "iEd2kG_compactionDisclosureIcon",
			"retryText": "iEd2kG_retryText",
			"retry-shimmer": "iEd2kG_retry-shimmer",
			"turnErrorMessage": "iEd2kG_turnErrorMessage",
			"retryRow": "iEd2kG_retryRow",
			"turnErrorCode": "iEd2kG_turnErrorCode",
			"bubble": "iEd2kG_bubble",
			"compactionLeading": "iEd2kG_compactionLeading",
			"maxTokensTitle": "iEd2kG_maxTokensTitle",
			"compactionTitle": "iEd2kG_compactionTitle",
			"compactionContextIcon": "iEd2kG_compactionContextIcon",
			"retryDetailLabel": "iEd2kG_retryDetailLabel",
			"compactionSep": "iEd2kG_compactionSep",
			"compactionRow": "iEd2kG_compactionRow",
			"turnErrorTitle": "iEd2kG_turnErrorTitle",
			"compactionSummary": "iEd2kG_compactionSummary",
			"turnErrorCopy": "iEd2kG_turnErrorCopy",
			"retryDetails": "iEd2kG_retryDetails",
			"userRow": "iEd2kG_userRow",
			"compactionBody": "iEd2kG_compactionBody",
			"turnErrorDot": "iEd2kG_turnErrorDot",
			"turnErrorRow": "iEd2kG_turnErrorRow",
			"retrySummary": "iEd2kG_retrySummary"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\HermesTemp\deepseek-harness\packages\client\ui-conversation\src\client\chat\ContextBody.module.css.mjs
		const css$14 = "._6kQnla_text{color:var(--dsw-alias-label-secondary);font:inherit;white-space:pre-wrap;overflow-wrap:anywhere;margin:0}._6kQnla_fields{border-top:1px solid var(--dsw-alias-line-secondary);flex-direction:column;gap:2px;margin:8px 0 0;padding-top:8px;display:flex}._6kQnla_field{gap:8px;min-width:0;display:flex}._6kQnla_fieldKey{min-width:96px;color:var(--dsw-alias-label-caption);flex:none}._6kQnla_fieldValue{min-width:0;color:var(--dsw-alias-label-tertiary);overflow-wrap:anywhere;flex:auto;margin:0}._6kQnla_files{flex-wrap:wrap;gap:4px 12px;margin:0 0 8px;padding:0;list-style:none;display:flex}._6kQnla_file{align-items:baseline;gap:6px;min-width:0;display:flex}._6kQnla_filePath{color:var(--dsw-alias-label-secondary);overflow-wrap:anywhere}._6kQnla_fileAction{color:var(--dsw-alias-label-caption)}._6kQnla_catalogNotice{color:var(--dsw-alias-label-caption);margin:0 0 6px}._6kQnla_entries{flex-direction:column;gap:4px;margin:0;padding:0;list-style:none;display:flex}._6kQnla_entry{gap:8px;min-width:0;display:flex}._6kQnla_entryName{color:var(--dsw-alias-label-secondary);flex:none}._6kQnla_entryDescription{min-width:0;color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;flex:auto;overflow:hidden}._6kQnla_sections{flex-direction:column;gap:8px;margin:0;display:flex}._6kQnla_section{flex-direction:column;gap:2px;min-width:0;display:flex}._6kQnla_sectionName{color:var(--dsw-alias-label-caption)}._6kQnla_sectionText{color:var(--dsw-alias-label-secondary);white-space:pre-wrap;overflow-wrap:anywhere;margin:0}._6kQnla_relaySender{color:var(--dsw-alias-label-caption);overflow-wrap:anywhere;margin:0 0 6px}._6kQnla_recalls{flex-direction:column;gap:2px;margin:0 0 8px;padding:0;list-style:none;display:flex}._6kQnla_recall{gap:8px;min-width:0;display:flex}._6kQnla_recallLabel{color:var(--dsw-alias-label-secondary);overflow-wrap:anywhere}._6kQnla_recallCounts{color:var(--dsw-alias-label-caption);flex:none}";
		...
		var ContextBody_module_css_default = {
			"files": "_6kQnla_files",
			"entry": "_6kQnla_entry",
			"section": "_6kQnla_section",
			"field": "_6kQnla_field",
			"entries": "_6kQnla_entries",
			"sections": "_6kQnla_sections",
			"sectionText": "_6kQnla_sectionText",
			"file": "_6kQnla_file",
			"recalls": "_6kQnla_recalls",
			"text": "_6kQnla_text",
			"fields": "_6kQnla_fields",
			"fieldKey": "_6kQnla_fieldKey",
			"filePath": "_6kQnla_filePath",
			"catalogNotice": "_6kQnla_catalogNotice",
			"entryDescription": "_6kQnla_entryDescription",
			"sectionName": "_6kQnla_sectionName",
			"relaySender": "_6kQnla_relaySender",
			"fieldValue": "_6kQnla_fieldValue",
			"entryName": "_6kQnla_entryName",
			"fileAction": "_6kQnla_fileAction",
			"recall": "_6kQnla_recall",
			"recallLabel": "_6kQnla_recallLabel",
			"recallCounts": "_6kQnla_recallCounts"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\HermesTemp\deepseek-harness\packages\client\ui-conversation\src\client\chat\ContextInjectionRow.module.css.mjs
		const css$13 = ".Irjj4G_root{min-width:0}.Irjj4G_root[data-open]{padding-bottom:4px}.Irjj4G_chevron{color:var(--dsw-alias-label-secondary)}.Irjj4G_sep{background:var(--dsw-alias-label-caption);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}.Irjj4G_source{min-width:0;color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;flex:none;font-size:14px;line-height:24px;overflow:hidden}.Irjj4G_summary{min-width:0;color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;flex:auto;font-size:14px;line-height:24px;overflow:hidden}.Irjj4G_body{box-sizing:border-box;background:var(--dsw-alias-markdown-code-block);width:calc(100% - 22px);max-height:141px;color:var(--dsw-alias-label-tertiary);font:400 11px/16px var(--ds-font-family-code);border:none;border-radius:8px;margin:4px 0 0 22px;padding:10px 16px 12px 12px;overflow:auto}";
		...
		var ContextInjectionRow_module_css_default = {
			"source": "Irjj4G_source",
			"summary": "Irjj4G_summary",
			"chevron": "Irjj4G_chevron",
			"root": "Irjj4G_root",
			"sep": "Irjj4G_sep",
			"body": "Irjj4G_body"
		};
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\HermesTemp\deepseek-harness\packages\client\ui-conversation\src\client\chat\MessageIconActions.module.css.mjs
		const css$12 = ".fnCloG_actions{align-items:center;gap:10px;height:28px;display:flex}.fnCloG_timeStart{color:var(--dsw-alias-label-tertiary);white-space:nowrap;padding-right:12px;font-size:14px;line-height:24px}.fnCloG_timeEnd{color:var(--dsw-alias-label-tertiary);white-space:nowrap;padding-left:12px;font-size:14px;line-height:24px}.fnCloG_runTimeDot{margin:0 10px}@media (hover:hover){[data-time-hover-root] :is(.fnCloG_timeStart,.fnCloG_timeEnd){opacity:0;transition:opacity 80ms}[data-time-hover-root]:hover :is(.fnCloG_timeStart,.fnCloG_timeEnd),[data-time-hover-root]:focus-within :is(.fnCloG_timeStart,.fnCloG_timeEnd){opacity:1}}.fnCloG_action{width:28px;height:28px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;border-radius:28px;justify-content:center;align-items:center;padding:6px;display:inline-flex}.fnCloG_action:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-secondary)}.fnCloG_action[data-unavailable]{cursor:default;opacity:.4}.fnCloG_action[data-unavailable]:hover{color:var(--dsw-alias-label-tertiary);background:0 0}.fnCloG_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}";
		...
		var MessageIconActions_module_css_default = {
			"timeStart": "fnCloG_timeStart",
			"actions": "fnCloG_actions",
			"timeEnd": "fnCloG_timeEnd",
			"runTimeDot": "fnCloG_runTimeDot",
			"action": "fnCloG_action",
			"visuallyHidden": "fnCloG_visuallyHidden"
		};
		//#endregion
		...
		*/
		...
		var ChatView_module_css_default = {
			...
			"dsh-turn-status-shimmer": "R15qIq_dsh-turn-status-shimmer",
			"hint": "R15qIq_hint",
			"openError": "R15qIq_openError",
			"toBottomSlot": "R15qIq_toBottomSlot",
			"older": "R15qIq_older",
			"root": "R15qIq_root",
			"turnStatusClock": "R15qIq_turnStatusClock",
			"turnStatus": "R15qIq_turnStatus",
			"toBottom": "R15qIq_toBottom",
			"callRow": "R15qIq_callRow"
		};
		//#endregion
		...
		function GeneratedImageCard({attachment,loadImage,sessionId,onEditSubmitted,t}) {
			...
			react.useEffect(()=>{if(typeof IntersectionObserver==="undefined")return;const observer=new IntersectionObserver(entries=>setNearby(entries.some(entry=>entry.isIntersecting)),{rootMargin:"500px"});if(element.current)observer.observe(element.current);return()=>observer.disconnect()},[]);
			react.useEffect(()=>{alive.current=true;return()=>{alive.current=false}},[]);
			react.useEffect(()=>{let active=true,lease;setUrl("");setError("");if(!nearby&&!preview)return;const pending=loadImage.acquire?loadImage.acquire(attachment):Promise.resolve(loadImage(attachment)).then(url=>({url,release:()=>{}}));pending.then(value=>{lease=value;if(active)setUrl(value.url);else value.release()},error=>{if(active)setError(String(error.message||error))});return()=>{active=false;pending.release?.();lease?.release()}},[attachment.attachmentId,loadImage,nearby||preview]);
			const submit=async()=>{if(sending||!instruction.trim())return;setSending(true);setError("");requestId.current??=globalThis.crypto?.randomUUID?.()??`image-edit-${Date.now()}`;
		...
		const ChatNodeSeat = (0, react.memo)(function ChatNodeSeat({ nodeKey, sessionId, onEditSubmitted, selectedCallId, cwd, openFile, inspectCall, forkAt, loadImage, fileMentions, useSession, renderSlot, t }) {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\HermesTemp\deepseek-harness\packages\client\ui-conversation\src\client\skeleton\ApprovalPanel.module.css.mjs
		const css$10 = "._l4_0G_root{padding:8px calc(var(--dsh-composer-side-clearance) + 16px) 12px;flex-direction:column;align-items:center;display:flex}._l4_0G_card{width:100%;max-width:var(--dsh-chat-content-width);border:1px solid var(--dsw-alias-state-warn-secondary);background:var(--dsw-specific-input-major);box-shadow:var(--dsw-shadow-lv2);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border-radius:20px;overflow:hidden}._l4_0G_strip{background:var(--dsw-alias-state-warn-tertiary);color:var(--dsw-alias-state-warn-primary);align-items:center;gap:8px;padding:10px 16px;font-size:13px;line-height:18px;display:flex}._l4_0G_dot{background:var(--dsw-alias-state-warn-primary);border-radius:50%;width:8px;height:8px}._l4_0G_body{box-sizing:border-box;max-height:var(--dsh-composer-text-max-height);flex-direction:column;gap:6px;padding:12px 16px 0;display:flex;overflow-y:auto}._l4_0G_headline{color:var(--dsw-alias-label-primary);font-size:15px;font-weight:500;line-height:24px}._l4_0G_command{color:var(--dsw-alias-label-tertiary);font-family:var(--ds-font-family-code);word-break:break-all;font-size:13px;line-height:20px}._l4_0G_actionRow{justify-content:flex-end;gap:8px;padding:14px 16px;display:flex}._l4_0G_reject:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover-danger);color:var(--dsw-alias-state-error-primary);border-color:#0000}";
		...
		var ApprovalPanel_module_css_default = {
			...
			"card": "_l4_0G_card",
			"strip": "_l4_0G_strip",
			"actionRow": "_l4_0G_actionRow",
			"reject": "_l4_0G_reject",
			"dot": "_l4_0G_dot",
			"root": "_l4_0G_root",
			"headline": "_l4_0G_headline",
			"command": "_l4_0G_command"
		};
		//#endregion
		...
		*/
		...
		var TodoPanel_module_css_default = {
			"header": "qbgx4a_header",
			"glyphCompleted": "qbgx4a_glyphCompleted",
			"chevron": "qbgx4a_chevron",
			"progress": "qbgx4a_progress",
			"item": "qbgx4a_item",
			"lead": "qbgx4a_lead",
			"glyphPending": "qbgx4a_glyphPending",
			"title": "qbgx4a_title",
			"body": "qbgx4a_body",
			"glyph": "qbgx4a_glyph",
			"list": "qbgx4a_list",
			"content": "qbgx4a_content",
			"root": "qbgx4a_root",
			"glyphProgress": "qbgx4a_glyphProgress",
			"todo-progress-spin": "qbgx4a_todo-progress-spin"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\HermesTemp\deepseek-harness\packages\client\ui-conversation\src\client\queue\QueueDock.module.css.mjs
		const css$8 = ".i2BQ_a_dock{box-sizing:border-box;width:calc(100% - var(--dsh-composer-side-clearance) - var(--dsh-composer-side-clearance) - var(--dsh-composer-dock-inset) - var(--dsh-composer-dock-inset));max-width:calc(var(--dsh-composer-card-max-width) - var(--dsh-composer-dock-inset) - var(--dsh-composer-dock-inset));margin:0 auto calc(0px - var(--dsh-composer-stack-gap) - 3px);padding:0 var(--dsh-composer-dock-inset);flex:none}.i2BQ_a_panel{background:var(--dsw-specific-tip);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border-radius:12px 12px 0 0;width:100%;padding:2px 0;position:relative;overflow:hidden}.i2BQ_a_panel:after{border:1px solid var(--dsw-alias-border-l1);border-radius:inherit;content:\"\";pointer-events:none;border-bottom:none;position:absolute;inset:0}.i2BQ_a_header{box-sizing:border-box;width:100%;height:36px;color:var(--dsw-alias-label-primary);text-align:left;cursor:pointer;background:0 0;border:none;border-radius:8px;align-items:center;gap:10px;padding:4px 12px;display:flex}.i2BQ_a_header:focus-visible{outline:2px solid var(--dsw-alias-label-tertiary);outline-offset:-2px}.i2BQ_a_header:disabled{cursor:default}.i2BQ_a_lead{color:var(--dsw-alias-label-tertiary);flex:none;place-items:center;display:grid}.i2BQ_a_count{min-width:0;font-family:Inter, var(--dsw-font-family);flex:auto;font-size:13px;font-weight:500;line-height:24px}.i2BQ_a_chevron{width:14px;height:14px;color:var(--dsw-alias-label-tertiary);flex:none;place-items:center;display:grid}.i2BQ_a_list{max-height:180px;margin:0;padding:0;list-style:none;overflow-y:auto}.i2BQ_a_row{box-sizing:border-box;border-radius:8px;align-items:center;gap:10px;width:100%;height:36px;padding:4px 5px 4px 12px;display:flex}.i2BQ_a_row+.i2BQ_a_row{box-shadow:inset 0 1px 0 var(--dsw-alias-border-l1)}.i2BQ_a_preview,.i2BQ_a_editor{min-width:0;font:var(--dsw-font-xs-13);font-family:Inter, var(--dsw-font-family);flex:auto}.i2BQ_a_preview{color:var(--dsw-alias-label-primary-dimmed);text-overflow:ellipsis;white-space:nowrap;word-break:break-word;overflow:hidden}.i2BQ_a_editor{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);height:28px;color:var(--dsw-alias-label-primary);border-radius:6px;outline:none;padding:0 8px}.i2BQ_a_editor:focus{border-color:var(--dsw-alias-state-business-primary)}.i2BQ_a_actions{flex:none;align-items:center;gap:10px;display:flex}.i2BQ_a_action{width:28px;height:28px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;border-radius:999px;flex:none;place-items:center;padding:0;display:grid}.i2BQ_a_action:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}.i2BQ_a_action:focus-visible{outline:2px solid var(--dsw-alias-label-tertiary);outline-offset:-2px}.i2BQ_a_action:disabled{cursor:default;opacity:.45}";
		...
		var QueueDock_module_css_default = {
			"actions": "i2BQ_a_actions",
			"lead": "i2BQ_a_lead",
			"dock": "i2BQ_a_dock",
			"list": "i2BQ_a_list",
			"preview": "i2BQ_a_preview",
			"action": "i2BQ_a_action",
			"count": "i2BQ_a_count",
			"editor": "i2BQ_a_editor",
			"header": "i2BQ_a_header",
			"chevron": "i2BQ_a_chevron",
			"row": "i2BQ_a_row",
			"panel": "i2BQ_a_panel"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\HermesTemp\deepseek-harness\packages\client\ui-conversation\src\client\skeleton\HeroShell.module.css.mjs
		const css$7 = "._7HN4pG_root{justify-content:center;align-items:center;min-width:0;height:100%;padding:0 24px;display:flex}._7HN4pG_stack{width:100%;max-width:var(--dsh-composer-card-max-width);flex-direction:column;align-items:stretch;gap:12px;display:flex;overflow:visible}._7HN4pG_headline{color:var(--dsw-alias-label-primary);grid-template-columns:34px auto auto;justify-content:center;align-items:center;column-gap:10px;font-size:26px;font-weight:500;line-height:32px;display:grid}._7HN4pG_headlineText{grid-area:1/2}._7HN4pG_previewBadge{border:1px solid var(--dsw-alias-interactive-bg-hover);background:var(--dsw-alias-state-business-tertiary);color:var(--dsw-alias-label-primary-bluish);font-family:var(--ds-font-family-code);white-space:nowrap;border-radius:24px;grid-area:1/3;align-self:start;margin-top:2px;margin-left:-3px;padding:1px 7px 0;font-size:12px;font-weight:500;line-height:18px}._7HN4pG_fishHitbox{grid-area:1/1;justify-content:center;align-items:center;display:inline-flex}._7HN4pG_fish{color:var(--dsw-alias-label-primary);transform-origin:50% 60%}@keyframes _7HN4pG_hero-fish-swim{0%,to{transform:translate(0)rotate(0)}35%{transform:translate(-1px,-1px)rotate(-5deg)}70%{transform:translate(1px)rotate(3deg)}}@media (hover:hover) and (prefers-reduced-motion:no-preference){._7HN4pG_fishHitbox:hover ._7HN4pG_fish{animation:_7HN4pG_hero-fish-swim var(--ds-transition-duration-slow) var(--ds-ease-in-out)}}._7HN4pG_body{flex-direction:column;gap:12px;min-width:0;display:flex;position:relative;overflow:visible}._7HN4pG_body>*{z-index:1;position:relative}._7HN4pG_body>._7HN4pG_workspaceRow{z-index:10;align-items:center;min-width:0;padding-left:8px;display:flex}._7HN4pG_workspace{max-width:min(100%,360px);min-height:28px;color:var(--dsw-alias-label-primary);cursor:pointer;background:0 0;border:none;border-radius:16px;align-items:center;gap:4px;padding:0 8px;font-size:13px;font-weight:500;line-height:20px;display:inline-flex}._7HN4pG_workspace:not(:disabled):hover,._7HN4pG_workspace[aria-expanded=true]{background:var(--dsw-alias-interactive-bg-hover)}._7HN4pG_workspace:disabled{cursor:default}._7HN4pG_folder{color:var(--dsw-alias-label-primary);flex:none}._7HN4pG_workspaceLabel{text-overflow:ellipsis;white-space:nowrap;overflow:hidden}._7HN4pG_chevron{color:var(--dsw-alias-label-caption);flex:none}._7HN4pG_modalInput{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);width:100%;height:44px;color:var(--dsw-alias-label-primary);background:0 0;border-radius:22px;outline:none;padding:7px 14px;font-size:14px;font-weight:400;line-height:22px}._7HN4pG_modalInput::placeholder{color:var(--dsw-alias-label-caption)}._7HN4pG_modalInput:disabled{color:var(--dsw-alias-label-dimmed)}._7HN4pG_modalAction{min-width:72px}._7HN4pG_modalError{color:var(--dsw-alias-state-error-primary);margin-top:8px;font-size:12px;line-height:18px}";
		...
		var HeroShell_module_css_default = {
			"headlineText": "_7HN4pG_headlineText",
			"chevron": "_7HN4pG_chevron",
			"body": "_7HN4pG_body",
			"workspaceLabel": "_7HN4pG_workspaceLabel",
			"headline": "_7HN4pG_headline",
			"stack": "_7HN4pG_stack",
			"modalError": "_7HN4pG_modalError",
			"fish": "_7HN4pG_fish",
			"workspace": "_7HN4pG_workspace",
			"hero-fish-swim": "_7HN4pG_hero-fish-swim",
			"modalAction": "_7HN4pG_modalAction",
			"fishHitbox": "_7HN4pG_fishHitbox",
			"root": "_7HN4pG_root",
			"workspaceRow": "_7HN4pG_workspaceRow",
			"previewBadge": "_7HN4pG_previewBadge",
			"folder": "_7HN4pG_folder",
			"modalInput": "_7HN4pG_modalInput"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\HermesTemp\deepseek-harness\packages\client\ui-conversation\src\client\skeleton\ConversationRoot.module.css.mjs
		const css$6 = ".c9AePG_root{background:var(--dsw-alias-bg-base);--dsh-chat-content-width:var(--dsh-chat-user-width,clamp(680px,calc(var(--dsh-conversation-column-width,0px) * .64),920px));--dsh-composer-card-max-width:calc(var(--dsh-chat-content-width) + 32px);--dsh-composer-side-clearance:16px;--dsh-composer-dock-inset:8px;flex-direction:column;min-width:0;height:100%;display:flex;position:relative}.c9AePG_widthHandle{z-index:4;cursor:col-resize;touch-action:none;background:transparent;border:0;box-shadow:none;outline:0;width:18px;height:64px;padding:0;position:absolute;top:calc(50% - 32px);bottom:auto}.c9AePG_widthHandle[data-width-handle=left]{left:max(0px,calc(50% - var(--dsh-chat-content-width) / 2 - 22px))}.c9AePG_widthHandle[data-width-handle=right]{right:max(0px,calc(50% - var(--dsh-chat-content-width) / 2 - 22px))}.c9AePG_widthHandle:before{display:none}.c9AePG_widthHandle:after{content:\"\";opacity:0;background:var(--dsw-alias-label-tertiary);border-radius:2px;width:3px;height:28px;position:absolute;top:18px;left:7px;transition:opacity .15s}.c9AePG_widthHandle:hover:after{opacity:.6;transition-delay:.4s}.c9AePG_widthHandle:focus-visible:after,.c9AePG_widthHandle[data-dragging=true]:after{opacity:1;transition-delay:0;background:var(--dsw-alias-brand-primary)}.c9AePG_header{border-bottom:1px solid #0000;flex:none;padding:12px 28px 0 20px;position:relative}.c9AePG_header:after{content:\"\";z-index:0;background:var(--dsw-alias-border-l2);pointer-events:none;height:1px;position:absolute;bottom:1px;left:0;right:0}.c9AePG_headerHidden{display:none}.c9AePG_titleRow{align-items:center;gap:0;min-height:32px;display:flex}.c9AePG_titleCluster{flex:1;align-items:center;gap:10px;min-width:0;display:flex}.c9AePG_crumbs{white-space:nowrap;align-items:center;gap:4px;min-width:0;display:flex;overflow:hidden}.c9AePG_crumbSeg{align-items:center;gap:4px;min-width:0;display:inline-flex}.c9AePG_crumbSep{color:var(--dsw-alias-label-caption);font-size:14px;line-height:20px}.c9AePG_crumb{max-width:220px;color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;cursor:pointer;background:0 0;border:none;border-radius:12px;padding:4px 8px;font-size:14px;line-height:20px;overflow:hidden}.c9AePG_crumb:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}.c9AePG_crumbCurrent{color:var(--dsw-alias-label-primary);cursor:default;font-weight:500}.c9AePG_headerActions{flex:none;align-items:center;gap:8px;display:flex}.c9AePG_headerUtilities{flex:none;align-items:center;gap:8px;margin-left:20px;display:flex}.c9AePG_headerUtilities:empty{display:none}.c9AePG_tabs{z-index:1;gap:36px;margin-top:4px;padding-left:8px;display:flex;position:relative}.c9AePG_tab{color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;padding:0 0 11px;font-size:13px;font-weight:500;line-height:16px;position:relative}.c9AePG_tab:after{content:\"\";background:0 0;border-radius:2px;height:2px;position:absolute;bottom:1px;left:0;right:0}.c9AePG_tabActive{color:var(--dsw-alias-state-business-primary)}.c9AePG_tabActive:after{background:var(--dsw-alias-state-business-primary)}.c9AePG_viewArea{flex-direction:column;flex:1;min-height:0;display:flex}.c9AePG_composerStack{--dsh-composer-stack-gap:6px;gap:var(--dsh-composer-stack-gap);flex-direction:column;display:flex}.c9AePG_composerSeat{--dsh-composer-text-max-height:336px;flex-direction:column;flex:none;display:flex}.c9AePG_root[data-phase=active]{overflow:hidden}.c9AePG_root[data-phase=active] .c9AePG_header{flex:none}.c9AePG_scrollBody{scrollbar-gutter:stable;flex-direction:column;flex:1;min-height:0;display:flex;overflow:hidden auto}.c9AePG_root[data-phase=active] .c9AePG_viewArea{flex:1 0 auto;min-height:auto}.c9AePG_root[data-phase=active] .c9AePG_composerSeat{z-index:7;background:linear-gradient(180deg, color-mix(in srgb, var(--dsw-alias-bg-base) 0%, transparent) 0px, var(--dsw-alias-bg-base) 36px);position:sticky;bottom:0}.c9AePG_scrollBody:has([data-conversation-composer-overlay]){scrollbar-gutter:auto;position:relative;overflow:hidden auto}.c9AePG_scrollBody:has([data-conversation-composer-overlay])>[data-slot=conversation\\.session]>.c9AePG_viewArea{flex:1 1 0;min-height:0;overflow:hidden}.c9AePG_scrollBody:has([data-conversation-composer-overlay])>.c9AePG_composerSeat{right:var(--dsh-scrollbar-width);position:absolute;bottom:0;left:0}.c9AePG_composerHero{width:min(calc(var(--dsh-composer-card-max-width) + 2 * var(--dsh-composer-side-clearance)), 100%);z-index:1;align-self:center;gap:8px;padding-bottom:32px;position:relative}.c9AePG_heroGlow{z-index:-1;aspect-ratio:1051/468;pointer-events:none;width:135.438%;position:absolute;bottom:92px;left:50%;transform:translate(-50%,50%)}.c9AePG_heroWorkspaceRow{align-items:center;gap:2px;min-width:0;margin-top:4px;padding-left:20px;display:flex}.c9AePG_root[data-phase=hero] .c9AePG_scrollBody{justify-content:center;overflow-y:auto}.c9AePG_root[data-phase=settling] .c9AePG_composerSeat{visibility:hidden}";
		...
		var ConversationRoot_module_css_default = {
			"titleRow": "c9AePG_titleRow",
			"composerStack": "c9AePG_composerStack",
			"heroGlow": "c9AePG_heroGlow",
			"header": "c9AePG_header",
			"headerHidden": "c9AePG_headerHidden",
			"heroWorkspaceRow": "c9AePG_heroWorkspaceRow",
			"scrollBody": "c9AePG_scrollBody",
			"crumbSeg": "c9AePG_crumbSeg",
			"headerActions": "c9AePG_headerActions",
			"crumbSep": "c9AePG_crumbSep",
			"crumbs": "c9AePG_crumbs",
			"viewArea": "c9AePG_viewArea",
			"tab": "c9AePG_tab",
			"headerUtilities": "c9AePG_headerUtilities",
			"tabActive": "c9AePG_tabActive",
			"composerHero": "c9AePG_composerHero",
			"root": "c9AePG_root",
			"crumb": "c9AePG_crumb",
			"crumbCurrent": "c9AePG_crumbCurrent",
			"composerSeat": "c9AePG_composerSeat",
			"tabs": "c9AePG_tabs",
			"titleCluster": "c9AePG_titleCluster",
			"widthHandle": "c9AePG_widthHandle"
		};
		//#endregion
		...
		function WidthHandle({ side, rootRef, onWidth, onCommit }) {
            const cleanup = react.useRef(null), callbacks = react.useRef({onWidth,onCommit});
            callbacks.current={onWidth,onCommit};
            const [dragging,setDragging]=react.useState(false);
            react.useEffect(()=>()=>cleanup.current?.(),[]);
            const start = event => {
                if(event.button!==0 || !rootRef.current || cleanup.current)return;
                event.preventDefault();
                let frame=0,last=null;
                const flush=()=>{frame=0;if(last!==null)callbacks.current.onWidth(last)};
                const move=next=>{
                    const rect=rootRef.current?.getBoundingClientRect();if(!rect)return;
                    const edge=side==='left'?next.clientX-rect.left:rect.right-next.clientX;
                    last=Math.round(Math.max(Math.min(CONTENT_MIN,rect.width),Math.min(rect.width-CONTENT_EDGE_BUDGET,(rect.width/2-edge)*2)));
                    if(!frame)frame=requestAnimationFrame(flush);
                };
                const pointer=event.type==='pointerdown';
                const dispose=()=>{if(frame)cancelAnimationFrame(frame);window.removeEventListener(pointer?'pointermove':'mousemove',move);window.removeEventListener(pointer?'pointerup':'mouseup',end);window.removeEventListener('pointercancel',end);window.removeEventListener('blur',end);cleanup.current=null};
                const end=()=>{dispose();if(last!==null){callbacks.current.onWidth(last);callbacks.current.onCommit(last)}setDragging(false)};
                cleanup.current=dispose;setDragging(true);
                window.addEventListener(pointer?'pointermove':'mousemove',move);window.addEventListener(pointer?'pointerup':'mouseup',end);window.addEventListener('pointercancel',end);window.addEventListener('blur',end);
            };
            return react_jsx_runtime.jsx('button',{type:'button',className:ConversationRoot_module_css_default.widthHandle,'data-width-handle':side,'data-dragging':dragging||undefined,'aria-label':side==='left'?'调整对话宽度左边界':'调整对话宽度右边界',title:'拖动调整对话宽度；双击恢复默认',onPointerDown:start,onMouseDown:start,onDoubleClick:()=>{callbacks.current.onWidth(null);callbacks.current.onCommit(null)},onKeyDown:event=>{if(!['ArrowLeft','ArrowRight','Home'].includes(event.key))return;event.preventDefault();const width=event.key==='Home'?null:Math.max(CONTENT_MIN,(Number.parseFloat(getComputedStyle(rootRef.current).getPropertyValue('--dsh-chat-user-width'))||rootRef.current.clientWidth*.64)+(event.key==='ArrowRight'?1:-1)*(side==='left'?-1:1)*32);callbacks.current.onWidth(width);callbacks.current.onCommit(width)}});
        }
		function ConversationRoot({ sessionId, useSession, useSessions, useWorkspaces, useInput, useComposerBlock, renderSlot, renderSlotChain, selectWorkspace, t }) {
			...
			const rootRef = (0, react.useRef)(null);
			const [contentWidth, setContentWidth] = (0, react.useState)(readWidthPreference);
			const commitWidth = (width) => { try { if(width===null)localStorage.removeItem(WIDTH_PREF_KEY);else localStorage.setItem(WIDTH_PREF_KEY,String(width)); } catch {} };
			(0, react.useEffect)(() => {
				const root = rootRef.current;
				if (root === null) return;
				const publish = () => root.style.setProperty("--dsh-conversation-column-width", `${root.clientWidth}px`);
				publish();
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\HermesTemp\deepseek-harness\packages\client\ui-conversation\src\client\skeleton\DetailsPanel.module.css.mjs
		const css$5 = ".EKSdBa_root{border-left:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);flex-direction:column;min-width:0;height:100%;display:flex}.EKSdBa_header{border-bottom:1px solid var(--dsw-alias-border-l2);justify-content:space-between;align-items:center;gap:8px;padding:14px 12px 12px;display:flex}.EKSdBa_title{color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;font-size:14px;font-weight:500;line-height:20px;overflow:hidden}.EKSdBa_close{width:28px;height:28px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;border-radius:999px;flex:none;place-items:center;display:grid}.EKSdBa_close:hover{background:var(--dsw-alias-interactive-bg-hover)}.EKSdBa_body{flex:1;min-height:0;padding:12px 16px;overflow-y:auto}.EKSdBa_empty{color:var(--dsw-alias-label-tertiary);padding:8px 0;font-size:13px;line-height:20px}.EKSdBa_section{margin-bottom:16px}.EKSdBa_sectionLabel{color:var(--dsw-alias-label-secondary);margin-bottom:6px;font-size:12px;font-weight:500;line-height:18px}.EKSdBa_code{background:var(--dsw-alias-markdown-code-block);font-family:var(--ds-font-family-code);color:var(--dsw-alias-label-primary);white-space:pre-wrap;word-break:break-word;border-radius:12px;margin:0;padding:16px;font-size:13px;line-height:22px}.EKSdBa_code[data-error]{color:var(--dsw-alias-state-error-primary)}";
		...
		var DetailsPanel_module_css_default = {
			"section": "EKSdBa_section",
			"close": "EKSdBa_close",
			"title": "EKSdBa_title",
			"root": "EKSdBa_root",
			"header": "EKSdBa_header",
			"body": "EKSdBa_body",
			"code": "EKSdBa_code",
			"empty": "EKSdBa_empty",
			"sectionLabel": "EKSdBa_sectionLabel"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\HermesTemp\deepseek-harness\packages\client\ui-conversation\src\client\chat\accessibility.module.css.mjs
		const css$4 = ".bj5vea_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}";
		...
		var ReasoningRow_module_css_default = {
			...
			"root": "yiubIW_root",
			"title": "yiubIW_title",
			"chevron": "yiubIW_chevron",
			"thinkBody": "yiubIW_thinkBody",
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\HermesTemp\deepseek-harness\packages\client\ui-conversation\src\client\chat\AssistantMarkdown.module.css.mjs
		const css$2 = ".RY9HBq_root{color:var(--dsw-alias-label-primary);flex-direction:column;font-size:16px;line-height:28px;display:flex}.RY9HBq_body{flex-direction:column;gap:16px;display:flex}.RY9HBq_stopped{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-tertiary);border-radius:6px;align-self:flex-start;padding:0 6px;font-size:11px;line-height:18px}.RY9HBq_actions{margin-top:16px;margin-left:-6px}";
		...
		var AssistantMarkdown_module_css_default = {
			"root": "RY9HBq_root",
			"stopped": "RY9HBq_stopped",
			"actions": "RY9HBq_actions",
			"body": "RY9HBq_body"
		};
		//#endregion
		...
		//#endregion
		//#region \0dsh-css:D:\HermesTemp\deepseek-harness\packages\client\ui-conversation\src\client\chat\GenericCommandCard.module.css.mjs
		const css$1 = "._5hqxEG_root{flex-direction:column;display:flex}._5hqxEG_row{position:relative;overflow:hidden}._5hqxEG_root[data-state=running] ._5hqxEG_row:after{content:\"\";inset-block:0;background:linear-gradient(90deg, transparent 0%, color-mix(in srgb, var(--dsw-alias-bg-base) 60%, transparent) 55%, transparent 100%);pointer-events:none;width:300px;animation:2.6s ease-out infinite _5hqxEG_dsh-command-row-sweep;position:absolute;left:0}@keyframes _5hqxEG_dsh-command-row-sweep{0%{left:-300px}90%,to{left:100%}}._5hqxEG_leading{flex-shrink:0}._5hqxEG_chevron{color:var(--dsw-alias-label-secondary)}._5hqxEG_title{font-weight:400}._5hqxEG_separator{background:var(--dsw-alias-label-caption);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}._5hqxEG_summary{min-width:0;color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;flex:auto;font-size:14px;line-height:24px;overflow:hidden}._5hqxEG_summary[data-error],._5hqxEG_body[data-error]{color:var(--dsw-alias-state-error-primary)}._5hqxEG_body{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-markdown-code-block);max-height:260px;color:var(--dsw-alias-label-primary);font:var(--dsw-font-markdown-code-block-small);white-space:pre-wrap;border-radius:12px;margin:4px 0 4px 4px;padding:12px 16px;overflow:auto}@media (prefers-reduced-motion:reduce){._5hqxEG_root[data-state=running] ._5hqxEG_row:after{animation:none}}";
		...
		var GenericCommandCard_module_css_default = {
			"chevron": "_5hqxEG_chevron",
			"root": "_5hqxEG_root",
			"row": "_5hqxEG_row",
			"body": "_5hqxEG_body",
			"dsh-command-row-sweep": "_5hqxEG_dsh-command-row-sweep",
			"separator": "_5hqxEG_separator",
			"summary": "_5hqxEG_summary",
			"leading": "_5hqxEG_leading",
			"title": "_5hqxEG_title"
		};
		//#endregion
