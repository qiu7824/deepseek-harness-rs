window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		var SkillRow_module_css_default = {
			"leading": "_CVIIG_leading",
			"chevron": "_CVIIG_chevron",
			"summary": "_CVIIG_summary",
			"inspectButton": "_CVIIG_inspectButton",
			"visuallyHidden": "_CVIIG_visuallyHidden",
			"errorSummary": "_CVIIG_errorSummary",
			"chevronHover": "_CVIIG_chevronHover",
			"instructionsCard": "_CVIIG_instructionsCard",
			"card": "_CVIIG_card",
			"bodyWrap": "_CVIIG_bodyWrap",
			"instructionsHeader": "_CVIIG_instructionsHeader",
			"instructions": "_CVIIG_instructions",
			"title": "_CVIIG_title",
			"separator": "_CVIIG_separator",
			"dsh-skill-row-sweep": "_CVIIG_dsh-skill-row-sweep",
			"row": "_CVIIG_row",
			"iconIdle": "_CVIIG_iconIdle"
		};
		//#endregion
