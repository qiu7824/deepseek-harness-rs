	...
	factory: (require) => {
		...
		*/
		function apply(ctx) {
			...
			ctx.slots.inject("main",()=>ctx.slots.register({name:"main",key:"plugin-center",locale:NS,children:{"plugin-center.inventory":{kind:"single",scope:"root"}}},props=>react.createElement("section",{style:{height:"100%",overflow:"auto",padding:24,boxSizing:"border-box"}},react.createElement("h1",null,"插件中心"),react.createElement(PluginInstallControls),react.createElement("button",{type:"button",onClick:()=>window.dispatchEvent(new CustomEvent("dsh-open-settings",{detail:{section:"plugins"}}))},"插件配置"),props.renderSlot("plugin-center.inventory",{}))));
