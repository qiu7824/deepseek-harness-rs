window.__ModuleLoader__.load({
  ...
  factory:require=>{
    ...
    function apply(ctx){
      const style=document.createElement("style");style.textContent=".dshPreviewPanel{box-sizing:border-box;overflow:auto;height:100%;padding:16px;color:var(--dsw-alias-label-primary)}.dshPreviewPanel header,.dshPreviewCard{display:flex;gap:10px;align-items:center;flex-wrap:wrap}.dshPreviewPanel button,.dshPreviewCard button{font:inherit;color:inherit;border:1px solid var(--dsw-alias-border-l2);border-radius:8px;padding:6px 10px;background:var(--dsw-alias-bg-layer-1);cursor:pointer}.dshPreviewCard small{color:var(--dsw-alias-label-tertiary)}.dshPreviewPanel :focus-visible,.dshPreviewCard :focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:2px}";style.textContent+="\n:is(.dshPluginInstall,.dshToolDiscovery,.dshSkillVersions,.dshPreviewPanel){font:inherit;line-height:1.6;color:var(--dsw-alias-label-primary)}\n.dshPluginInstall{display:flex;flex-direction:column;gap:14px;padding:20px!important;box-sizing:border-box}\n.dshPluginInstall h3,.dshPluginInstall p{margin:0}.dshPluginInstall p{color:var(--dsw-alias-label-secondary)}\n:is(.dshPluginInstall,.dshToolDiscovery,.dshSkillVersions) label{display:flex;flex-wrap:wrap;align-items:center;gap:8px}\n.dshPluginInstall label{display:flex;flex-direction:column;align-items:stretch;gap:6px}\n:is(.dshPluginInstall,.dshToolDiscovery,.dshSkillVersions,.dshPreviewPanel) :is(input:not([type=checkbox]),select,textarea){box-sizing:border-box;max-width:100%;min-height:38px;padding:8px 10px;font:inherit;color:inherit;background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l2,#dedede);border-radius:8px}\n:is(.dshPluginInstall,.dshToolDiscovery,.dshSkillVersions) button,.dshPluginCenter>button{min-height:36px;padding:7px 13px;font:inherit;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l2,#dedede);border-radius:8px;cursor:pointer;align-self:flex-start}\n.dshPluginCenter>button{margin:0 0 12px}.dshPluginCenter h1{font-size:24px;margin:0 0 20px}\n:is(.dshPluginInstall,.dshToolDiscovery,.dshSkillVersions,.dshPreviewPanel) button:disabled{opacity:.5;cursor:default}\n:is(.dshPluginInstall,.dshToolDiscovery,.dshSkillVersions,.dshPluginCenter) :focus-visible{outline:2px solid var(--dsw-alias-state-business-primary,#5067ed);outline-offset:2px}\n.dshSkillVersions .actions{display:flex;flex-wrap:wrap;gap:8px}.dshSkillVersions pre{overflow:auto;max-height:50vh}\n@media(max-width:600px){.dshPluginCenter{padding:16px!important}.dshPluginInstall{padding:14px!important}}\n";document.head.appendChild(style);ctx.effect(()=>()=>{style.remove();plans.clear()},"workbench preview lifecycle");
