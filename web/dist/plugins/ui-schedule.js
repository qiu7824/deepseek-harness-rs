window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		var ScheduleCatalogAction_module_css_default = {
			"count": "oVLzAG_count",
			"menu": "oVLzAG_menu",
			"metadata": "oVLzAG_metadata",
			"prompt": "oVLzAG_prompt",
			"relativeOverdue": "oVLzAG_relativeOverdue",
			"root": "oVLzAG_root",
			"row": "oVLzAG_row",
			"rowOverdue": "oVLzAG_rowOverdue",
			"status": "oVLzAG_status",
			"statusDot": "oVLzAG_statusDot",
			"trigger": "oVLzAG_trigger",
			"triggerOpen": "oVLzAG_triggerOpen"
		};
		//#endregion
