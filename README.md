...
Current release line: `0.1.3-alpha.7`.
...
- `deepseek-harness-rs-v0.1.3-alpha.7-windows-x86_64-{core,skin,free}-portable.zip`
- `deepseek-harness-rs-v0.1.3-alpha.7-linux-x86_64-{core,skin,free}-portable.tar.gz`
- `deepseek-harness-rs-v0.1.3-alpha.7-macos-{x86_64,aarch64}-{core,skin,free}-portable.tar.gz`
