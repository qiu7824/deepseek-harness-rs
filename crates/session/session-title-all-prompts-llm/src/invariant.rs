...
//! `@deepseek-ai/dsh-session-title-all-prompts-llm`: a no-runtime-check
...
pub const PACKAGE_NAME: &str = "@deepseek-ai/dsh-session-title-all-prompts-llm";

/// Cordis companion plugin name (TS `name`).
pub const NAME: &str = "session-title-all-prompts-llm-invariant";
...
pub struct SessionTitleAllPromptsLlmInvariantPlugin;

#[async_trait::async_trait]
impl Plugin for SessionTitleAllPromptsLlmInvariantPlugin {
