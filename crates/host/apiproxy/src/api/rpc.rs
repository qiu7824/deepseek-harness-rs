...
pub enum RpcErrorCode {
    ...
    SettingsNotExposed,
    SettingsConflict,
    PluginConfigUnsupported,
    PluginConfigNotFound,
    PluginConfigAmbiguous,
    PluginConfigRuntimeConflict,
    PluginConfigUnavailable,
    PluginConfigCancelled,
    PluginConfigConflict,
    PluginConfigInvalid,
    PluginConfigApplyFailed,
    PluginConfigCommitFailed,
    PluginConfigRecoveryRequired,
    CredentialRejected,
...
impl RpcErrorCode {
    ...
    pub fn as_str(&self) -> &'static str {
        match self {
            ...
            Self::PluginConfigUnsupported => "plugin-config-unsupported",
            Self::PluginConfigNotFound => "plugin-config-not-found",
            Self::PluginConfigAmbiguous => "plugin-config-ambiguous",
            Self::PluginConfigRuntimeConflict => "plugin-config-runtime-conflict",
            Self::PluginConfigUnavailable => "plugin-config-unavailable",
            Self::PluginConfigCancelled => "plugin-config-cancelled",
            Self::PluginConfigConflict => "plugin-config-conflict",
            Self::PluginConfigInvalid => "plugin-config-invalid",
            Self::PluginConfigApplyFailed => "plugin-config-apply-failed",
            Self::PluginConfigCommitFailed => "plugin-config-commit-failed",
            Self::PluginConfigRecoveryRequired => "plugin-config-recovery-required",
    ...
    pub fn parse_wire_code(value: &str) -> Option<Self> {
        Some(match value {
            ...
            "plugin-config-unsupported" => Self::PluginConfigUnsupported,
            "plugin-config-not-found" => Self::PluginConfigNotFound,
            "plugin-config-ambiguous" => Self::PluginConfigAmbiguous,
            "plugin-config-runtime-conflict" => Self::PluginConfigRuntimeConflict,
            "plugin-config-unavailable" => Self::PluginConfigUnavailable,
            "plugin-config-cancelled" => Self::PluginConfigCancelled,
            "plugin-config-conflict" => Self::PluginConfigConflict,
            "plugin-config-invalid" => Self::PluginConfigInvalid,
            "plugin-config-apply-failed" => Self::PluginConfigApplyFailed,
            "plugin-config-commit-failed" => Self::PluginConfigCommitFailed,
            "plugin-config-recovery-required" => Self::PluginConfigRecoveryRequired,
...
pub enum RpcError {
    ...
    PluginConfigUnsupported(RpcErrorBody<EmptyDetails>),
    PluginConfigNotFound(RpcErrorBody<EmptyDetails>),
    PluginConfigAmbiguous(RpcErrorBody<EmptyDetails>),
    PluginConfigRuntimeConflict(RpcErrorBody<EmptyDetails>),
    PluginConfigUnavailable(RpcErrorBody<EmptyDetails>),
    PluginConfigCancelled(RpcErrorBody<EmptyDetails>),
    PluginConfigConflict(RpcErrorBody<EmptyDetails>),
    PluginConfigInvalid(RpcErrorBody<EmptyDetails>),
    PluginConfigApplyFailed(RpcErrorBody<EmptyDetails>),
    PluginConfigCommitFailed(RpcErrorBody<EmptyDetails>),
    PluginConfigRecoveryRequired(RpcErrorBody<EmptyDetails>),
...
impl RpcError {
    pub fn code(&self) -> RpcErrorCode {
        match self {
            ...
            Self::PluginConfigUnsupported(_) => RpcErrorCode::PluginConfigUnsupported,
            Self::PluginConfigNotFound(_) => RpcErrorCode::PluginConfigNotFound,
            Self::PluginConfigAmbiguous(_) => RpcErrorCode::PluginConfigAmbiguous,
            Self::PluginConfigRuntimeConflict(_) => RpcErrorCode::PluginConfigRuntimeConflict,
            Self::PluginConfigUnavailable(_) => RpcErrorCode::PluginConfigUnavailable,
            Self::PluginConfigCancelled(_) => RpcErrorCode::PluginConfigCancelled,
            Self::PluginConfigConflict(_) => RpcErrorCode::PluginConfigConflict,
            Self::PluginConfigInvalid(_) => RpcErrorCode::PluginConfigInvalid,
            Self::PluginConfigApplyFailed(_) => RpcErrorCode::PluginConfigApplyFailed,
            Self::PluginConfigCommitFailed(_) => RpcErrorCode::PluginConfigCommitFailed,
            Self::PluginConfigRecoveryRequired(_) => RpcErrorCode::PluginConfigRecoveryRequired,
    ...
    pub fn message(&self) -> &str {
        match self {
            ...
            Self::PluginConfigUnsupported(body) => &body.message,
            Self::PluginConfigNotFound(body) => &body.message,
            Self::PluginConfigAmbiguous(body) => &body.message,
            Self::PluginConfigRuntimeConflict(body) => &body.message,
            Self::PluginConfigUnavailable(body) => &body.message,
            Self::PluginConfigCancelled(body) => &body.message,
            Self::PluginConfigConflict(body) => &body.message,
            Self::PluginConfigInvalid(body) => &body.message,
            Self::PluginConfigApplyFailed(body) => &body.message,
            Self::PluginConfigCommitFailed(body) => &body.message,
            Self::PluginConfigRecoveryRequired(body) => &body.message,
