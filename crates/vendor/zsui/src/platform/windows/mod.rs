...
use crate::View;
use crate::{
    native_status_menu_command_from_menu, Color, Command, DialogButtonLabels, DialogButtons,
    DialogLevel, DialogResponse, FileDialogService, FileDialogSpec, HostCapabilities, MenuItemSpec,
    MenuSpec, NativeAppIconResource, NativeDialogService, NativeDialogSpec, NativeDrawPlan,
...
use windows_sys::Win32::{
    ...
    UI::{
        ...
        WindowsAndMessaging::{
            ...
            GetMenu, GetMessageW, GetSystemMetrics, GetWindowLongPtrW, GetWindowLongW,
            GetWindowRect, IsWindow, IsWindowVisible, KillTimer, LoadCursorW, LoadImageW,
            MessageBoxW, PostMessageW, PostQuitMessage, RegisterClassExW, SendMessageW,
            SetForegroundWindow, SetMenu, SetTimer, SetWindowLongPtrW, SetWindowLongW,
            SetWindowPos, SetWindowTextW, SetWindowsHookExW, ShowWindow, SystemParametersInfoW,
            TrackPopupMenu, TranslateAcceleratorW, TranslateMessage, UnhookWindowsHookEx, ACCEL,
            CREATESTRUCTW, CS_DBLCLKS, CS_HREDRAW, CS_VREDRAW, CW_USEDEFAULT, FALT, FCONTROL,
            FSHIFT, FVIRTKEY, GWLP_USERDATA, GWL_EXSTYLE, GWL_STYLE, HACCEL, HCBT_ACTIVATE,
            HCURSOR, HHOOK, HICON, HMENU, HTCAPTION, HWND_TOPMOST, ICON_BIG, ICON_SMALL, IDCANCEL,
            IDC_ARROW, IDNO, IDOK, IDYES, IMAGE_ICON, LR_DEFAULTCOLOR, LR_LOADFROMFILE,
            MB_ICONERROR, MB_ICONINFORMATION, MB_ICONWARNING, MB_OK, MB_OKCANCEL, MB_TASKMODAL,
            MB_YESNO, MB_YESNOCANCEL, MF_CHECKED, MF_GRAYED, MF_POPUP, MF_SEPARATOR, MF_STRING,
            MINMAXINFO, MSG, SC_MOVE, SIZE_MINIMIZED, SM_CXICON, SM_CXSMICON, SM_CYICON,
            SM_CYSMICON, SPI_GETHIGHCONTRAST, SWP_FRAMECHANGED, SWP_NOACTIVATE, SWP_NOMOVE,
            SWP_NOSIZE, SWP_NOZORDER, SWP_SHOWWINDOW, SW_HIDE, SW_SHOW, SW_SHOWNOACTIVATE,
            TPM_NONOTIFY, TPM_RETURNCMD, TPM_RIGHTBUTTON, WH_CBT, WM_APP, WM_CAPTURECHANGED,
            WM_CHAR, WM_CLOSE, WM_COMMAND, WM_CONTEXTMENU, WM_DPICHANGED, WM_ERASEBKGND,
            WM_GETMINMAXINFO, WM_IME_COMPOSITION, WM_IME_ENDCOMPOSITION, WM_IME_STARTCOMPOSITION,
            WM_KEYDOWN, WM_KILLFOCUS, WM_LBUTTONDBLCLK, WM_LBUTTONDOWN, WM_LBUTTONUP,
            WM_MBUTTONDOWN, WM_MBUTTONUP, WM_MOUSEMOVE, WM_MOUSEWHEEL, WM_NCCREATE, WM_NCDESTROY,
            WM_PAINT, WM_PRINTCLIENT, WM_RBUTTONDOWN, WM_RBUTTONUP, WM_SETICON, WM_SETTINGCHANGE,
            WM_SHOWWINDOW, WM_SIZE, WM_SYSCOLORCHANGE, WM_SYSCOMMAND, WM_THEMECHANGED, WM_TIMER,
            WM_XBUTTONDOWN, WM_XBUTTONUP, WNDCLASSEXW, WNDPROC, WS_CAPTION, WS_CLIPCHILDREN,
...
const ZSUI_WIN32_INVALIDATE_VIEW_MESSAGE: u32 = WM_APP + 0x0552;
